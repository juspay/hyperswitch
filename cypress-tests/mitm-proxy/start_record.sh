...
echo "    export CYPRESS_REDIRECT_PROXY_ADMIN_URL=http://127.0.0.1:9002"
echo "    export CYPRESS_IS_PROXY_ENABLED=true"
echo ""
echo "Start the redirect proxy in a separate terminal:"
echo "    python ${SCRIPT_DIR}/redirect_proxy.py"
echo "    (listens :9001 → Hyperswitch :8080, admin :9002)"
echo "    Requires development.toml: multitenancy.tenants.public.base_url = \"http://localhost:9001\""
echo ""
