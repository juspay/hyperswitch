...
describe("Card - Mandates using Payment Method Id flow test", () => {
  ...
  context(
    ...
    () => {
      it(
        "customer-create-call-test -> Create No 3DS Payment Intent -> Confirm No 3DS CIT -> retrieve-payment-call-test -> Confirm No 3DS MIT -> retrieve-payment-call-test",
        () => {
          ...
          cy.step("Create No 3DS Payment Intent", () => {
            if (!shouldContinue) {
              cy.task(
                "cli_log",
                "Skipping step: Create No 3DS Payment Intent"
              );
              return;
            }
  ...
  context(
    ...
    () => {
      it(
        "Create No 3DS Payment Intent -> Confirm No 3DS CIT -> cit-capture-call-test -> retrieve-payment-call-test -> Confirm No 3DS MIT -> retrieve-payment-call-test",
        () => {
          let shouldContinue = true;
  ...
  context(
    ...
    () => {
      it(
        "Confirm No 3DS CIT -> retrieve-payment-call-test -> Confirm No 3DS MIT -> retrieve-payment-call-test -> Confirm No 3DS MIT -> retrieve-payment-call-test",
        () => {
          let shouldContinue = true;
  ...
  context(
    ...
    () => {
      it(
        "Confirm No 3DS CIT -> cit-capture-call-test -> retrieve-payment-call-test -> Confirm No 3DS MIT 1 -> mit-capture-call-test -> retrieve-payment-call-test -> Confirm No 3DS MIT 2 -> mit-capture-call-test -> retrieve-payment-call-test",
        () => {
          let shouldContinue = true;
  ...
  context("Card - MIT without billing address", () => {
    it(
      "Create No 3DS Payment Intent -> Confirm No 3DS CIT -> Confirm No 3DS MIT",
      () => {
        let shouldContinue = true;
  ...
  context(
    ...
    () => {
      it(
        "Confirm 3DS CIT -> Handle redirection -> retrieve-payment-call-test -> Confirm No 3DS MIT -> Confirm No 3DS MIT",
        () => {
          let shouldContinue = true;
  ...
  context(
    ...
    () => {
      it(
        "Confirm 3DS CIT -> Handle redirection -> cit-capture-call-test -> retrieve-payment-call-test -> Confirm No 3DS MIT",
        () => {
          let shouldContinue = true;
