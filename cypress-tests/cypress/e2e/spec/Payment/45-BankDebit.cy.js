...
describe("Bank Debit tests", () => {
  ...
  context("ACH Bank Debit with Invalid Routing Number flow test", () => {
    it("Create Payment Intent -> List Merchant Payment Methods -> Confirm ACH with Invalid Routing Number -> Retrieve Payment", () => {
      let shouldContinue = true;

      cy.step("Create Payment Intent for ACH Invalid Routing Number", () => {
        const data = getConnectorDetails(globalState.get("connectorId"))[
          "bank_debit_pm"
        ]["PaymentIntent"]("Ach");
        cy.createPaymentIntentTest(
  ...
  context("ACH Bank Debit with Invalid Account Number flow test", () => {
    it("Create Payment Intent -> List Merchant Payment Methods -> Confirm ACH with Invalid Account Number -> Retrieve Payment", () => {
      let shouldContinue = true;

      cy.step("Create Payment Intent for ACH Invalid Account Number", () => {
        const data = getConnectorDetails(globalState.get("connectorId"))[
          "bank_debit_pm"
        ]["PaymentIntent"]("Ach");
        cy.createPaymentIntentTest(
