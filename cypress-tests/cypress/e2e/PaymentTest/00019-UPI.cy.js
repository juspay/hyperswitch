...
describe("UPI Payments - Hyperswitch", () => {
  ...
  context("[Payment] [UPI - UPI Collect] Create & Confirm + Refund", () => {
    ...
    it("Create payment intent", () => {
      let data = getConnectorDetails(globalState.get("connectorId"))["upi_pm"]["PaymentIntent"];
    ...
    it("Confirm payment", () => {
      let data = getConnectorDetails(globalState.get("connectorId"))["upi_pm"]["UpiCollect"];
      let req_data = data["Request"];
      let res_data = data["Response"];

      cy.confirmUpiCall(fixtures.confirmBody, req_data, res_data, true, globalState);
    ...
    it("Refund payment", () => {
      let data = getConnectorDetails(globalState.get("connectorId"))["upi_pm"]["Refund"];
      let req_data = data["Request"];
      let res_data = data["Response"];
  ...
  context.skip("[Payment] [UPI - UPI Intent] Create & Confirm", () => {
    ...
    it("Confirm payment", () => {
      let data = getConnectorDetails(globalState.get("connectorId"))["upi_pm"]["UpiIntent"];
      let req_data = data["Request"];
      let res_data = data["Response"];
