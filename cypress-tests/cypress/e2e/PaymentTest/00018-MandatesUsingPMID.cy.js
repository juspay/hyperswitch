...
describe("Card - Mandates using Payment Method Id flow test", () => {
  ...
  context("Card - NoThreeDS Create and Confirm Automatic CIT and MIT payment flow test", () => {
    ...
    it("Confirm No 3DS MIT", () => {
      cy.mitUsingPMId(fixtures.pmIdConfirmBody, 7000, true, "automatic", globalState);
    });
  });

  context("Card - NoThreeDS Create and Confirm Manual CIT and MIT payment flow test", () => {
    let should_continue = true;
  ...
  context("Card - NoThreeDS Create + Confirm Manual CIT and MIT payment flow test", () => {
    ...
    it("Confirm No 3DS MIT 1", () => {
      cy.mitUsingPMId(fixtures.pmIdConfirmBody, 6500, true, "manual", globalState);
    });
  ...
  context("Card - ThreeDS Create + Confirm Automatic CIT and MIT payment flow test", () => {
    let should_continue = true;
    ...
    it("Confirm 3DS CIT", () => {
      console.log("confirm -> " + globalState.get("connectorId"));
      let data = getConnectorDetails(globalState.get("connectorId"))["card_pm"]["PaymentMethodIdMandate3DSAutoCapture"];
      let req_data = data["Request"];
      let res_data = data["Response"];
      console.log("det -> " + data.card);
      cy.citForMandatesCallTest(
  ...
  context("Card - ThreeDS Create + Confirm Manual CIT and MIT payment flow", () => {
    let should_continue = true;
