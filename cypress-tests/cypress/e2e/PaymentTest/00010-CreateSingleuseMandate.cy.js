...
describe("Card - SingleUse Mandates flow test", () => {
  ...
  context("Card - NoThreeDS Create + Confirm Manual CIT and MIT payment flow test", () => {
    ...
    it("Confirm No 3DS MIT", () => {
      cy.mitForMandatesCallTest(fixtures.mitConfirmBody, 6500, true, "manual", globalState);
    });
  ...
  context("Card - No threeDS Create + Confirm Manual CIT and MIT payment flow test", () => {
    let should_continue = true; // variable that will be used to skip tests if a previous test fails
