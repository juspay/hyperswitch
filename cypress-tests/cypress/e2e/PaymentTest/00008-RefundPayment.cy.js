...
describe("Card - Refund flow - No 3DS", () => {
  ...
  context("Card - Partial Refund flow test for No-3DS", () => {
    ...
    it("refund-call-test", () => {
      ...
      let req_data = data["Request"];
      let res_data = data["Response"];
      cy.refundCallTest(fixtures.refundBody, req_data, res_data, 1200, globalState);
      if (should_continue) should_continue = utils.should_continue_further(res_data);
    });
  ...
  context("Partially Refund Card-NoThreeDS payment flow test Create+Confirm", () => {
    ...
    it("refund-call-test", () => {
      ...
      let req_data = data["Request"];
      let res_data = data["Response"];
      cy.refundCallTest(fixtures.refundBody, req_data, res_data, 3000, globalState);
      if (should_continue) should_continue = utils.should_continue_further(res_data);
    });
  ...
  context("Card - Full Refund for partially captured No-3DS payment", () => {
    ...
    it("refund-call-test", () => {
      ...
      let req_data = data["Request"];
      let res_data = data["Response"];
      cy.refundCallTest(fixtures.refundBody, req_data, res_data, 100, globalState);
      if (should_continue) should_continue = utils.should_continue_further(res_data);
    });
  ...
  context("Card - Full Refund for Create + Confirm Automatic CIT and MIT payment flow test", () => {
    ...
    it("refund-call-test", () => {
      ...
      let req_data = data["Request"];
      let res_data = data["Response"];
      cy.refundCallTest(fixtures.refundBody, req_data, res_data, 7000, globalState);
      if (should_continue) should_continue = utils.should_continue_further(res_data);
    });
...
describe("Card - Refund flow - 3DS", () => {
  ...
  context("Card - Full Refund for fully captured 3DS payment", () => {
    ...
    it("create-payment-call-test", () => {
      ...
      let req_data = data["Request"];
      let res_data = data["Response"];
      cy.createPaymentIntentTest(fixtures.createPaymentBody, req_data, res_data, "three_ds", "manual", globalState);
      if (should_continue) should_continue = utils.should_continue_further(res_data);
    });
  ...
  context("Card - Partial Refund for fully captured 3DS payment", () => {
    ...
    it("refund-call-test", () => {
      ...
      let req_data = data["Request"];
      let res_data = data["Response"];
      cy.refundCallTest(fixtures.refundBody, req_data, res_data, 5000, globalState);
      if (should_continue) should_continue = utils.should_continue_further(res_data);
    });
    it("refund-call-test", () => {
      let data = getConnectorDetails(globalState.get("connectorId"))["card_pm"]["Refund"];
      let req_data = data["Request"];
      let res_data = data["Response"];
      cy.refundCallTest(fixtures.refundBody, req_data, res_data, 1500, globalState);
      if (should_continue) should_continue = utils.should_continue_further(res_data);
    });
  ...
  context("Card - partial Refund for partially captured 3DS payment", () => {
    ...
    it("refund-call-test", () => {
      ...
      let req_data = data["Request"];
      let res_data = data["Response"];
      cy.refundCallTest(fixtures.refundBody, req_data, res_data, 50, globalState);
      if (should_continue) should_continue = utils.should_continue_further(res_data);
    });
