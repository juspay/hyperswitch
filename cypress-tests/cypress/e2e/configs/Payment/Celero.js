...
// ============================================================================
// CELERO CYPRESS TEST CONFIGURATION
// ============================================================================
// Core functionality based on Celero API specification:
...
export const connectorDetails = {
  card_pm: {
    ...
    SaveCardUseNo3DSAutoCapture: getCustomExchange({
      Configs: {
        TRIGGER_SKIP: true, // Skip if Celero doesn't support save card
      },
      Request: {
        payment_method: "card",
        payment_method_data: {
    ...
    // Note: Celero doesn't support 3DS or save card, marked as TRIGGER_SKIP
    ...
    // Note: Celero doesn't support off-session or save card, marked as TRIGGER_SKIP

    SaveCardUseNo3DSAutoCaptureOffSession: getCustomExchange({
      Configs: {
        TRIGGER_SKIP: true, // Skip if Celero doesn't support off-session save card
      },
      Request: {
        payment_method: "card",
        payment_method_data: {
    ...
    // Note: Celero doesn't support 3DS or mandates, marked as TRIGGER_SKIP
    ...
    // Note: These may not be supported by Celero, marked as TRIGGER_SKIP
