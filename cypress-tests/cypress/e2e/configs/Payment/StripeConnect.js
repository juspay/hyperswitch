...
// Stripe Connect Split Payments Configuration
const stripeSplitPaymentData = {
...
const zeroAuthStripeSplitPaymentData = {
  stripe_split_payment: {
    charge_type: "direct",
    application_fees: 0,
    transfer_account_id: "acct_1RWCjbRT4izcUWmO",
      ...
      payment_method_types: [
        {
          ...
          required_fields: commonsCardRequiredField,
        },
      ],
    },
  ],
...
export const connectorDetails = {
  card_pm: {
    ...
    Refund: {
      Request: {
        amount: 6000,
        split_refunds: stripeSplitRefundData,
      },
      Response: {
        status: 200,
        body: {
