...
// Test card details for Square
const successfulNo3DSCardDetails = {
  card_number: "4111111111111111", // Visa test card from Square documentation
  card_exp_month: "12",
  card_exp_year: "30",
...
const successfulThreeDSCardDetails = {
  ...
  card_number: "4000000000003220", // Visa 3DS test card from Square documentation
};

const failedCardDetails = {
  ...successfulNo3DSCardDetails,
  card_number: "4000000000009995", // Standard decline test card for Square
};
      ...
      Response: {
        ...
        body: {
          error: {
            ...
            message: "3DS not supported for Square",
            code: "IR_00",
          },
        },
      },
    ...
    ZeroAuthMandate: {
      ...
      Response: {
        ...
        body: {
          error: {
            type: "invalid_request",
            message: "Setup Mandate flow for Square is not implemented",
            code: "IR_00",
          },
        },
      },
