...
describe("Connector Account Create flow test", () => {
  ...
  it("adyen-connector-create-call-test", () => {
    cy.createConnectorWithNameCallTest(createConnectorBody, "adyen", "payment_processor", globalState);
  });

  it("stripe-connector-create-call-test", () => {
    cy.createConnectorWithNameCallTest(createConnectorBody, "stripe", "payment_processor", globalState);
  });
});
