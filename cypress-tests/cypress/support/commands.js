 ...
 *
 * GET /account/{merchant_id}/business_profile/{profile_id}
 *
 * @param {Object} globalState  - Global state instance
 * @param {string} profilePrefix - globalState key prefix for profileId (default "profile")
 * @param {string|null} verificationType - Optional retrieve response verification
  ...
  (globalState, profilePrefix = "profile", verificationType = null) => {
    ...
    return cy
      ...
      .then((response) => {
        ...
        if (verificationType === "verifyVisaAcquirerConfig") {
