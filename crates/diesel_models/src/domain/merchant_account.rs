...
impl super::behaviour::Conversion for MerchantAccount {
    type DstType = crate::merchant_account::MerchantAccount;
    type NewDstType = crate::merchant_account::MerchantAccountNew;
    async fn convert(self) -> CustomResult<Self::DstType, ValidationError> {
        Ok(crate::merchant_account::MerchantAccount {
    ...
    async fn construct_new(self) -> CustomResult<Self::NewDstType, ValidationError> {
        ...
        Ok(crate::merchant_account::MerchantAccountNew {
            merchant_id: self.merchant_id,
