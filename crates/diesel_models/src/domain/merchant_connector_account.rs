...
impl behaviour::Conversion for MerchantConnectorAccount {
    type DstType = crate::merchant_connector_account::MerchantConnectorAccount;
    type NewDstType = crate::merchant_connector_account::MerchantConnectorAccountNew;

    async fn convert(self) -> CustomResult<Self::DstType, ValidationError> {
        Ok(
            crate::merchant_connector_account::MerchantConnectorAccount {
