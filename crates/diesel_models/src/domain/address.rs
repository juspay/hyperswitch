...
use crate::{address::AddressUpdateInternal, encryption::Encryption, enums};
...
impl behaviour::Conversion for Address {
    type DstType = crate::address::Address;
    type NewDstType = crate::address::AddressNew;

    async fn convert(self) -> CustomResult<Self::DstType, ValidationError> {
        Ok(crate::address::Address {
