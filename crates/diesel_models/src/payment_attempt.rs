        ...
        match payment_attempt_update {
            ...
            PaymentAttemptUpdate::ManualUpdate {
                ...
                Self {
                    ...
                    error_message: error_message.map(Some).flatten(),
                    error_reason: error_reason.map(Some).flatten(),
                    updated_by,
                    unified_code: unified_code.map(Some).flatten(),
                    unified_message: unified_message.map(Some).flatten(),
                    connector_payment_id,
                    connector_payment_data,
                    modified_at: common_utils::date_time::now(),
                    authentication_type: None,
