...
#[diesel(table_name = payment_attempt)]
#[router_derive::apply_changeset(target = PaymentAttempt)]
...
impl PaymentAttemptUpdate {
    pub fn apply_changeset(self, source: PaymentAttempt) -> PaymentAttempt {
        PaymentAttemptUpdateInternal::from(self).apply_changeset(source)
    }
}
    ...
    fn from(payment_attempt_update: PaymentAttemptUpdate) -> Self {
        match payment_attempt_update {
            ...
            PaymentAttemptUpdate::AppliedOfferUpdate {
                ...
                external_surcharge_details: None,
                external_threeds_authentication_type: None,
                applied_offer_details: Some(applied_offer_details),
            },
        }
    }
}
