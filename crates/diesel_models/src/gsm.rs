...
#[derive(
    Clone, Debug, Eq, PartialEq, router_derive::DebugAsDisplay, Identifiable, Queryable, Selectable,
)]
...
pub struct GatewayStatusMap {
    ...
    pub decision: String,
    #[cfg_attr(feature = "deja", serde(with = "common_utils::custom_serde::iso8601"))]
