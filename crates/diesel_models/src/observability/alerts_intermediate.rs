...
///
/// The per-channel structs below exist because diesel needs one per table; this is what everything
/// above the query layer works in, so a caller picks a channel once and never again.
