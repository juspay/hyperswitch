...
#[cfg(feature = "v1")]
impl From<PaymentIntentNew> for PaymentIntent {
    fn from(payment_intent_new: PaymentIntentNew) -> Self {
        let PaymentIntentNew {
            payment_id,
            merchant_id,
            status,
            amount,
...
pub enum PaymentIntentUpdate {
    ...
    ExternalSurchargeApplicableUpdate {
        external_surcharge_applicable: Option<bool>,
        updated_by: String,
    },
...
#[diesel(table_name = payment_intent)]
#[router_derive::apply_changeset(target = PaymentIntent)]
...
impl PaymentIntentUpdate {
    pub fn apply_changeset(self, source: PaymentIntent) -> PaymentIntent {
        PaymentIntentUpdateInternal::from(self).apply_changeset(source)
    }
}
