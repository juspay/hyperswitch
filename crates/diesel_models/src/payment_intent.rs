...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, diesel::AsExpression)]
...
// common_utils::impl_to_sql_from_sql_json!(PmtTax);
...
// common_utils::impl_to_sql_from_sql_json!(DefaultTax);
