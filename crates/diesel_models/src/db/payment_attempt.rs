...
pub trait PaymentAttemptInterface {
    ...
    async fn get_filters_for_payments(
        &self,
        pi: &[crate::payment_intent::PaymentIntent],
        merchant_id: &str,
        storage_scheme: enums::MerchantStorageScheme,
    ) -> CustomResult<crate::payment_attempt::PaymentListFilters, errors::StorageError>;
}
...
impl PaymentAttemptInterface for MockDb {
    ...
    async fn get_filters_for_payments(
        &self,
        _pi: &[crate::payment_intent::PaymentIntent],
        _merchant_id: &str,
        _storage_scheme: enums::MerchantStorageScheme,
    ) -> CustomResult<crate::payment_attempt::PaymentListFilters, errors::StorageError>
    {
...
mod storage {
    ...
    use crate::{
        connection,
        PaymentAttempt, PaymentAttemptNew, PaymentAttemptUpdate, ReverseLookupNew,
