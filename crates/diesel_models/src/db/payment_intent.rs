...
mod storage {
    use common_utils::{self as utils, date_time, errors::CustomResult};
    use crate::utils::{storage_partitioning};
    use crate::{reverse_lookup::ReverseLookup, enums, errors, kv, utils::db_utils};
    use error_stack::{IntoReport, ResultExt};
    use redis_interface::HsetnxReply;

    use crate::db::payment_attempt::PaymentAttemptInterface;
    use crate::{
        connection,
        PaymentIntent, PaymentIntentNew, PaymentIntentUpdate, ReverseLookupNew,
        ...
        async fn update_payment_intent(
            ...
            match storage_scheme {
                ...
                enums::MerchantStorageScheme::RedisKv => {
                    ...
                    let redis_value =
                    common_utils::ext_traits::Encode::<PaymentIntent>::encode_to_string_of_json(&updated_intent)
