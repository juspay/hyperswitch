...
#[derive(Clone, Debug, Insertable, router_derive::DebugAsDisplay, serde::Deserialize, serde::Serialize)]
...
#[derive(Clone, Debug, Default, AsChangeset, router_derive::DebugAsDisplay, serde::Deserialize, serde::Serialize)]
#[diesel(table_name = customers)]
