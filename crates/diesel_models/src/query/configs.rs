...
impl ConfigNew {
    pub async fn insert(self, conn: &mut PgPooledConn) -> StorageResult<Config> {
        generics::generic_insert(conn, self).await
    }
}

impl Config {
    pub async fn find_by_key(conn: &mut PgPooledConn, key: &str) -> StorageResult<Self> {
    ...
    pub async fn delete_by_key(conn: &mut PgPooledConn, key: &str) -> StorageResult<Self> {
