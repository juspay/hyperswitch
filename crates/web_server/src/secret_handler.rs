...
impl SecretsHandler for settings::Database {
    ...
    ) -> CustomResult<secret_state::SecretStateContainer<Self, secret_state::RawSecret>, secrets_interface::SecretsManagementError> {
...
impl SecretsHandler for settings::KeyManagerConfig {
    async fn convert_to_raw_secret(
        value: secret_state::SecretStateContainer<Self, secret_state::SecuredSecret>,
        _secret_management_client: &dyn secrets_interface::SecretManagementInterface,
    ) -> CustomResult<secret_state::SecretStateContainer<Self, secret_state::RawSecret>, secrets_interface::SecretsManagementError> {
...
pub(crate) async fn fetch_raw_secrets(
    conf: settings::Settings<secret_state::SecuredSecret>,
    secret_management_client: &dyn secrets_interface::SecretManagementInterface,
) -> settings::Settings<secret_state::RawSecret> {
