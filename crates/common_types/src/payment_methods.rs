...
pub struct RequestPaymentMethodTypes {
    ...
    #[schema(value_type = common_enums::PaymentMethodType)]
    pub payment_method_subtype: common_enums::PaymentMethodType,

    /// The payment experience for the payment method
    #[schema(value_type = Option<common_enums::PaymentExperience>)]
    ...
    #[schema(value_type = Option<Vec<common_enums::CardNetwork>>)]
...
pub enum AcceptedCountries {
    ...
    #[schema(value_type = Vec<common_enums::CountryAlpha2>)]
...
pub enum AcceptedCurrencies {
    ...
    #[schema(value_type = Vec<common_enums::Currency>)]
...
pub struct NetworkTokenization {
    ...
    #[schema(value_type = common_enums::NetworkTokenizationToggle)]
