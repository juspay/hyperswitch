...
impl PaymentIntent {
    ...
    pub fn extract_connector_customer_id_from_payment_intent(&self) -> Result<String, common_utils::errors::ValidationError> {
        self
            .feature_metadata
            .as_ref()
            ...
            .ok_or(common_utils::errors::ValidationError::MissingRequiredField {
