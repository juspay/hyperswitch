...
pub mod types {
    ...
    impl ApiModelToDieselModelConvertor<api_models::injector::VaultType> for VaultType {
        fn convert_from(from: api_models::injector::VaultType) -> Self {
            match from {
                ...
                api_models::injector::VaultType::Skyflow => Self::Skyflow,
                api_models::injector::VaultType::Basis => Self::Basis,
                api_models::injector::VaultType::Hashicorp => Self::Hashicorp,
            }
        }
        ...
        fn convert_back(self) -> api_models::injector::VaultType {
            match self {
                ...
                Self::Skyflow => api_models::injector::VaultType::Skyflow,
                Self::Basis => api_models::injector::VaultType::Basis,
                Self::Hashicorp => api_models::injector::VaultType::Hashicorp,
            }
        }
    }
    ...
    impl ApiModelToDieselModelConvertor<api_models::injector::InjectorResponse> for InjectorResponse {
        fn convert_from(from: api_models::injector::InjectorResponse) -> Self {
            Self {
                success: from.success,
                message: from.message,
                processed_payload: from.processed_payload,
                response_data: from.response_data,
            }
        }

        fn convert_back(self) -> api_models::injector::InjectorResponse {
            api_models::injector::InjectorResponse {
    ...
    impl From<api_models::injector::InjectorResponse> for InjectorResponse {
        fn from(response: api_models::injector::InjectorResponse) -> Self {
            Self {
                success: response.success,
                message: response.message,
                processed_payload: response.processed_payload,
