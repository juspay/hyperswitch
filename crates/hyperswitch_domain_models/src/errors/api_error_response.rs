...
pub enum ApiErrorResponse {
    ...
    #[error(error_type = ErrorType::ObjectNotFound, code = "HE_02", message = "Tokenization record not found for the given token_id")]
    TokenizationRecordNotFound,
}
...
impl ErrorSwitch<api_models::errors::types::ApiErrorResponse> for ApiErrorResponse {
    fn switch(&self) -> api_models::errors::types::ApiErrorResponse {
        ...
        match self {
            ...
            Self::TokenizationRecordNotFound => {
                AER::NotFound(ApiError::new("HE", 2, "Tokenization record not found for the given token_id", None))
            }
        }
    }
}
