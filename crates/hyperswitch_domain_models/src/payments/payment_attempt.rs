...
#[cfg(feature = "v1")]
use common_types::payment_attempt_types::{
...
impl PaymentAttempt {
    ...
    ) -> CustomResult<Option<pii::SecretSerdeValue>, ApiErrorResponse>
    {
...
impl PaymentAttempt {
    ...
    pub fn get_payment_method_data(
        &self,
    ) -> CustomResult<Option<AdditionalPaymentData>, ApiErrorResponse>
    {
