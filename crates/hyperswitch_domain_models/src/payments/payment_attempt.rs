...
pub struct PaymentAttempt {
    ...
    /// Error message that is returned by the connector in case of any error
    ...
    /// The unified code that is generated by the application.
    /// This is done using the the error code mapping of different connectors with the application error code
    pub unified_code: Option<String>,
    /// The unified message that is generated by the application.
    /// This is done using the the error message mapping of different connectors with the application error message
