...
use common_utils::{
    ...
    id_type, pii,
    types::{keymanager::ToEncryptable, ConnectorTransactionId, CreatedBy, MinorUnit},
};
#[cfg(feature = "v1")]
use diesel_models::{
...
impl PaymentAttempt {
    ...
    pub fn is_save_payment_method_not_supported_for_on_session(
        &self,
        unsupported_payment_methods: &common_utils::collections::HashMap<
