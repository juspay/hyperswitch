...
pub struct PaymentIntentUpdateFields {
    ...
    pub tax_details: Option<common_types::payment_intent_types::TaxDetails>,
...
pub enum PaymentIntentUpdate {
    ...
    SessionResponseUpdate {
        tax_details: common_types::payment_intent_types::TaxDetails,
        shipping_address_id: Option<String>,
        updated_by: String,
...
// Conversion implementations moved to storage_impl/src/conversions/payments/payment_intent.rs
