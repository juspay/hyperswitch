...
pub fn get_payments_response_from_ucs_webhook_content(
    ...
    match event_content.content {
        ...
        Some(unified_connector_service_client::payments::event_content::Content::PayoutsResponse(_)) => Err(UnifiedConnectorServiceError::WebhookProcessingFailure).attach_printable(
