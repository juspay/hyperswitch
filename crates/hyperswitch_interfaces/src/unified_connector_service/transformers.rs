    ...
    for Result<(PaymentsResponseData, AttemptStatus), ErrorResponse>
{
    ...
    fn foreign_try_from(
        ...
        let response = if let Some(error_code) = connector_details.and_then(|details| details.code)
        {
            ...
            Err(ErrorResponse {
                ...
                network_decline_code: response.error.and_then(|error| {
                ...
                network_advice_code: response.error.and_then(|error| {
                    error.issuer_details.as_ref().and_then(|id| {
                        id.network_details
                            .as_ref()
                ...
                network_error_message: response.error.and_then(|error| {
                    error.issuer_details.as_ref().and_then(|id| {
                        id.network_details
                            .as_ref()
