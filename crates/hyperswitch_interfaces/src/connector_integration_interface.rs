...
impl ConnectorEnum {
    ...
    pub fn requires_webhook_hmac_generation(&self) -> bool {
        match self {
            Self::Old(connector) => connector.requires_webhook_hmac_generation(),
            Self::New(connector) => connector.requires_webhook_hmac_generation(),
        }
    }
}
