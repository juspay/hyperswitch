use hyperswitch_domain_models::{
    ...
    router_flow_types::CreateCustomer,
    router_request_types::customers::CreateCustomerRequest,
    router_response_types::customers::CreateCustomerResponse,
};
