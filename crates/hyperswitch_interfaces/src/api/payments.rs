...
use hyperswitch_domain_models::{
    ...
    router_request_types::{
        ...
        PaymentMethodTokenizationData, PaymentTriggerRequest, PaymentsApproveData,
        ...
        PaymentsIncrementalAuthorizationData, PaymentsPostAuthenticateData, PaymentsPostProcessingData,
    ...
    router_response_types::{
        GiftCardBalanceCheckResponseData, PaymentTriggerResponse, PaymentsResponseData,
...
pub trait PaymentsPaymentTrigger:
    api::ConnectorIntegration<PaymentTrigger, PaymentTriggerRequest, PaymentsResponseData>
{
}
