...
mod storage {
    ...
    use common_utils::{
        errors::CustomResult, ext_traits::AsyncExt, id_type, types::keymanager::KeyManagerState,
    };
    use diesel_models::address as storage_types;
    ...
    use sample::{address::AddressInterface, domain::address as domain};
    ...
    impl<T: DatabaseStore> AddressInterface for RouterStore<T> {
...
//     };
//     use sample::address::AddressInterface;
//     use sample::domain::address as domain;

//     use hyperswitch_domain_models::{merchant_key_store, behaviour::{Conversion, ReverseConversion}};
//     use diesel_models::address as storage_types;
//     use crate::{errors, connection, Store};
...
//         ) -> CustomResult<domain::PaymentAddress, errors::StorageError> {
//             let conn = connection::pg_connection_write(self).await?;
//             let address = behaviour::Conversion::convert(this)
//                 .await
//                 .change_context(errors::StorageError::EncryptionError)?;
...
//                             updatable: Box::new(kv::Updateable::address::AddressUpdate(Box::new(
...
//         address_id: &str,
//         key_store: &merchant_key_store::MerchantKeyStore,
//     ) -> CustomResult<address::Address, errors::StorageError> {
//         match self
//             .addresses
//             .lock()
//             .await
...
//         key_store: &merchant_key_store::MerchantKeyStore,
//         _storage_scheme: MerchantStorageScheme,
//     ) -> CustomResult<payment_address::PaymentAddress, errors::StorageError> {
//         match self
//             .addresses
//             .lock()
//             .await
...
//         state: &KeyManagerState,
//         _payment_id: &id_type::PaymentId,
//         address_new: payment_address::PaymentAddress,
//         key_store: &merchant_key_store::MerchantKeyStore,
//         _storage_scheme: MerchantStorageScheme,
//     ) -> CustomResult<payment_address::PaymentAddress, errors::StorageError> {
//         let mut addresses = self.addresses.lock().await;

//         let address = behaviour::Conversion::convert(address_new)
//             .await
//             .change_context(errors::StorageError::EncryptionError)?;
...
//         &self,
//         state: &KeyManagerState,
//         address_new: address::CustomerAddress,
//         key_store: &merchant_key_store::MerchantKeyStore,
//     ) -> CustomResult<address::Address, errors::StorageError> {
//         let mut addresses = self.addresses.lock().await;
...
//         address_update: address::AddressUpdate,
//         key_store: &merchant_key_store::MerchantKeyStore,
//     ) -> CustomResult<Vec<address::Address>, errors::StorageError> {
//         let updated_addr = self
//             .addresses
//             .lock()
//             .await
