...
use hyperswitch_domain_models::{
    ...
    transformers::ForeignInto as DomainForeignInto,
        ...
        match profile_update {
            domain::ProfileUpdate::Update(update) => {
                ...
                Self {
                    ...
                    payment_response_hash_key,
                    redirect_to_merchant_with_http_post,
                    webhook_details: webhook_details.map(DomainForeignInto::foreign_into),
                    metadata,
                    routing_algorithm,
                    intent_fulfillment_time,
                    frm_routing_algorithm,
...
impl Conversion for domain::Profile {
    ...
    async fn convert(self) -> CustomResult<Self::DstType, ValidationError> {
        ...
        Ok(diesel::Profile {
            ...
            webhook_details: self.webhook_details.map(DomainForeignInto::foreign_into),
        ...
        Self: Sized,
    {
        ...
        Ok(domain::ProfileDbBuilder {
            ...
            webhook_details: item.webhook_details.map(DomainForeignInto::foreign_into),
