...
where
    address::Address:
        behaviour::Conversion<DstType = storage_types::Address, NewDstType = storage_types::AddressNew>,
{
    type Error;
    ...
    ) -> CustomResult<address::Address, Self::Error>;
    ...
    ) -> CustomResult<address::PaymentAddress, Self::Error>;
    ...
    async fn update_address_by_merchant_id_customer_id(
        ...
        address: address::AddressUpdate,
        key_store: &merchant_key_store::MerchantKeyStore,
    ) -> CustomResult<Vec<address::Address>, Self::Error>;
}
