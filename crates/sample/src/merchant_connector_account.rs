...
use hyperswitch_domain_models::{merchant_key_store, behaviour, router_data, merchant_connector_account as domain};
...
pub trait ConnectorAccessToken {
    ...
    ) -> CustomResult<Option<router_data::AccessToken>, Self::Error>;
...
//         _merchant_id: &common_utils::id_type::MerchantId,
//         _merchant_connector_id_or_connector_name: &str,
//         _access_token: router_data::AccessToken,
...
where
    domain::MerchantConnectorAccount: behaviour::Conversion<
...
//             behaviour::Conversion::convert(merchant_connector_account)
//                 .await
//                 .change_context(errors::StorageError::EncryptionError)?
...
//             let conn = connection::pg_connection_write(self).await?;
//             behaviour::Conversion::convert(this)
//                 .await
//                 .change_context(errors::StorageError::EncryptionError)?
...
//         services,
//         types::{
//             domain::{self, behaviour::behaviour::Conversion},
//             storage,
//         },
//     };
...
//                     key_manager_state,
//                     type_name!(merchant_key_store::MerchantKeyStore),
...
//             behaviour::Conversion::convert(mca)
//                 .await
//                 .change_context(errors::StorageError::DecryptionError)
//         };
