...
use diesel_models::dispute as storage;
...
pub trait DisputeInterface {
    ...
    ) -> CustomResult<storage::Dispute, Self::Error>;
    ...
    ) -> CustomResult<Option<storage::Dispute>, Self::Error>;
    ...
    ) -> CustomResult<Vec<storage::Dispute>, Self::Error>;
    ...
    ) -> CustomResult<Vec<(common_enums::enums::DisputeStatus, i64)>, Self::Error>;
}
