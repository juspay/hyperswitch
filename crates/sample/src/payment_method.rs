...
use hyperswitch_domain_models::payment_methods as domain;
use common_utils::{types::keymanager::KeyManagerState};
use diesel_models::{payment_method as storage_types, enums::MerchantStorageScheme};
...
pub trait PaymentMethodInterface {
    ...
    ) -> CustomResult<domain::PaymentMethod, Self::Error>;
    ...
    async fn find_payment_method_by_customer_id_merchant_id_list(
        ...
        limit: Option<i64>,
    ) -> CustomResult<Vec<domain::PaymentMethod>, Self::Error>;
