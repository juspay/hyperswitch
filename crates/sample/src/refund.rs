...
use diesel_models::{enums, refund as storage_types};
...
pub trait RefundInterface {
    ...
    ) -> CustomResult<storage_types::Refund, Self::Error>;
    ...
    async fn find_refund_by_payment_id_merchant_id(
        ...
        merchant_id: &common_utils::id_type::MerchantId,
        storage_scheme: enums::MerchantStorageScheme,
    ) -> CustomResult<Vec<storage_types::Refund>, Self::Error>;
    ...
    //     limit: i64,
    //     offset: i64,
    // ) -> CustomResult<Vec<diesel_models::refund::Refund>, Self::Error>;

    // TODO(jarnura): API Model use here
    // #[cfg(feature = "olap")]
    ...
    //     storage_scheme: enums::MerchantStorageScheme,
    // ) -> CustomResult<api_models::refunds::RefundListMetaData, Self::Error>;
    ...
    //     storage_scheme: enums::MerchantStorageScheme,
    // ) -> CustomResult<Vec<(common_enums::RefundStatus, i64)>, Self::Error>;
