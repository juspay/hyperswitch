...
/// Custom serialization/deserialization for `NaiveDate` as "YYYY-MM-DD" strings.
pub mod date_yyyy_mm_dd {
    ...
    /// Deserialize a [`NaiveDate`] from a `"YYYY-MM-DD"` string.
    ...
    /// Serialization/deserialization helpers for [`Option<NaiveDate>`].
    pub mod option {
        use serde::{Deserialize, Deserializer, Serializer};

        use super::*;

        /// Serialize an [`Option<NaiveDate>`] as a `"YYYY-MM-DD"` string.
        ...
        /// Deserialize an [`Option<NaiveDate>`] from a `"YYYY-MM-DD"` string.
