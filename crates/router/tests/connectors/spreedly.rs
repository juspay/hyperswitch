...
impl utils::Connector for SpreedlyTest {
    fn get_data(&self) -> api::ConnectorData {
        use hyperswitch_connectors::connectors::Spreedly;
        api::ConnectorData {
        ...
        address: Some(types::PaymentAddress::new(
            ...
            Some(api::Address {
                address: Some(api::AddressDetails {
                    ...
                    line1: Some(Secret::new("123 Test St".to_string())),
                    line2: None,
                    line3: None,
                ...
                email: Some(pii::Email::from_str("test@example.com").unwrap()),
            }),
            None,
            None,
        )),
...
fn payment_method_details() -> Option<types::PaymentsAuthorizeData> {
    Some(types::PaymentsAuthorizeData {
        ...
        confirm: true,
        customer_acceptance: Some(types::CustomerAcceptance {
            acceptance_type: types::AcceptanceType::Online,
            accepted_at: Some(common_utils::date_time::now()),
            online: Some(types::OnlineMandate {
                ip_address: Some(Secret::new("127.0.0.1".to_string())),
                user_agent: Some("test_user_agent".to_string()),
            }),
        }),
        email: Some(pii::Email::from_str("test@example.com").unwrap()),
        browser_info: Some(types::BrowserInformation {
            ip_address: Some(Secret::new("127.0.0.1".to_string())),
            user_agent: Some("test_user_agent".to_string()),
            ..Default::default()
        }),
        // Gateway token required for Spreedly authorization
        connector_meta_data: Some(Secret::new(json!({
