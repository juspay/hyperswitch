...
#[derive(Clone, Copy)]
struct MaxpayTest;
impl ConnectorActions for MaxpayTest {}
impl utils::Connector for MaxpayTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Maxpay;
        api::ConnectorData {
            connector: Box::new(Maxpay::new()),
            connector_name: types::Connector::Maxpay,
...
static CONNECTOR: MaxpayTest = MaxpayTest {};
