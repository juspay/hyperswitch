...
#[derive(Clone, Copy)]
struct ExpresscheckoutTest;
impl ConnectorActions for ExpresscheckoutTest {}
impl utils::Connector for ExpresscheckoutTest {
    fn get_data(&self) -> types::api::ConnectorData {
        use router::connector::Expresscheckout;
        types::api::ConnectorData {
            connector: Box::new(&Expresscheckout),
            connector_name: types::Connector::Expresscheckout,
    ...
    fn get_name(&self) -> String {
        "expresscheckout".to_string()
    }
}

static CONNECTOR: ExpresscheckoutTest = ExpresscheckoutTest {};
