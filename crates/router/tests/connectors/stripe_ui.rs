...
async fn should_make_afterpay_payment(c: WebDriver) -> Result<(), WebDriverError> {
    ...
    conn.make_redirection_payment(c,
        vec![
            ...
            Event::Trigger(Trigger::Click(By::Id("card-submit-btn"))),
            Event::Trigger(Trigger::Click(By::Css("a[class='common-Button common-Button--default']"))),
            Event::Assert(Assert::IsPresent("Google")),
            Event::Assert(Assert::Contains(Selector::QueryParamStr, "status=succeeded"))
    ]).await?;
    Ok(())
...
async fn should_make_stripe_alipay_payment(c: WebDriver) -> Result<(), WebDriverError> {
    ...
    conn.make_redirection_payment(c,
        vec![
            ...
            Event::Trigger(Trigger::Click(By::Id("card-submit-btn"))),
            Event::Trigger(Trigger::Click(By::Css("button[class='common-Button common-Button--default']"))),
            Event::Trigger(Trigger::Sleep(5)),
            Event::Assert(Assert::IsPresent("Google")),
            Event::Assert(Assert::Contains(Selector::QueryParamStr, "status=succeeded"))
    ]).await?;
...
async fn should_make_stripe_ideal_bank_redirect_payment(c: WebDriver) -> Result<(), WebDriverError> {
    let conn = StripeSeleniumTest {};
    conn.make_redirection_payment(c,
        vec![
...
async fn should_make_stripe_giropay_bank_redirect_payment(c: WebDriver) -> Result<(), WebDriverError> {
    let conn = StripeSeleniumTest {};
    conn.make_redirection_payment(c,
        vec![
...
async fn should_make_stripe_bancontact_card_redirect_payment(c: WebDriver) -> Result<(), WebDriverError> {
    let conn = StripeSeleniumTest {};
    conn.make_redirection_payment(c,
        vec![
...
async fn should_make_stripe_sofort_redirect_payment(c: WebDriver) -> Result<(), WebDriverError> {
    ...
    conn.make_redirection_payment(c,
        vec![
            ...
            Event::Trigger(Trigger::Click(By::Css("a[class='common-Button common-Button--default']"))),
            Event::Assert(Assert::IsPresent("Google")),
            Event::Assert(Assert::ContainsAny(Selector::QueryParamStr, vec!["status=processing", "status=succeeded"]))
    ]).await?;
    Ok(())
}
...
async fn should_make_stripe_ach_bank_debit_payment(c: WebDriver) -> Result<(), WebDriverError> {
    ...
    conn.make_redirection_payment(c,
        vec![
            ...
            Event::Trigger(Trigger::Click(By::Id("card-submit-btn"))),
            Event::Trigger(Trigger::SendKeys(By::Css("input[class='p-CodePuncher-controllingInput']"), "11AA")),
            Event::Trigger(Trigger::Click(By::Css("div[class='SubmitButton-IconContainer']"))),
