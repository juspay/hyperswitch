...
impl utils::Connector for PayloadTest {
    fn get_data(&self) -> api::ConnectorData {
        ...
        api::ConnectorData {
            connector: Box::new(Payload::new()),
            connector_name: types::Connector::Payload,
    ...
    Some(utils::PaymentInfo {
        address: Some(types::PaymentAddress::new(
            ...
            Some(api::Address {
                ...
                email: Some(masking::Secret::new("john.doe@example.com".to_string())),
            }),
            None,
        )),
        access_token: None,
...
fn payment_method_details() -> Option<types::PaymentsAuthorizeData> {
    Some(types::PaymentsAuthorizeData {
        payment_method_data: types::api::PaymentMethodData::Card(api::Card {
            card_number: Secret::new("4111111111111111".to_string()), // Visa test card
        ...
        payment_method_data_billing: None,
