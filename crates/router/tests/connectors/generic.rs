...
#[derive(Clone, Copy)]
struct GenericTest;
impl ConnectorActions for GenericTest {}
impl utils::Connector for GenericTest {
    fn get_data(&self) -> types::api::ConnectorData {
        use router::connector::Generic;
        types::api::ConnectorData {
            connector: Box::new(&Generic),
            connector_name: types::Connector::Generic,
...
static CONNECTOR: GenericTest = GenericTest {};
