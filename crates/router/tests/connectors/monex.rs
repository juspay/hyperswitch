...
use common_enums::{self, Currency};
...
#[derive(Clone, Copy)]
struct MonexTest;
impl ConnectorActions for MonexTest {}
impl utils::Connector for MonexTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Monex;
        api::ConnectorData {
            connector: Box::new(Monex::new()),
            connector_name: types::Connector::Monex,
...
static CONNECTOR: MonexTest = MonexTest {};
        ...
        address: Some(types::PaymentAddress::new(
            ...
            Some(hyperswitch_domain_models::address::Address {
                address: Some(hyperswitch_domain_models::address::AddressDetails {
                    ...
                    country: Some(common_enums::Country::US),
                }),
                ...
                email: Some(hyperswitch_domain_models::address::EmailDetails {
                    id: Secret::new("user@example.com".to_string()),
                }),
            }),
            None,
        )),
