...
#[derive(Clone, Copy)]
struct MoneiTest;
impl ConnectorActions for MoneiTest {}
impl utils::Connector for MoneiTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Monei;
        api::ConnectorData {
            connector: Box::new(Monei::new()),
            connector_name: types::Connector::Monei,
...
static CONNECTOR: MoneiTest = MoneiTest {};
