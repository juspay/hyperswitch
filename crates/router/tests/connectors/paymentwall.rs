...
#[derive(Clone, Copy)]
struct PaymentwallTest;
impl ConnectorActions for PaymentwallTest {}
impl utils::Connector for PaymentwallTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Paymentwall;
        utils::construct_connector_data_old(
            Box::new(Paymentwall::new()),
    ...
    fn get_name(&self) -> String {
        "paymentwall".to_string()
    }
}

static CONNECTOR: PaymentwallTest = PaymentwallTest {};
