...
pub use hyperswitch_connectors::connectors::{
    ...
    hyperswitch_vault::HyperswitchVault, hyperswitchpeach, hyperswitchpeach::Hyperswitchpeach,
    hyperwallet, hyperwallet::Hyperwallet, iatapay, iatapay::Iatapay, imerchantsolutions,
