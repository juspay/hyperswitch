...
pub use hyperswitch_connectors::connectors::{
    ...
    redsys::Redsys, revolv3, revolv3::Revolv3, riskified, riskified::Riskified, absa_sanlam,
    absa_sanlam::AbsaSanlam, santander, santander::Santander, shift4, shift4::Shift4, sift, sift::Sift,
