...
pub use hyperswitch_connectors::connectors::{
    ...
    etisalat, etisalat::Etisalat, facilitapay, facilitapay::Facilitapay, finix, finix::Finix,
    fiserv, fiserv::Fiserv, fiservcommercehub, fiservcommercehub::Fiservcommercehub, fiservemea,
