...
pub use hyperswitch_connectors::connectors::{
    ...
    riskified, riskified::Riskified, shift4, shift4::Shift4, signifyd, signifyd::Signifyd,
    spreedly, spreedly::Spreedly, square, square::Square, stax, stax::Stax, stripe, stripe::Stripe,
