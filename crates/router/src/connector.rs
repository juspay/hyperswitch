...
pub use hyperswitch_connectors::connectors::{
    ...
    stripe::Stripe, stripebilling, stripebilling::Stripebilling, taxjar, taxjar::Taxjar, tdaypay,
    tdaypay::Tdaypay, tesouro, tesouro::Tesouro, threedsecureio, threedsecureio::Threedsecureio,
