...
pub use hyperswitch_connectors::connectors::{
    ...
    juspaythreedsserver::Juspaythreedsserver, klarna, klarna::Klarna, maxpay, maxpay::Maxpay,
    ...
    shift4::Shift4, signifyd, signifyd::Signifyd, spreedly, spreedly::Spreedly, square,
