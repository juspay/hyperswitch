...
pub use hyperswitch_connectors::connectors::{
    ...
    digitalvirgo::Digitalvirgo, dlocal, dlocal::Dlocal, dotpay, dotpay::Dotpay, ebanx,
    ...
    shift4::Shift4, signifyd, signifyd::Signifyd, spreedly, spreedly::Spreedly, square, square::Square, stax, stax::Stax, stripe,
