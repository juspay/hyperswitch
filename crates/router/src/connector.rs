...
pub use hyperswitch_connectors::connectors::{
    ...
    redsys::Redsys, shift4, shift4::Shift4, square, square::Square, stax, stax::Stax, stripebilling,
    stripebilling::Stripebilling, taxjar, taxjar::Taxjar, thunes, thunes::Thunes, tsys, tsys::Tsys, unified_authentication_service,
