...
pub use hyperswitch_connectors::connectors::{
    ...
    globalpayments_heartland::GlobalpaymentsHeartland, globalpayments_realex,
    globalpayments_realex::GlobalpaymentsRealex, globepay, globepay::Globepay, gocardless,
