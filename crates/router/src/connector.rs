...
pub use hyperswitch_connectors::connectors::{
    ...
    gigadat::Gigadat, givepayments, givepayments::Givepayments, globalpay, globalpay::Globalpay, globalpaymentsheartland,
    globalpaymentsheartland::GlobalpaymentsHeartland,
