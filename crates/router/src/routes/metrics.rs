...
// Save-payment-method async flow failures (#12904)
counter_metric!(SAVE_PAYMENT_METHOD_LOCKER_SAVE_FAILURE, GLOBAL_METER);
counter_metric!(SAVE_PAYMENT_METHOD_ATTEMPT_UPDATE_ENQUEUED, GLOBAL_METER);
counter_metric!(
    SAVE_PAYMENT_METHOD_ATTEMPT_UPDATE_ENQUEUE_FAILURE,
    GLOBAL_METER
);
counter_metric!(
    SAVE_PAYMENT_METHOD_ATTEMPT_UPDATE_RETRIES_EXCEEDED,
    GLOBAL_METER
);
counter_metric!(
    SAVE_PAYMENT_METHOD_ATTEMPT_UPDATE_ATTEMPT_NOT_FOUND,
    GLOBAL_METER
);
