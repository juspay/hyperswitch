...
#[utoipa::path(
    ...
    params (
        ...
        ("card_networks" = Option<Vec<CardNetwork>>, Query, description = "Indicates whether the payment method is eligible for card networks"),
        ),
    responses(
...
#[utoipa::path(
    ...
    params (
        ("customer_id" = String, Query, description = "The unique identifier for the customer account"),
        ("client-secret" = Option<String>, Query, description = "A secret known only to your client and the authorization server. Used for client side authentication"),
        ("accepted_country" = Option<Vec<String>>, Query, description = "The two-letter ISO currency code"),
        ("accepted_currency" = Option<Vec<Currency>>, Query, description = "The three-letter ISO currency code"),
        ("minimum_amount" = Option<i64>, Query, description = "The minimum amount accepted for processing by the particular payment method."),
        ("maximum_amount" = Option<i64>, Query, description = "The maximum amount accepted for processing by the particular payment method."),
        ("recurring_payment_enabled" = Option<bool>, Query, description = "Indicates whether the payment method is eligible for recurring payments"),
        ("installment_payment_enabled" = Option<bool>, Query, description = "Indicates whether the payment method is eligible for installment payments"),
    ),
    responses(
