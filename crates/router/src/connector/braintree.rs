...
impl ConnectorCommon for Braintree {
    ...
    fn build_error_response(
        ...
        let response: Result<braintree::ErrorResponses, Report<common_utils::errors::ParsingError>> =
    ...
    for Braintree
{
    ...
    fn get_request_body(
        ...
        let connector_router_data =
            transformers::BraintreeRouterData::try_from((
            ...
            let connector_req =
                transformers::BraintreeCaptureRequest::try_from(
    ...
    for Braintree
{
    ...
    fn get_request_body(
        ...
        let connector_req =
            transformers::BraintreePSyncRequest::try_from(req)?;
    ...
    fn get_request_body(
        ...
        let connector_router_data =
            ...
            let connector_req: transformers::BraintreePaymentsRequest =
                transformers::BraintreePaymentsRequest::try_from(
                    &connector_router_data,
                )?;
            Ok(RequestContent::Json(Box::new(connector_req)))
    }
    ...
    for Braintree
{
    ...
    fn get_request_body(
        ...
        let connector_req =
            transformers::BraintreeCancelRequest::try_from(req)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
            }
    ...
    for Braintree
{
    ...
    fn get_request_body(
        ...
        let connector_req =
                    transformers::BraintreeRefundRequest::try_from(
                        connector_router_data,
                    )?;
        Ok(RequestContent::Json(Box::new(connector_req)))
        }
    ...
    for Braintree
{
    ...
    fn get_request_body(
        ...
        _connectors: &settings::Connectors,
            ...
            let connector_req =
                    transformers::BraintreeRSyncRequest::try_from(req)?;
                Ok(RequestContent::Json(Box::new(connector_req)))
            }
        ...
        match response.dispute {
            Some(dispute_data) => {
                ...
                Ok(api::disputes::DisputePayload {
                    ...
                    dispute_stage: transformers::get_dispute_stage(
    ...
    fn get_flow_type(
        ...
        match action {
            services::PaymentAction::PSync => match json_payload {
                Some(payload) => {
                    let redirection_response:transformers::BraintreeRedirectionResponse = serde_json::from_value(payload)
                    ...
                    let braintree_payload =
                        serde_json::from_str::<
                            transformers::BraintreeThreeDsErrorResponse,
