...
use crate::{
    connector::utils::{
        CardData, PaymentsAuthorizeRequestData, PaymentsCancelRequestData, WalletData, self,
    },
    consts,
    core::errors,
    services,
...
> {
    match wallet {
        ...
        api_models::payments::WalletData::SwishQr(_) => Err(errors::ConnectorError::NotImplemented(
            utils::get_unimplemented_payment_method_error_message("nexinets"),
        ))?,
    }
}
