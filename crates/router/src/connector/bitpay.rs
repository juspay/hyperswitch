...
impl api::IncomingWebhook for Bitpay {
    ...
    fn get_webhook_event_type(
        ...
        match notif.event.name {
            ...
            bitpay::WebhookEventType::Unknown | bitpay::WebhookEventType::Expired | bitpay::WebhookEventType::Invalid | bitpay::WebhookEventType::Refunded | bitpay::WebhookEventType::Resent
