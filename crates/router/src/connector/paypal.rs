...
impl Paypal {
    pub fn connector_transaction_id(
        ...
        match payment_method {
            Some(storage_models::enums::PaymentMethod::Wallet) | Some(storage_models::enums::PaymentMethod::BankRedirect) => {
    ...
    for Paypal
{
    ...
    fn handle_response(
        ...
        match data.payment_method {
            storage_models::enums::PaymentMethod::Wallet | storage_models::enums::PaymentMethod::BankRedirect=> {
    ...
    for Paypal
{
    ...
    fn get_url(
        ...
        match req.payment_method {
            storage_models::enums::PaymentMethod::Wallet | storage_models::enums::PaymentMethod::BankRedirect=> Ok(format!(
                "{}v2/checkout/orders/{}",
                self.base_url(connectors),
                paypal_meta.order_id
            )),
