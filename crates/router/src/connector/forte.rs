    ...
    for Forte
{
    ...
    fn get_url(
        ...
        let _connector_payment_id = &req.request.connector_transaction_id;
        Ok(format!(
            "{}organizations/org_436916/locations/loc_314205/transactions",
            _connectors.forte.base_url
        ))
    }
    ...
    fn get_request_body(
        ...
        let void_req = utils::Encode::<forte::ForteVoidRequest>::convert_and_encode(_req)
            .change_context(errors::ConnectorError::RequestEncodingFailed)?;
        println!("void req is {}", void_req);
        Ok(Some(void_req))
    }
    ...
    for Forte
{
    ...
    fn get_url(
        ...
        Ok(format!(
            "{}organizations/org_436916/locations/loc_314205/transactions{}",
            _connectors.forte.base_url, connector_payment_id
        ))
    }
    ...
    for Forte
{
    ...
    fn get_request_body(
        ...
        let capt_req = utils::Encode::<forte::ForteCaptureRequest>::convert_and_encode(_req)
            .change_context(errors::ConnectorError::RequestEncodingFailed)?;
        println!("capt req is {}", capt_req);
        Ok(Some(capt_req))
    }
    ...
    fn handle_response(
        ...
        let response: forte::ForteCaptureResponse = res
            .response
            .parse_struct("Forte CaptureResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
