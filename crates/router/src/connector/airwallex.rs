    ...
    for Airwallex
{
    ...
    fn get_request_body(
        ...
        let req = utils::Encode::<airwallex::AirwallexIntentRequest>::encode_to_string_of_json(&req_obj)
...
impl
    ...
    fn get_url(&self, req: &types::PaymentsAuthorizeRouterData, connectors: &settings::Connectors,) -> CustomResult<String,errors::ConnectorError> {
        Ok(format!(
            ...
            req.reference_id.clone().ok_or(errors::ConnectorError::MissingConnectorTransactionID)?,
            "/confirm"
        ))
    }
    ...
    fn get_request_body(&self, req: &types::PaymentsAuthorizeRouterData) -> CustomResult<Option<String>,errors::ConnectorError> {
        let airwallex_req =
            utils::Encode::<airwallex::AirwallexPaymentsRequest>::convert_and_encode(req).change_context(errors::ConnectorError::RequestEncodingFailed)?;
    ...
    fn handle_response(
        ...
        let response: airwallex::AirwallexPaymentsResponse = res.response.parse_struct("AirwallexPaymentsResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
    ...
    > for Airwallex
{
    ...
    fn get_request_body(
        ...
        let airwallex_req = utils::Encode::<airwallex::AirwallexPaymentsCaptureRequest>::encode_to_string_of_json(
            &connector_req,
        )
        .change_context(errors::ConnectorError::RequestEncodingFailed)?;
        Ok(Some(airwallex_req))
    ...
    > for Airwallex
{
    ...
    fn get_request_body(
        ...
        let airwallex_req = utils::Encode::<airwallex::AirwallexPaymentsCancelRequest>::encode_to_string_of_json(
            &connector_req,
        )
        .change_context(errors::ConnectorError::RequestEncodingFailed)?;
        Ok(Some(airwallex_req))
...
impl
    ...
    fn get_request_body(&self, req: &types::RefundsRouterData<api::Execute>) -> CustomResult<Option<String>,errors::ConnectorError> {
        let airwallex_req = utils::Encode::<airwallex::AirwallexRefundRequest>::convert_and_encode(req).change_context(errors::ConnectorError::RequestEncodingFailed)?;
        Ok(Some(airwallex_req))
    }
    ...
    fn handle_response(
        ...
        let response: airwallex::RefundResponse = res.response.parse_struct("airwallex RefundResponse").change_context(errors::ConnectorError::RequestEncodingFailed)?;
        types::ResponseRouterData {
            response,
            data: data.clone(),
            http_code: res.status_code,
...
impl
    ConnectorIntegration<api::RSync, types::RefundsData, types::RefundsResponseData> for Airwallex {
    ...
    fn handle_response(
        ...
        logger::debug!(target: "router::connector::airwallex", response=?res);
        let response: airwallex::RefundResponse = res.response.parse_struct("airwallex RefundResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        types::ResponseRouterData {
            response,
            data: data.clone(),
            http_code: res.status_code,
