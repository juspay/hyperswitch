...
pub struct ConnectorMetaData {
    ...
    pub order_id: String,
    #[serde(rename(serialize = "metadata[txn_id]"))]
    pub txn_id: String,
    #[serde(rename(serialize = "metadata[txn_uuid]"))]
    pub txn_uuid: String,
...
impl TryFrom<&types::PaymentsAuthorizeRouterData> for PaymentIntentRequest {
    ...
    fn try_from(item: &types::PaymentsAuthorizeRouterData) -> Result<Self, Self::Error> {
        ...
        let txn_id = format!("{}_{}_{}", item.merchant_id, item.payment_id, "1");
        let txn_uuid = Uuid::new_v4().to_string(); //Fetch autogenerated txn_uuid from Database.
...
impl<F> TryFrom<&types::RefundsRouterData<F>> for RefundRequest {
    ...
    fn try_from(item: &types::RefundsRouterData<F>) -> Result<Self, Self::Error> {
        ...
        let txn_id = "Fetch txn_id from DB".to_string();
        let txn_uuid = "Fetch txn_id from DB".to_string();
