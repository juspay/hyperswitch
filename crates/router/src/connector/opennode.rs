...
impl ConnectorCommon for Opennode {
    ...
    fn get_auth_header(
        ...
        let auth: opennode::OpennodeAuthType = auth_type
            .try_into()
    ...
    for Opennode
{
    ...
    fn get_request_body(
        ...
        let opennode_req =
            utils::Encode::<opennode::OpennodePaymentsRequest>::encode_to_string_of_json(&req_obj)
    ...
    for Opennode
{
    ...
    fn get_request_body(
        ...
        let opennode_req =
            utils::Encode::<opennode::OpennodeRefundRequest>::convert_and_encode(req)
                .change_context(errors::ConnectorError::RequestEncodingFailed)?;
        Ok(Some(opennode_req))
    }
...
impl services::ConnectorRedirectResponse for Opennode {
    fn get_flow_type(
        &self,
        _query_params: &str,
