    ...
    > for Gpayments
{
    ...
    fn get_url(
        ...
        req.request.authentication_url.clone().ok_or(error_stack::Report::new(errors::ConnectorError::FailedToObtainIntegrationUrl))
    }
    ...
    fn handle_response(
        ...
        event_builder: Option<&mut ConnectorEvent>,
        res: Response,
    ) -> CustomResult<types::authentication::ConnectorAuthenticationRouterData, errors::ConnectorError> {
...
impl
    ...
    > for Gpayments
    {
        ...
        fn get_url(
            ...
            Ok(format!("{}/api/v2/auth/brw/result?threeDSServerTransID={}", base_url,req.request.threeds_server_transaction_id,))
        }
