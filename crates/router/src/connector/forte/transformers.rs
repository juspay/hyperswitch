...
impl<F> TryFrom<&types::RefundsRouterData<F>> for ForteRefundRequest {
    ...
    fn try_from(item: &types::RefundsRouterData<F>) -> Result<Self,Self::Error> {
        Ok(Self {
            ...
            authorization_code:item.request.authorization_code,
            entered_by:item.request.entered_by,
        })
    }
}
...
impl From<RefundStatus> for enums::RefundStatus {
    fn from(item: RefundStatus) -> Self {
        match item {
            ...
            FortePaymentStatus::Captured | FortePaymentStatus::Funded => Self::Success,
            FortePaymentStatus::Declined | FortePaymentStatus::Rejected => Self::Failure,
            FortePaymentStatus::Initiated |ForteyPaymentStatus::Pending => Self::Pending,
            _ => Self::Pending,
        }
        }
    }
