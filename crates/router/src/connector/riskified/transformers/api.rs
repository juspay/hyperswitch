            ...
            order: CheckoutRequest {
                ...
                line_items: payment_data
                    ...
                    .map(|order_detail| LineItem {
                        price: order_detail.amount.get_amount_as_i64(), // This should be changed to MiniorUnit when we implement amount conversion for this connector. Additionally, the function get_amount_as_i64() should be avoided in the future.
