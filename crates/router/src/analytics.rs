...
pub mod routes {
    ...
    use api_models::analytics::{
        ...
        GetAuthEventFilterRequest, GetDisputeMetricRequest, GetFrmFilterRequest,
        GetFrmMetricRequest, GetPaymentFiltersRequest, GetPaymentIntentMetricRequest,
    ...
    use api_models::analytics::{
        ...
        GetPaymentIntentFiltersRequest, GetSdkEventFiltersRequest, GetSdkEventMetricRequest,
        ReportRequest,
    };
