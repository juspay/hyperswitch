    ...
    async fn update_mandate_by_merchant_id_mandate_id(
        ...
        match storage_scheme {
            ...
            MerchantStorageScheme::RedisKv => {
                ...
                if let diesel_models::MandateUpdate::ConnectorMandateIdUpdate { connector_mandate_id : Some(val) ,..} = &mandate_update
                {
                ...
                kv_wrapper::<(), _, _>(
                    self,
                    KvOperation::<diesel_models::Mandate>::Hset((&field, redis_value), redis_entry),
                    key,
                )
                .await
        ...
        match storage_scheme {
            ...
            MerchantStorageScheme::RedisKv => {
                ...
                if let Some(connector_val) = connector_mandate_id {
                    let lookup_id = format!("mid_{}_conn_mandate_{}", merchant_id, connector_val);
