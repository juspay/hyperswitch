...
impl RoleInterface for Store {
    ...
    async fn find_role_by_role_id(
        ...
        storage::Role::find_by_role_id(&mut conn, role_id)
            .await
            .map_err(|error| report!(errors::StorageError::from(error)))
    }
    ...
    async fn find_by_role_id_org_id_tenant_id(
        ...
        let mut conn = connection::pg_connection_read(self).await?;
        storage::Role::find_by_role_id_org_id_tenant_id(&mut conn, role_id, org_id, tenant_id)
            .await
            .map_err(|error| report!(errors::StorageError::from(error)))
    }
    ...
    async fn update_role_by_role_id(
        ...
        let mut conn = connection::pg_connection_write(self).await?;
        storage::Role::update_by_role_id(&mut conn, role_id, role_update)
            .await
            .map_err(|error| report!(errors::StorageError::from(error)))
    }
    ...
    async fn delete_role_by_role_id(
        ...
        let mut conn = connection::pg_connection_write(self).await?;
        storage::Role::delete_by_role_id(&mut conn, role_id)
            .await
            .map_err(|error| report!(errors::StorageError::from(error)))
    }
