...
/// Creates a Redis connection pool for the specified Redis settings/// # Panics
///
...
pub async fn redis_connection(
    ...
    redis_interface::RedisConnectionPool::new_without_event_emitter(&conf.redis) //check why this has to be without event emitter
        .await
