...
impl ForeignTryFrom<api_enums::Connector> for common_enums::RoutableConnectors {
    ...
    fn foreign_try_from(from: api_enums::Connector) -> Result<Self, Self::Error> {
        Ok(match from {
            ...
            // api_enums::Connector::juspaythreedsserver => Self::juspaythreedsserver,
...
impl ForeignFrom<&storage::Authentication> for payments::ExternalAuthenticationDetailsResponse {
    fn foreign_from(authn_data: &storage::Authentication) -> Self {
        ...
        Self {
            ...
            ds_transaction_id: authn_data.ds_trans_id.clone(),
            three_ds_server_trans_id: authn_data.threeds_server_transaction_id.clone(),
            transaction_status: authn_data.trans_status.clone(),
            authentication_value: authn_data.cavv.clone(),
            version,
