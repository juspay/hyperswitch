...
impl From<F<storage_enums::AttemptStatus>> for F<storage_enums::IntentStatus> {
    fn from(s: F<storage_enums::AttemptStatus>) -> Self {
        match s.0 {
            ...
            storage_enums::AttemptStatus::PendingCustomerAuthentication => {
                storage_enums::IntentStatus::RequiresCustomerAction
            }

            storage_enums::AttemptStatus::PartialCharged
            | storage_enums::AttemptStatus::Started
            | storage_enums::AttemptStatus::CustomerAuthenticationSuccessful
            ...
            | storage_enums::AttemptStatus::OrcaDeclined
