    ...
    pub fn convert_connector(
        ...
        match enums::Connector::from_str(connector_name) {
            Ok(name) => match name {
                ...
                enums::Connector::DummyConnector1 => Ok(Box::new(&connector::DummyConnector)),
                #[cfg(feature = "dummy_connector")]
                enums::Connector::DummyConnector2 => Ok(Box::new(&connector::DummyConnector)),
                #[cfg(feature = "dummy_connector")]
                enums::Connector::DummyConnector3 => Ok(Box::new(&connector::DummyConnector)),
                #[cfg(feature = "dummy_connector")]
                enums::Connector::DummyConnector4 => Ok(Box::new(&connector::DummyConnector)),
                #[cfg(feature = "dummy_connector")]
                enums::Connector::DummyConnector5 => Ok(Box::new(&connector::DummyConnector)),
                #[cfg(feature = "dummy_connector")]
                enums::Connector::DummyConnector6 => Ok(Box::new(&connector::DummyConnector)),
                #[cfg(feature = "dummy_connector")]
                enums::Connector::DummyConnector7 => Ok(Box::new(&connector::DummyConnector)),
