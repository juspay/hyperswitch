                                        ...
                                        non_mandate: HashMap::from([
                                            ...
                                            (
                                                ...
                                                RequiredFieldInfo {
                                                    ...
                                                    display_name: "country".to_string(),                                                        field_type: enums::FieldType::UserShippingAddressCountry{
                                                    options: vec![
                                                            "GB".to_string(),
                                                        ]
                                                    },
                                            ...
                                            (
                                                ...
                                                RequiredFieldInfo {
                                                    required_field: "payment_method_data.shipping.address.line2".to_string(),
                                                    display_name: "street".to_string(),
                                                    field_type: enums::FieldType::UserShippingAddressLine1,
                                                    value: None,
                                                }
                                            ),
