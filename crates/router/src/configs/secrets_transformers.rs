...
impl SecretsHandler for settings::GooglePayDecryptConfig {
    async fn convert_to_raw_secret(
        ...
        let (google_pay_root_signing_keys, google_pay_recipient_id, google_pay_private_key) = tokio::try_join!(
            secret_management_client
                .get_secret(google_pay_decrypt_keys.google_pay_root_signing_keys.clone()),
            secret_management_client
                .get_secret(google_pay_decrypt_keys.google_pay_recipient_id.clone()),
            secret_management_client
                .get_secret(google_pay_decrypt_keys.google_pay_private_key.clone()),
        )?;
