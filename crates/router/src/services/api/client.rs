...
pub fn proxy_bypass_urls(
    ...
    let proxy_list = [
        ...
        format!("{locker_host}/api/v2/vault/add"),
        format!("{locker_host}/api/v2/vault/fingerprint"),
        format!("{locker_host}/api/v2/vault/retrieve"),
        format!("{locker_host}/api/v2/vault/delete"),
