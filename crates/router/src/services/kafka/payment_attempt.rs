...
impl<'a> KafkaPaymentAttempt<'a> {
    pub fn from_storage(attempt: &'a PaymentAttempt) -> Self {
        Self {
            ...
            amount: attempt.amount.get_amount_as_i64(),
            currency: attempt.currency,
            save_to_locker: attempt.save_to_locker,
            connector: attempt.connector.as_ref(),
            error_message: attempt.error_message.as_ref(),
            offer_amount: MinorUnit::get_optional_amount_as_i64(attempt.offer_amount),
            surcharge_amount: MinorUnit::get_optional_amount_as_i64(attempt.surcharge_amount),
            tax_amount: MinorUnit::get_optional_amount_as_i64(attempt.tax_amount),
            ...
            amount_to_capture: MinorUnit::get_optional_amount_as_i64(attempt.amount_to_capture),
            ...
            amount_capturable: attempt.amount_capturable.get_amount_as_i64(),
            merchant_connector_id: attempt.merchant_connector_id.as_ref(),
            net_amount: attempt.net_amount.get_amount_as_i64(),
