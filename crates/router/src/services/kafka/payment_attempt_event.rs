...
pub struct KafkaPaymentAttemptEvent<'a> {
    ...
    pub recovered_from_error_code: Option<&'a String>,
    pub recovered_from_error_reason: Option<&'a String>,
    pub recovered_from_standardised_code: Option<&'a String>,
    pub recovered_from_connector: Option<&'a String>,
...
impl<'a> KafkaPaymentAttemptEvent<'a> {
    pub fn from_storage(attempt: &'a PaymentAttempt) -> Self {
        ...
        Self {
            ...
            recovered_from_error_code: attempt.recovered_from_error_code.as_ref(),
            recovered_from_error_reason: attempt.recovered_from_error_reason.as_ref(),
            recovered_from_standardised_code: attempt.recovered_from_standardised_code.as_ref(),
            recovered_from_connector: attempt.recovered_from_connector.as_ref(),
            ...
            standardised_code: attempt
                .error_details
                .as_ref()
                .and_then(|details| details.unified_details.as_ref())
                .and_then(|unified| unified.standardised_code.as_ref())
...
impl<'a> KafkaPaymentAttemptEvent<'a> {
    pub fn from_storage(attempt: &'a PaymentAttempt) -> Self {
        ...
        Self {
            ...
            recovered_from_error_code: recovered_from_error_code.as_ref(),
            recovered_from_error_reason: recovered_from_error_reason.as_ref(),
            recovered_from_standardised_code: recovered_from_standardised_code.as_ref(),
            recovered_from_connector: recovered_from_connector.as_ref(),
