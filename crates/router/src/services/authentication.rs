...
use self::{
    blacklist::BlackList,
    detached::{ExtractedPayload, GetAuthType},
};
...
//
#[cfg(feature = "partial-auth")]
pub struct HeaderAuth<I, A>(I, std::marker::PhantomData<fn() -> A>);
...
#[async_trait]
impl<A, I> AuthenticateAndFetch<AuthenticationData, A> for HeaderAuth<I, A>
where
    A: AppStateInfo + Sync,
