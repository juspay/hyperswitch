...
pub static PREDEFINED_ROLES: LazyLock<HashMap<&'static str, RoleInfo>> = LazyLock::new(|| {
    ...
    roles.insert(
        ...
        RoleInfo {
            groups: vec![
                ...
                PermissionGroup::ReconDataView,
                PermissionGroup::ReconDataManage,
    ...
    roles.insert(
        consts::user_role::ROLE_ID_RECON_ANALYST,
        RoleInfo {
            groups: vec![
                PermissionGroup::ReconOpsView,
                PermissionGroup::ReconDataView,
            ...
            role_id: consts::user_role::ROLE_ID_RECON_ANALYST.to_string(),
            role_name: "recon_analyst".to_string(),
            scope: RoleScope::Organization,
            entity_type: EntityType::Merchant,
            is_invitable: true,
            is_deletable: true,
    ...
    roles.insert(
        consts::user_role::ROLE_ID_RECON_VIEW_ONLY,
        RoleInfo {
            groups: vec![
                PermissionGroup::ReconOpsView,
                PermissionGroup::ReconDataView,
            ...
            role_id: consts::user_role::ROLE_ID_RECON_VIEW_ONLY.to_string(),
    ...
    roles.insert(
        consts::user_role::ROLE_ID_RECON_IAM_ADMIN,
        RoleInfo {
            groups: vec![
                PermissionGroup::ReconOpsView,
                PermissionGroup::ReconDataView,
            ...
            role_id: consts::user_role::ROLE_ID_RECON_IAM_ADMIN.to_string(),
            role_name: "recon_iam".to_string(),
            scope: RoleScope::Organization,
            entity_type: EntityType::Merchant,
            is_invitable: true,
            is_deletable: true,
    ...
    roles.insert(
        consts::user_role::ROLE_ID_RECON_DEVELOPER,
        RoleInfo {
            groups: vec![
                PermissionGroup::ReconOpsView,
                PermissionGroup::ReconOpsManage,
            ...
            role_id: consts::user_role::ROLE_ID_RECON_DEVELOPER.to_string(),
            role_name: "recon_developer".to_string(),
            scope: RoleScope::Organization,
            entity_type: EntityType::Merchant,
            is_invitable: true,
            is_deletable: true,
