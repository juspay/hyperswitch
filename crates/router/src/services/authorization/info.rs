...
fn get_group_description(group: PermissionGroup) -> Option<&'static str> {
    match group {
        ...
        PermissionGroup::LegacyReconReportsView => Some("View reconciliation reports and analytics"),
        PermissionGroup::LegacyReconReportsManage => Some("Manage reconciliation reports"),
        PermissionGroup::LegacyReconOpsView => Some("View and access all reconciliation operations including reports and analytics"),
        PermissionGroup::LegacyReconOpsManage => Some("Manage all reconciliation operations including reports and analytics"),
...
pub fn get_parent_group_description(group: ParentGroup) -> Option<&'static str> {
    match group {
        ...
        ParentGroup::LegacyReconOps => Some("View, manage reconciliation operations like upload and process files, run reconciliation etc"),
        ParentGroup::LegacyReconReports => Some("View, manage reconciliation reports and analytics"),
