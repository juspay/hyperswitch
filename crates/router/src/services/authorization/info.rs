...
fn get_group_description(group: PermissionGroup) -> Option<&'static str> {
    match group {
        ...
        PermissionGroup::WebhooksView => Some("View Merchant webhooks"),
        PermissionGroup::WebhooksManage => Some("Create, modify and delete Merchant webhooks"),
        PermissionGroup::ApiKeysView => Some("View Merchant API keys"),
        PermissionGroup::ApiKeysManage => Some("Create, modify and delete Merchant API keys"),
...
pub fn get_parent_group_description(group: ParentGroup) -> Option<&'static str> {
    match group {
        ...
        ParentGroup::Account => Some("Create, modify and delete Merchant account details"),
        ParentGroup::Webhook => Some("Create, modify and delete Merchant webhooks"),
        ParentGroup::ApiKeys => Some("Create, modify and delete Merchant API keys"),
