...
pub trait ConnectorIntegrationNew<T, Req, Resp> {
    fn get_headers(
        &self,
        _req: &types::RouterDataNew<T, Req, Resp>,
    ...
    async fn execute_pretasks(
        &self,
        _router_data: &mut types::RouterDataNew<T, Req, Resp>,
        _app_state: &AppState,
    ) -> CustomResult<(), errors::ConnectorError> {
        Ok(())
    }
    ...
    fn build_request_new(
        &self,
        req: &types::RouterDataNew<T, Req, Resp>,
        _connectors: &Connectors,
    ...
    fn handle_response_new(
        &self,
        data: &types::RouterDataNew<T, Req, Resp>,
        event_builder: Option<&mut ConnectorEvent>,
        _res: types::Response,
    ) -> CustomResult<types::RouterDataNew<T, Req, Resp>, errors::ConnectorError>
    where
        T: Clone,
        Req: Clone,
        Resp: Clone,
