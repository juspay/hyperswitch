...
pub fn build_payment_link_html(
    ...
    let css_template = include_str!("../core/payment_link/payment_link_initiate/payment_link.css").to_string();
    ...
    let js_template = include_str!("../core/payment_link/payment_link_initiate/payment_link.js").to_string();
    ...
    let html_template = include_str!("../core/payment_link/payment_link_initiate/payment_link.html").to_string();
...
pub fn get_payment_link_status(
    ...
    // Add modification to css template with dynamic data
    let css_template = include_str!("../core/payment_link/payment_link_status/status.css").to_string();
    let _ = tera.add_raw_template("payment_link_css", &css_template);
    let mut context = Context::new();
    context.insert("css_color_scheme", &payment_link_data.css_script);
    ...
    let rendered_css = match tera.render("payment_link_css", &context) {
     ...
     // Add modification to js template with dynamic data
    let js_template = include_str!("../core/payment_link/payment_link_status/status.js").to_string();
    let _ = tera.add_raw_template("payment_link_js", &js_template);
    context.insert("payment_details_js_script", &payment_link_data.js_script);
    ...
    // Modify Html template with rendered js and rendered css files
    let html_template = include_str!("../core/payment_link/payment_link_status/status.html").to_string();
