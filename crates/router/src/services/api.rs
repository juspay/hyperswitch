...
pub async fn send_request(
    ...
    headers_with_request_id.insert((crate::headers::X_REQUEST_ID.to_string(), state.api_client.get_request_id().ok_or(errors::ApiClientError::InternalServerErrorReceived).into_report()?.into()));
