...
pub async fn send_request(
    ...
    let proxy_excluded_urls = if url.starts_with(&state.conf.connectors.dummyconnector.base_url) {
    ...
    let proxy_excluded_urls = client::proxy_bypass_urls(&state.conf.locker);
