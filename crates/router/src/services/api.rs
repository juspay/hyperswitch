    ...
    match form {
        ...
        RedirectForm::Nexixpay {
            ...
            html {
                ...
                (PreEscaped(format!("<form name="redirect" action="{three_ds_auth_url}" method="POST">
                        <input type=hidden name="ThreeDsRequest" value="{three_ds_request}" />
                        <input type=hidden name="ReturnUrl" value="{return_url}" />
                        <input type=hidden name="transactionId" value="{operation_id}" />
               </form>")))
              (PreEscaped(r#"<script>
