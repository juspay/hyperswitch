...
use api_models::{
    ...
    payment_methods::{
        ...
        PaymentMethodsData, RequiredFieldInfo, ResponsePaymentMethodIntermediate,
...
pub async fn filter_payment_methods(
    ...
    for payment_method in payment_methods.into_iter() {
        ...
        if let Ok(payment_methods_enabled) = parse_result {
            ...
            let allowed_currency = payment_intent
                .as_ref()
                ...
                .unwrap_or_default()
            {
                ...
                let context = euclid::dssa::graph::AnalysisContext::from_dir_values([
                    pm_dir_value.clone(),
                    DirValue::BillingCountry(common_enums::Country::from_alpha2(
                        address.unwrap().country.unwrap(),
                    )),
