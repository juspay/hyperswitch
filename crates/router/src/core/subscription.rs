pub mod utils;
use utils::{self as subscription_types, get_or_create_customer, CreateSubscriptionResponse, Subscription, SubscriptionStatus, SUBSCRIPTION_ID_PREFIX};
...
use utils::get_customer_details_from_request;
...
pub async fn create_subscription(
    ...
    {
        response.customer =
            get_or_create_customer(&state, &customer, &merchant_context).await?;
        response
            .customer
            .as_ref()
