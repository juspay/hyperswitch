...
// =============================================================================
// PayoutGateway Implementation for domain::PoFulfill
// =============================================================================
        ...
        + RouterDataConversion<Self, types::PayoutsData, types::PayoutsResponseData>,
{
    ...
    > {
        ...
        logger::debug!("Granular Gateway: Payout fulfill flow");
        let granular_payout_transfer_request =
            payments_grpc::PayoutServiceTransferRequest::foreign_try_from(router_data)
                .change_context(ConnectorError::RequestEncodingFailed)
                        ...
                        Err(report) => {
                                ...
                                report.current_context()
                            {
                                ...
                                return Ok((
                                    router_data,
                                    (),
                                    payments_grpc::PayoutServiceTransferResponse::default(),
                                ));
                            }
