...
// =============================================================================
// PayoutGateway Implementation for domain::PoRecipientAccount
// =============================================================================
        ...
        + RouterDataConversion<Self, types::PayoutsData, types::PayoutsResponseData>,
{
    ...
    > {
        ...
        logger::debug!("Granular Gateway: Payout recipient_account flow");
        let granular_payout_enroll_disburse_account_request =
            payments_grpc::PayoutServiceEnrollDisburseAccountRequest::foreign_try_from(router_data)
                .change_context(ConnectorError::RequestEncodingFailed)
                .attach_printable("Failed to construct Payout Enroll Disburse Account Request")?;
        ...
        let updated_router_data = Box::pin(unified_connector_service::ucs_logging_wrapper_granular(
            ...
            |mut router_data, granular_payout_enroll_disburse_account_request, grpc_headers| async move {
                    ...
                    Err(report) => {
                            ...
                            report.current_context()
                        {
                            ...
                            return Ok((
                                router_data,
                                (),
                                payments_grpc::PayoutServiceEnrollDisburseAccountResponse::default(),
                            ));
                        }
                ...
                Ok((router_data, (), payout_enroll_disburse_account_response))
            },
        ))
        .await
