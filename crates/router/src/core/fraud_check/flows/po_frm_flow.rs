...
use crate::{
    ...
    types::{
        ...
        domain,
        fraud_check::{FraudCheckPayoutData, FraudCheckResponseData},
    ...
    ) -> RouterResult<RouterData<frm_api::PoFrm, FraudCheckPayoutData, FraudCheckResponseData>>
    {
        ...
        Ok(RouterData {
            ...
            request: FraudCheckPayoutData {
                ...
                gateway: self.payout_attempt.connector.clone(),
                gateway_metadata: get_payout_gateway_frm_metadata(
            ...
            connector_request_reference_id: self.fraud_check.frm_id.clone(),
...
#[async_trait]
impl FeatureFrm<frm_api::PoFrm, FraudCheckPayoutData> for PoFrmRouterData {
...
async fn decide_frm_flow(
    router_data: &mut PoFrmRouterData,
    state: &SessionState,
    connector: &FraudCheckConnectorData,
    call_connector_action: payments::CallConnectorAction,
    _platform: &domain::Platform,
) -> RouterResult<PoFrmRouterData> {
