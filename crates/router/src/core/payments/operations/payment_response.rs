...
async fn payment_response_update_tracker<F: Clone, T: types::Capturable>(
    ...
    let additional_payment_method_data = match payment_data.payment_method_data.clone(){
        Some(payment_method_data) => match payment_method_data{
            ...
            hyperswitch_domain_models::payment_method_data::PaymentMethodData::OpenBanking(_)  => update_additional_payment_data_with_connector_response_pm_data(
            ...
            hyperswitch_domain_models::payment_method_data::PaymentMethodData::NetworkToken(_) => payment_data.payment_attempt.payment_method_data.clone(),
        }
        None => None
