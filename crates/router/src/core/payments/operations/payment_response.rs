...
#[cfg(feature = "v2")]
impl<F: Send + Clone> Operation<F, types::PaymentsCancelData> for PaymentResponse {
    type Data = hyperswitch_domain_models::payments::PaymentVoidData<F>;
    fn to_post_update_tracker(
        &self,
    ) -> RouterResult<
...
impl<F: Clone>
    PostUpdateTracker<
        F,
        hyperswitch_domain_models::payments::PaymentVoidData<F>,
    ...
    > for PaymentResponse
{
    async fn update_tracker<'b>(
        &'b self,
        state: &'b SessionState,
        mut payment_data: hyperswitch_domain_models::payments::PaymentVoidData<F>,
        response: types::RouterData<F, types::PaymentsCancelData, types::PaymentsResponseData>,
        key_store: &domain::MerchantKeyStore,
        storage_scheme: enums::MerchantStorageScheme,
    ) -> RouterResult<hyperswitch_domain_models::payments::PaymentVoidData<F>>
    where
        F: 'b + Send + Sync,
