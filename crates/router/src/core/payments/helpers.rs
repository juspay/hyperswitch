...
pub async fn get_additional_payment_data(
    ...
    match pm_data {
        ...
        api_models::payments::PaymentMethodData::Wallet(_) => {
            Ok(api_models::payments::AdditionalPaymentData::Wallet {})
        }
        api_models::payments::PaymentMethodData::PayLater(_) => {
            Ok(api_models::payments::AdditionalPaymentData::PayLater {})
        }
        api_models::payments::PaymentMethodData::BankTransfer(_) => {
            Ok(api_models::payments::AdditionalPaymentData::BankTransfer {})
        }
        api_models::payments::PaymentMethodData::Crypto(_) => {
            Ok(api_models::payments::AdditionalPaymentData::Crypto {})
        }
        api_models::payments::PaymentMethodData::BankDebit(_) => {
            Ok(api_models::payments::AdditionalPaymentData::BankDebit {})
        }
