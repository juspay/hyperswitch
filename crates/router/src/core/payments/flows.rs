...
macro_rules! default_imp_for_connector_error_type_mapping{
    ($($path:ident::$connector:ident),*)=> {
        $(
            impl api::ConnectorErrorTypeMapping for $path::$connector {}
    )*
    };
}

#[cfg(feature = "dummy_connector")]
impl<const T: u8> api::ConnectorErrorTypeMapping for connector::DummyConnector<T> {}

default_imp_for_connector_error_type_mapping!(
    connector::Stax,
    connector::Aci,
    connector::Adyen,
    connector::Airwallex,
