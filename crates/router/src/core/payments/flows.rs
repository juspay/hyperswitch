...
#[cfg(feature = "dummy_connector")]
default_imp_for_payouts_eligibility!(connector::DummyConnector);
...
#[cfg(feature = "dummy_connector")]
default_imp_for_payouts_fulfill!(connector::DummyConnector);
...
#[cfg(feature = "dummy_connector")]
default_imp_for_payouts_cancel!(connector::DummyConnector);
