...
default_imp_for_connector_request_id!(connectors::Tokenio, connector::Stripe);
...
#[cfg(feature = "frm")]
default_imp_for_fraud_check!(connectors::Tokenio, connector::Stripe);
...
default_imp_for_connector_authentication!(connectors::Tokenio, connector::Stripe);
