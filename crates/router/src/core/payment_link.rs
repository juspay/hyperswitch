...
use crate::{
    consts::{
        self, DEFAULT_ALLOWED_DOMAINS, DEFAULT_BACKGROUND_COLOR, DEFAULT_DISPLAY_BILLING_DETAILS,
        DEFAULT_DISPLAY_SDK_ONLY, DEFAULT_ENABLE_SAVED_PAYMENT_METHOD,
...
pub async fn form_payment_link_data(
    ...
    let payment_link_config =
        if let Some(pl_config_value) = payment_link.payment_link_config.clone() {
            ...
            PaymentLinkConfig {
                ...
                display_billing_details: DEFAULT_DISPLAY_BILLING_DETAILS,
    ...
    let payment_link_details = api_models::payments::PaymentLinkDetails {
        ...
        display_billing_details: payment_link_config.display_billing_details,
