...
use hyperswitch_domain_models::payments::{
    PaymentCaptureData, PaymentConfirmData, PaymentIntentData, PaymentStatusData, PaymentVoidData,
};
#[cfg(feature = "v2")]
...
#[cfg(feature = "v2")]
impl<F: Clone> OperationSessionGetters<F> for PaymentVoidData<F> {
    #[track_caller]
    fn get_payment_attempt(&self) -> &storage::PaymentAttempt {
        &self.payment_attempt
    }
...
#[cfg(feature = "v2")]
impl<F: Clone> OperationSessionSetters<F> for PaymentVoidData<F> {
    fn set_payment_intent(&mut self, payment_intent: storage::PaymentIntent) {
        self.payment_intent = payment_intent;
    }
