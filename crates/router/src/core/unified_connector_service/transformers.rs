...
use hyperswitch_domain_models::{
    ...
    router_flow_types::{payments::{Authorize, PSync}, ExternalVaultProxy},
    router_request_types::{AuthenticationData, ExternalVaultProxyPaymentsData, PaymentsAuthorizeData, PaymentsSyncData},
