...
use api_models::{
    authentication::{
        ...
        AuthenticationCreateRequest, AuthenticationResponse, AuthenticationSyncRequest,
...
use hyperswitch_domain_models::{
    ...
    router_request_types::{
        ...
        unified_authentication_service::{
            ...
            UasPostAuthenticationRequestData, UasPreAuthenticationRequestData, UasAuthenticationResponseData, WebhookResponse
        },
        BrowserInformation,
    },
    types::{
...
pub async fn authentication_webhook_core(
    ...
    let (_mca, _connector_enum, connector_name) = crate::core::webhooks::fetch_optional_mca_and_connector(
        &state,
        &merchant_context,
    ...
    let three_ds_server_transaction_id = response_body.three_ds_server_transaction_id.clone().ok_or(ApiErrorResponse::MissingRequiredField { field_name: "three_ds_server_transaction_id" })?;
    ...
    let authentication_update = diesel_models::authentication::AuthenticationUpdate::PostAuthenticationUpdate {
