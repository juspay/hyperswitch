...
counter_metric!(CURRENCY_CONVERSION_SUCCESSFUL_REDIS_WRITE, GLOBAL_METER);
counter_metric!(CURRENCY_CONVERSION_REDIS_LOCK_NOT_ACQUIRED, GLOBAL_METER);
counter_metric!(
    CURRENCY_CONVERSION_SUCCESSFUL_PRIMARY_API_CALL,
    GLOBAL_METER
);
counter_metric!(
    CURRENCY_CONVERSION_SUCCESSFUL_FALLBACK_API_CALL,
    GLOBAL_METER
);
