...
pub(crate) fn diesel_enum_derive_inner(ast: &DeriveInput) -> syn::Result<TokenStream> {
    ...
    Ok(quote! {
        ...
        // FIXME(kos): Consider to mark any new code/items, generated by
        // procedural macros, with the `#[automatically_derived]`
        // attribute. This makes code style linters to omit the
        // generated code and doesn't report redundant warnings.
