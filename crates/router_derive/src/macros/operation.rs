...
impl Conversion {
    fn get_req_type(ident: Derives) -> syn::Ident {
        match ident {
            ...
            Derives::Decline => syn::Ident::new("PaymentsDeclineRequest", Span::call_site()),
            Derives::Declinedata => syn::Ident::new("PaymentsDeclineData", Span::call_site()),
