...
pub async fn update_merchant_default_config(
    ...
    let config_update = ConfigUpdate::Update {
...
pub async fn update_merchant_active_algorithm_ref(
    ...
    let merchant_account_update = merchant_account::MerchantAccountUpdate::Update {
        merchant_name: None,
...
pub async fn update_profile_active_algorithm_ref(
    ...
    current_business_profile: business_profile::Profile,
    algorithm_id: routing_types::RoutingAlgorithmRef,
    transaction_type: &common_enums::TransactionType,
) -> RouterResult<()> {
    ...
    let (routing_algorithm, payout_routing_algorithm) = match transaction_type {
        common_enums::TransactionType::Payment => (Some(ref_val), None),
        #[cfg(feature = "payouts")]
        common_enums::TransactionType::Payout => (None, Some(ref_val)),
    };

    let business_profile_update = business_profile::ProfileUpdate::RoutingAlgorithmUpdate {
        routing_algorithm,
...
pub async fn update_business_profile_active_dynamic_algorithm_ref(
    ...
    let business_profile_update = business_profile::ProfileUpdate::DynamicRoutingAlgorithmUpdate {
...
pub async fn validate_connectors_in_routing_config(
    ...
    let all_mcas = state
        .mca_handler
        .get_disabled_merchant_connector_accounts(key_store, merchant_id)
        .await?;
...
pub fn get_default_config_key(
    ...
    match transaction_type {
        common_enums::TransactionType::Payment => format!("routing_default_{merchant_id}"),
        #[cfg(feature = "payouts")]
        common_enums::TransactionType::Payout => format!("routing_default_po_{merchant_id}"),
    }
}
