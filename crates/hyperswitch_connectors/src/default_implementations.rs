...
use hyperswitch_domain_models::{
    router_flow_types::{
        ...
        ExternalVaultInsertFlow, ExternalVaultProxy, ExternalVaultRetrieveFlow, PostAuthenticate,
        PreAuthenticate,
    },
    router_request_types::{
        ...
        ExternalVaultProxyPaymentsData, MandateRevokeRequestData, PaymentsApproveData,
...
use hyperswitch_interfaces::{
    api::{
        ...
        payments::{
            ...
            PaymentAuthorizeSessionToken, PaymentIncrementalAuthorization,
