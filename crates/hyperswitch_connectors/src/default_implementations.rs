...
use hyperswitch_domain_models::{
    ...
    router_request_types::{
        ...
        PaymentsTaxCalculationData, PaymentsUpdateMetadataData, PaymentTriggerRequest,
    ...
    router_response_types::{
        ...
        MandateRevokeResponseData, PaymentTriggerResponse, PaymentsResponseData,
        RetrieveFileResponse, SubmitEvidenceResponse, TaxCalculationResponseData, UploadFileResponse,
...
macro_rules! default_imp_for_payment_trigger {
    ($($path:ident::$connector:ident),*) => {
        $(
...
default_imp_for_payment_trigger!(
    connectors::Vgs,
    connectors::Aci,
    connectors::Adyen,
    connectors::Adyenplatform,
