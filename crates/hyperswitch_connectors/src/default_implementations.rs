...
use hyperswitch_domain_models::{
    ...
    router_response_types::{
        subscriptions::GetSubscriptionPlanPricesResponse, AcceptDisputeResponse,
...
macro_rules! default_imp_for_get_subscription_plan_prices {
    ($($path:ident::$connector:ident),*) => {
...
default_imp_for_get_subscription_plan_prices!(
    connectors::Vgs,
    connectors::Aci,
    connectors::Adyen,
    connectors::Adyenplatform,
