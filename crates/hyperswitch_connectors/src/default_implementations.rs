...
use hyperswitch_interfaces::{
    api::{
        ...
        ConnectorRedirectResponse, ConnectorTransactionId, ModularAuthAuthenticationCreate,
        UasAuthentication, UasAuthenticationConfirmation, UasPostAuthentication,
        UasPreAuthentication, UasProcessWebhook, UnifiedAuthenticationService,
    },
...
macro_rules! default_imp_for_uas_authentication_create {
    ($($path:ident::$connector:ident),*) => {
        $(  impl ModularAuthAuthenticationCreate for $path::$connector {}
            impl
            ConnectorIntegration<
...
default_imp_for_uas_authentication_create!(
    connectors::Vgs,
    connectors::Aci,
    connectors::Adyen,
    connectors::Adyenplatform,
...
#[cfg(feature = "dummy_connector")]
impl<const T: u8> ModularAuthAuthenticationCreate for connectors::DummyConnector<T> {}
#[cfg(feature = "dummy_connector")]
impl<const T: u8>
    ConnectorIntegration<
        AuthenticationCreate,
