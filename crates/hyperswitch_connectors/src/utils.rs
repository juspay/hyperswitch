    ...
    fn foreign_try_from(value: String) -> Result<Self, Self::Error> {
        ...
        match state_abbreviation_check {
            ...
            Err(_) => match value.as_str().to_lowercase().as_str() {
                ...
                "katimogang leyte" | "southern leyte" => Ok(Self::KatimogangLeyte),
                ...
                "leyte" => Ok(Self::Leyte),
                "maguidanao del sur" | "timog maguindanao" => Ok(Self::MaguindanaoDelSur),
                ...
                "negros oriental" | "silingang negros" => Ok(Self::NegrosOriental),
