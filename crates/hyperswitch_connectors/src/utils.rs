...
use hyperswitch_domain_models::{
    payment_method_data::{
        ...
        OpenBankingData, PayLaterData, PaymentMethodData, RealTimePaymentData, VoucherData,
        WalletData,
    },
...
pub fn is_mandate_supported(
    ...
    mandate_implemented_pmds: std::collections::HashSet<PaymentMethodDataType>,
    ...
    fn from(pm_data: PaymentMethodData) -> Self {
        match pm_data {
            ...
            PaymentMethodData::Wallet(wallet_data) => match wallet_data {
                WalletData::AliPayQr(_) => Self::AliPayQr,
                WalletData::AliPayRedirect(_) => Self::AliPayRedirect,
                WalletData::AliPayHkRedirect(_) => Self::AliPayHkRedirect,
                WalletData::MomoRedirect(_) => Self::MomoRedirect,
                WalletData::KakaoPayRedirect(_) => Self::KakaoPayRedirect,
                WalletData::GoPayRedirect(_) => Self::GoPayRedirect,
                WalletData::GcashRedirect(_) => Self::GcashRedirect,
                WalletData::ApplePay(_) => Self::ApplePay,
                WalletData::ApplePayRedirect(_) => Self::ApplePayRedirect,
                WalletData::ApplePayThirdPartySdk(_) => Self::ApplePayThirdPartySdk,
                WalletData::DanaRedirect {} => Self::DanaRedirect,
                WalletData::GooglePay(_) => Self::GooglePay,
                WalletData::GooglePayRedirect(_) => Self::GooglePayRedirect,
                WalletData::GooglePayThirdPartySdk(_) => Self::GooglePayThirdPartySdk,
                WalletData::MbWayRedirect(_) => Self::MbWayRedirect,
                WalletData::MobilePayRedirect(_) => Self::MobilePayRedirect,
                WalletData::PaypalRedirect(_) => Self::PaypalRedirect,
                WalletData::PaypalSdk(_) => Self::PaypalSdk,
                ...
                WalletData::TouchNGoRedirect(_) => Self::TouchNGoRedirect,
                WalletData::WeChatPayRedirect(_) => Self::WeChatPayRedirect,
                WalletData::WeChatPayQr(_) => Self::WeChatPayQr,
                WalletData::CashappQr(_) => Self::CashappQr,
                WalletData::SwishQr(_) => Self::SwishQr,
                WalletData::Mifinity(_) => Self::Mifinity,
            },
            PaymentMethodData::PayLater(pay_later_data) => match pay_later_data {
                PayLaterData::KlarnaRedirect { .. } => Self::KlarnaRedirect,
                PayLaterData::KlarnaSdk { .. } => Self::KlarnaSdk,
            ...
            PaymentMethodData::BankRedirect(bank_redirect_data) => match bank_redirect_data {
                BankRedirectData::BancontactCard { .. } => Self::BancontactCard,
                BankRedirectData::Bizum {} => Self::Bizum,
                BankRedirectData::Blik { .. } => Self::Blik,
                BankRedirectData::Eps { .. } => Self::Eps,
                BankRedirectData::Giropay { .. } => Self::Giropay,
                BankRedirectData::Ideal { .. } => Self::Ideal,
                BankRedirectData::Interac { .. } => Self::Interac,
                BankRedirectData::OnlineBankingCzechRepublic { .. } => {
                    Self::OnlineBankingCzechRepublic
                }
                BankRedirectData::OnlineBankingFinland { .. } => Self::OnlineBankingFinland,
                BankRedirectData::OnlineBankingPoland { .. } => Self::OnlineBankingPoland,
                BankRedirectData::OnlineBankingSlovakia { .. } => Self::OnlineBankingSlovakia,
                BankRedirectData::OpenBankingUk { .. } => Self::OpenBankingUk,
                BankRedirectData::Przelewy24 { .. } => Self::Przelewy24,
                BankRedirectData::Sofort { .. } => Self::Sofort,
                BankRedirectData::Trustly { .. } => Self::Trustly,
                BankRedirectData::OnlineBankingFpx { .. } => Self::OnlineBankingFpx,
                BankRedirectData::OnlineBankingThailand { .. } => Self::OnlineBankingThailand,
                BankRedirectData::LocalBankRedirect {} => Self::LocalBankRedirect,
            },
            PaymentMethodData::BankDebit(bank_debit_data) => match bank_debit_data {
                BankDebitData::AchBankDebit { .. } => Self::AchBankDebit,
                BankDebitData::SepaBankDebit { .. } => Self::SepaBankDebit,
                BankDebitData::BecsBankDebit { .. } => Self::BecsBankDebit,
                BankDebitData::BacsBankDebit { .. } => Self::BacsBankDebit,
            },
            PaymentMethodData::BankTransfer(bank_transfer_data) => match *bank_transfer_data {
                BankTransferData::AchBankTransfer { .. } => Self::AchBankTransfer,
                BankTransferData::SepaBankTransfer { .. } => Self::SepaBankTransfer,
                BankTransferData::BacsBankTransfer { .. } => Self::BacsBankTransfer,
                BankTransferData::MultibancoBankTransfer { .. } => Self::MultibancoBankTransfer,
                BankTransferData::PermataBankTransfer { .. } => Self::PermataBankTransfer,
                BankTransferData::BcaBankTransfer { .. } => Self::BcaBankTransfer,
                BankTransferData::BniVaBankTransfer { .. } => Self::BniVaBankTransfer,
                BankTransferData::BriVaBankTransfer { .. } => Self::BriVaBankTransfer,
                ...
                BankTransferData::LocalBankTransfer { .. } => Self::LocalBankTransfer,
            },
            ...
            PaymentMethodData::Voucher(voucher_data) => match voucher_data {
                VoucherData::Boleto(_) => Self::Boleto,
                ...
                VoucherData::Alfamart(_) => Self::Alfamart,
                VoucherData::Indomaret(_) => Self::Indomaret,
                VoucherData::Oxxo => Self::Oxxo,
                VoucherData::SevenEleven(_) => Self::SevenEleven,
                VoucherData::Lawson(_) => Self::Lawson,
                VoucherData::MiniStop(_) => Self::MiniStop,
                VoucherData::FamilyMart(_) => Self::FamilyMart,
                VoucherData::Seicomart(_) => Self::Seicomart,
                VoucherData::PayEasy(_) => Self::PayEasy,
            },
            ...
            PaymentMethodData::GiftCard(gift_card_data) => match *gift_card_data {
                GiftCardData::Givex(_) => Self::Givex,
                GiftCardData::PaySafeCard {} => Self::PaySafeCar,
            },
            PaymentMethodData::CardToken(_) => Self::CardToken,
            PaymentMethodData::OpenBanking(data) => match data {
                OpenBankingData::OpenBankingPIS {} => Self::OpenBanking,
            },
        }
    }
}
