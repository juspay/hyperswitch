...
pub use self::{
    ...
    gocardless::Gocardless, helcim::Helcim, hipay::Hipay, iatapay::Iatapay, inespay::Inespay,
    ...
    multisafepay::Multisafepay, nexinets::Nexinets, nexixpay::Nexixpay, nmi::Nmi, nomupay::Nomupay,
