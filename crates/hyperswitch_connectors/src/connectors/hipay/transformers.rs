...
impl<T> From<(StringMinorUnit, T)> for HipayRouterData<T> {
...
impl From<HipayPaymentStatus> for common_enums::AttemptStatus {
    fn from(item: HipayPaymentStatus) -> Self {
        match item {
            HipayPaymentStatus::Succeeded => Self::Charged,
            HipayPaymentStatus::Failed => Self::Failure,
            HipayPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
...
impl<F, T> TryFrom<ResponseRouterData<F, HipayPaymentsResponse, T, PaymentsResponseData>>
    for RouterData<F, T, PaymentsResponseData>
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: ResponseRouterData<F, HipayPaymentsResponse, T, PaymentsResponseData>,
...
impl<F> TryFrom<&HipayRouterData<&RefundsRouterData<F>>> for HipayRefundRequest {
    type Error = error_stack::Report<errors::ConnectorError>;
