...
#[derive(Clone, Copy)]
struct UasTest;
impl ConnectorActions for UasTest {}
impl utils::Connector for UasTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Uas;
        api::ConnectorData {
            connector: Box::new(Uas::new()),
            connector_name: types::Connector::Uas,
...
static CONNECTOR: UasTest = UasTest {};
