...
#[derive(Clone, Copy)]
struct QuickstreamTest;
impl ConnectorActions for QuickstreamTest {}
impl utils::Connector for QuickstreamTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Quickstream;
        api::ConnectorData {
            connector: Box::new(Quickstream::new()),
            connector_name: types::Connector::Quickstream,
    ...
    fn get_name(&self) -> String {
        "quickstream".to_string()
    }
}

static CONNECTOR: QuickstreamTest = QuickstreamTest {};
