...
#[derive(Clone, Copy)]
struct DotpayTest;
impl ConnectorActions for DotpayTest {}
impl utils::Connector for DotpayTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Dotpay;
        api::ConnectorData {
            connector: Box::new(Dotpay::new()),
            connector_name: types::Connector::Dotpay,
...
static CONNECTOR: DotpayTest = DotpayTest {};
