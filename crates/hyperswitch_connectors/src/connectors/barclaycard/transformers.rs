...
impl<T> From<(StringMinorUnit, T)> for BarclaycardRouterData<T> {
...
pub struct BarclaycardPaymentsRequest {
    ...
    card: BarclaycardCard,
}

#[derive(Default, Debug, Serialize, Eq, PartialEq)]
pub struct BarclaycardCard {
...
impl From<BarclaycardPaymentStatus> for common_enums::AttemptStatus {
    fn from(item: BarclaycardPaymentStatus) -> Self {
        match item {
            BarclaycardPaymentStatus::Succeeded => Self::Charged,
            BarclaycardPaymentStatus::Failed => Self::Failure,
            BarclaycardPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
...
pub struct BarclaycardPaymentsResponse {
    status: BarclaycardPaymentStatus,
    id: String,
}

impl<F, T> TryFrom<ResponseRouterData<F, BarclaycardPaymentsResponse, T, PaymentsResponseData>>
...
pub struct BarclaycardErrorResponse {
    pub status_code: u16,
    pub code: String,
    pub message: String,
