...
impl ConnectorCommon for Razorpay {
    ...
    fn get_auth_header(
        ...
        println!("$$$$$ Razorpay auth header: {:?}", encoded_api_key);
        Ok(vec![(
    ...
    fn build_error_response(
        ...
        println!("$$$ Razorpay Error Response: {:?}", res.response);
    ...
    for Razorpay
{
    ...
    fn handle_response(
        ...
        println!("$$$ Razorpay PreProcessing Response: {:?}", res.response);
    ...
    fn get_error_response(
        ...
        println!(
            "$$$ Razorpay PreProcessing Error Response: {:?}",
            res.response
        );
...
impl ConnectorIntegration<Authorize, PaymentsAuthorizeData, PaymentsResponseData> for Razorpay {
    ...
    fn handle_response(
        ...
        println!("$$$ Razorpay Authorize Response: {:?}", res.response);
...
impl ConnectorIntegration<PSync, PaymentsSyncData, PaymentsResponseData> for Razorpay {
    ...
    fn get_url(
        ...
        println!("$$$$$ Razorpay Sync URL: {:?}", connector_payment_id);
        Ok(format!(
            "{}v1/orders/{}",
            self.base_url(connectors),
    ...
    fn handle_response(
        ...
        println!("$$$ Razorpay Sync Response: {:?}", res.response);
