    ...
    for Worldpayvantiv
{
    ...
    fn get_request_body(
        ...
        let connector_req =
            worldpayvantiv::WorldpayvantivPaymentsRequest::try_from(&connector_router_data)?;
    ...
    fn handle_response(
        ...
        let response: worldpayvantiv::WorldpayvantivPaymentsResponse = res
            .response
            .parse_struct("Worldpayvantiv PaymentsAuthorizeResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
...
impl ConnectorIntegration<PSync, PaymentsSyncData, PaymentsResponseData> for Worldpayvantiv {
    ...
    fn handle_response(
        ...
        let response: worldpayvantiv::WorldpayvantivPaymentsResponse = res
            .response
            .parse_struct("worldpayvantiv PaymentsSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<Capture, PaymentsCaptureData, PaymentsResponseData> for Worldpayvantiv {
    ...
    fn handle_response(
        ...
        let response: worldpayvantiv::WorldpayvantivPaymentsResponse = res
            .response
            .parse_struct("Worldpayvantiv PaymentsCaptureResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<Execute, RefundsData, RefundsResponseData> for Worldpayvantiv {
    ...
    fn get_request_body(
        ...
        let connector_req =
            worldpayvantiv::WorldpayvantivRefundRequest::try_from(&connector_router_data)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: worldpayvantiv::RefundResponse = res
            .response
            .parse_struct("worldpayvantiv RefundResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<RSync, RefundsData, RefundsResponseData> for Worldpayvantiv {
    ...
    fn handle_response(
        ...
        let response: worldpayvantiv::RefundResponse = res
            .response
            .parse_struct("worldpayvantiv RefundSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
