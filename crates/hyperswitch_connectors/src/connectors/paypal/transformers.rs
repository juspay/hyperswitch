...
fn get_paypal_error_message(error_code: &str) -> Option<&str> {
    match error_code {
        ...
        "PPRE" | "RESPONSE_PPRE" => Some("UNSUPPORTED_REFUND_ON_PENDING_BC."),
        ...
        "PPUE" | "RESPONSE_PPUE" => Some("UNSUPPORTED_ENTITY."),
        "PPUI" | "RESPONSE_PPUI" => Some("UNSUPPORTED_INSTALLMENT."),
        "PPUP" | "RESPONSE_PPUP" => Some("UNSUPPORTED_POS_FLAG."),
