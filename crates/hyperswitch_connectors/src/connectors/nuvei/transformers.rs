...
use hyperswitch_domain_models::{
    ...
    payment_method_data::{
        ApplePayWalletData, BankRedirectData, GooglePayWalletData, PayLaterData, PaymentMethodData,
        WalletData,
    },
    router_data::{ConnectorAuthType, ErrorResponse, RouterData},
    router_flow_types::{
        refunds::Execute, Authorize, Capture, CompleteAuthorize, PSync, RSync, Void,
    },
...
use crate::{
    ...
    utils::{
        self, to_boolean, AddressDetailsData, BrowserInformationData, ForeignTryFrom,
        PaymentsAuthorizeRequestData, PaymentsCancelRequestData, PaymentsPreProcessingData,
        RouterData as _,
    },
};
...
impl NuveiAuthorizePreprocessingCommon
...
fn get_card_info<F, Req>(
    item: &RouterData<F, Req, PaymentsResponseData>,
    card_details: &hyperswitch_domain_models::payment_method_data::Card,
) -> Result<NuveiPaymentsRequest, error_stack::Report<errors::ConnectorError>>
where
    Req: NuveiAuthorizePreprocessingCommon,
{
