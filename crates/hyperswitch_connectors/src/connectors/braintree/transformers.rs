        ...
        match item.router_data.request.payment_method_data.clone() {
            ...
            PaymentMethodData::Wallet(ref wallet_data) => match wallet_data {
                ...
                WalletData::ApplePayThirdPartySdk(ref req_wallet) => {
                    ...
                    let query = if is_mandate {
                        match item.router_data.request.is_auto_capture()? {
                            true => CHARGE_AND_VAULT_APPLE_PAY_MUTATION.to_string(),
                            false => AUTHORIZE_AND_VAULT_APPLE_PAY_MUTATION.to_string(),
                        }
                    } else {
                        match item.router_data.request.is_auto_capture()? {
                            ...
                            input: WalletPaymentInput {
                                ...
                                transaction: WalletTransactionBody {
                                    ...
                                    order_id: item
                                        ...
                                        .connector_request_reference_id
                                        .clone(),
                                    customer_details: if is_mandate {
                                        item.router_data
                                            .get_billing_email()
                                            .ok()
                                    ...
                                    vault_payment_method_after_transacting: if is_mandate {
