...
use crate::{
    ...
    utils::{missing_field_err, ForeignTryFrom, RouterData as OtherRouterData},
};
                ...
                BankTransferData::Pix {
                    ...
                    let transaction_data =
                        FacilitapayTransactionRequest::Pix(PixTransactionRequest {
                            ...
                            subject_id: item.router_data.get_connector_customer_id()?,
            ...
            match BrazilStatesAbbreviation::foreign_try_from(state_str.clone()) {
                ...
                Err(parse_error) => {
                    ...
                    return Err(parse_error).change_context(
                                ...
                                "Invalid address_state ('{}') received in Facilitapay customer response. Expected a valid Brazil state abbreviation or null.",
                                state_str
                            ));
                }
            }
