...
pub struct ZiftPaymentsRequest {
...
impl From<ZiftPaymentStatus> for common_enums::AttemptStatus {
    fn from(item: ZiftPaymentStatus) -> Self {
        match item {
            ZiftPaymentStatus::Succeeded => Self::Charged,
            ZiftPaymentStatus::Failed => Self::Failure,
            ZiftPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
...
pub struct ZiftPaymentsResponse {
    status: ZiftPaymentStatus,
    id: String,
}

impl<F, T> TryFrom<ResponseRouterData<F, ZiftPaymentsResponse, T, PaymentsResponseData>>
    for RouterData<F, T, PaymentsResponseData>
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: ResponseRouterData<F, ZiftPaymentsResponse, T, PaymentsResponseData>,
