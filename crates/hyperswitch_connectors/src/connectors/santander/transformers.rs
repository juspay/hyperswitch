...
pub struct SantanderPaymentsRequest {
...
impl TryFrom<&SantanderRouterData<&PaymentsAuthorizeRouterData>> for SantanderPaymentsRequest {
...
impl From<SantanderPaymentStatus> for common_enums::AttemptStatus {
    fn from(item: SantanderPaymentStatus) -> Self {
        match item {
            SantanderPaymentStatus::Succeeded => Self::Charged,
            SantanderPaymentStatus::Failed => Self::Failure,
            SantanderPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
