...
#[derive(Clone, Copy)]
struct PaymangoTest;
impl ConnectorActions for PaymangoTest {}
impl utils::Connector for PaymangoTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Paymango;
        api::ConnectorData {
            connector: Box::new(Paymango::new()),
            connector_name: types::Connector::Paymango,
...
static CONNECTOR: PaymangoTest = PaymangoTest {};
