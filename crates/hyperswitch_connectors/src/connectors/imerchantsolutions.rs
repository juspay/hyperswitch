...
#[derive(Clone)]
pub struct Imerchantsolutions {
    amount_converter: &'static (dyn AmountConvertor<Output = MinorUnit> + Sync),
}

impl Imerchantsolutions {
...
impl api::Payment for Imerchantsolutions {}
impl api::PaymentSession for Imerchantsolutions {}
impl api::ConnectorAccessToken for Imerchantsolutions {}
impl api::MandateSetup for Imerchantsolutions {}
impl api::PaymentAuthorize for Imerchantsolutions {}
impl api::PaymentSync for Imerchantsolutions {}
impl api::PaymentCapture for Imerchantsolutions {}
impl api::PaymentVoid for Imerchantsolutions {}
impl api::Refund for Imerchantsolutions {}
impl api::RefundExecute for Imerchantsolutions {}
impl api::RefundSync for Imerchantsolutions {}
impl api::PaymentToken for Imerchantsolutions {}

impl ConnectorIntegration<PaymentMethodToken, PaymentMethodTokenizationData, PaymentsResponseData>
    for Imerchantsolutions
{
    // Not Implemented (R)
}

impl<Flow, Request, Response> ConnectorCommonExt<Flow, Request, Response> for Imerchantsolutions
where
...
impl ConnectorCommon for Imerchantsolutions {
    ...
    fn base_url<'a>(&self, connectors: &'a Connectors) -> &'a str {
        connectors.imerchantsolutions.base_url.as_ref()
    }
    ...
    for Imerchantsolutions
{
    ...
    fn get_request_body(
        ...
        let connector_router_data =
            imerchantsolutions::ImerchantsolutionsRouterData::from((amount, req));
        let connector_req = imerchantsolutions::ImerchantsolutionsPaymentsRequest::try_from(
    ...
    fn handle_response(
        ...
        let response: imerchantsolutions::ImerchantsolutionsPaymentsResponse = res
            .response
            .parse_struct("Imerchantsolutions PaymentsAuthorizeResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
...
impl ConnectorIntegration<PSync, PaymentsSyncData, PaymentsResponseData> for Imerchantsolutions {
    fn get_headers(
        &self,
    ...
    fn handle_response(
        ...
        let response: imerchantsolutions::ImerchantsolutionsPaymentsResponse = res
            .response
            .parse_struct("imerchantsolutions PaymentsSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
    ...
    for Imerchantsolutions
{
    ...
    fn handle_response(
        ...
        let response: imerchantsolutions::ImerchantsolutionsPaymentsResponse = res
            .response
            .parse_struct("Imerchantsolutions PaymentsCaptureResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<Void, PaymentsCancelData, PaymentsResponseData> for Imerchantsolutions {}

impl ConnectorIntegration<Execute, RefundsData, RefundsResponseData> for Imerchantsolutions {
    fn get_headers(
        &self,
    ...
    fn get_request_body(
        ...
        let connector_router_data =
            imerchantsolutions::ImerchantsolutionsRouterData::from((refund_amount, req));
        let connector_req =
            imerchantsolutions::ImerchantsolutionsRefundRequest::try_from(&connector_router_data)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: imerchantsolutions::RefundResponse = res
            .response
...
impl ConnectorIntegration<RSync, RefundsData, RefundsResponseData> for Imerchantsolutions {
    fn get_headers(
        &self,
    ...
    fn handle_response(
        ...
        let response: imerchantsolutions::RefundResponse = res
            .response
            .parse_struct("imerchantsolutions RefundSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
static IMERCHANTSOLUTIONS_SUPPORTED_PAYMENT_METHODS: LazyLock<SupportedPaymentMethods> =
    LazyLock::new(|| {
        ...
        let mut imerchant_supported_payment_methods = SupportedPaymentMethods::new();
