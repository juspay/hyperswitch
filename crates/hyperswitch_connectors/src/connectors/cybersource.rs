...
use hyperswitch_domain_models::{
    ...
    types::{
        ...
        PaymentsSyncRouterData, PayoutsRouterData, RefundExecuteRouterData, RefundSyncRouterData,
...
use hyperswitch_interfaces::{
    api::{
        ...
        ConnectorCommon, ConnectorCommonExt, ConnectorIntegration, ConnectorValidation,
    },
    configs::Connectors,
    errors,
    ...
    types::{
        ...
        PaymentsSyncType, PaymentsVoidType, PayoutFulfillType, RefundExecuteType, RefundSyncType,
    ...
    fn validate_capture_method(
        ...
        match capture_method {
            ...
            enums::CaptureMethod::ManualMultiple | enums::CaptureMethod::Scheduled => Err(
                crate::utils::construct_not_implemented_error_report(capture_method, self.id()),
            ),
        }
    }
    ...
    for Cybersource
{
    ...
    fn get_url(
        ...
        Ok(format!(
            ...
            crate::utils::RevokeMandateRequestData::get_connector_mandate_id(&req.request)?
        ))
    }
    fn build_request(
        &self,
