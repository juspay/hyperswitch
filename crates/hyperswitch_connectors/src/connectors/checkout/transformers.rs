...
use hyperswitch_domain_models::{
    ...
    router_data::{self, ConnectorAuthType, PaymentMethodToken, RouterData},
    ...
    types::{
        ...
        PaymentsSyncRouterData, RefundsRouterData, SubmitEvidenceRouterData,
        TokenizationRouterData, UploadFileRouterData,
    },
};
...
impl TryFrom<PaymentsResponseRouterData<PaymentsResponse>> for PaymentsAuthorizeRouterData {
    ...
    fn try_from(item: PaymentsResponseRouterData<PaymentsResponse>) -> Result<Self, Self::Error> {
        ...
        let error_response = if status == enums::AttemptStatus::Failure {
            Some(router_data::ErrorResponse {
...
impl From<CheckoutWebhookEventType> for IncomingWebhookEvent {
