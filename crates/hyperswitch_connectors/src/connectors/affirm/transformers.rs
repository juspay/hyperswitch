...
impl<T> From<(StringMinorUnit, T)> for AffirmRouterData<T> {
...
impl From<AffirmPaymentStatus> for common_enums::AttemptStatus {
    fn from(item: AffirmPaymentStatus) -> Self {
        match item {
            AffirmPaymentStatus::Succeeded => Self::Charged,
            AffirmPaymentStatus::Failed => Self::Failure,
            AffirmPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
...
impl<F, T> TryFrom<ResponseRouterData<F, AffirmPaymentsResponse, T, PaymentsResponseData>>
    for RouterData<F, T, PaymentsResponseData>
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: ResponseRouterData<F, AffirmPaymentsResponse, T, PaymentsResponseData>,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
