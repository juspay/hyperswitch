...
impl ConnectorIntegration<Authorize, PaymentsAuthorizeData, PaymentsResponseData> for Barclaycard {
    ...
    fn get_request_body(
        ...
        let connector_router_data = barclaycard::BarclaycardRouterData::from((amount, req));
        let connector_req =
...
impl ConnectorIntegration<Execute, RefundsData, RefundsResponseData> for Barclaycard {
    ...
    fn get_request_body(
        ...
        let connector_router_data = barclaycard::BarclaycardRouterData::from((refund_amount, req));
        let connector_req =
    ...
    fn handle_response(
        ...
        let response: barclaycard::RefundResponse = res
            .response
