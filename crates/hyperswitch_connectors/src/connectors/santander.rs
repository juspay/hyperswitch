...
use hyperswitch_domain_models::{
    ...
    router_request_types::{
        ...
        PaymentsCaptureData, PaymentsSessionData, PaymentsSyncData, PushNotificationRequestData,
    ...
    types::{
        ...
        PaymentsPushNotificationRouterData, PaymentsSyncRouterData, RefundSyncRouterData,
        RefundsRouterData,
    },
};
