...
impl ConnectorCommon for Fiuu {
    ...
    fn get_auth_header(
        ...
        let auth = fiuu::FiuuAuthType::try_from(auth_type)
...
impl ConnectorIntegration<Authorize, PaymentsAuthorizeData, PaymentsResponseData> for Fiuu {
    ...
    fn get_request_body(
        ...
        let connector_req = fiuu::FiuuPaymentsRequest::try_from(&connector_router_data)?;
...
impl ConnectorIntegration<PSync, PaymentsSyncData, PaymentsResponseData> for Fiuu {
    ...
    fn handle_response(
        ...
        let response: fiuu::FiuuPaymentsResponse = res
            .response
            .parse_struct("fiuu PaymentsSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<Execute, RefundsData, RefundsResponseData> for Fiuu {
    ...
    fn get_request_body(
        ...
        let connector_req = fiuu::FiuuRefundRequest::try_from(&connector_router_data)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: fiuu::RefundResponse = res
            .response
            .parse_struct("fiuu RefundResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<RSync, RefundsData, RefundsResponseData> for Fiuu {
    ...
    fn handle_response(
        ...
        let response: fiuu::RefundResponse =
            res.response
                .parse_struct("fiuu RefundSyncResponse")
                .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
