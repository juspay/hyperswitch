...
impl TryFrom<&CoingateRouterData<&PaymentsAuthorizeRouterData>> for CoingatePaymentsRequest  {
    ...
    fn try_from(item: &CoingateRouterData<&PaymentsAuthorizeRouterData>) -> Result<Self,Self::Error> {
...
impl<F,T> TryFrom<ResponseRouterData<F, CoingatePaymentsResponse, T, PaymentsResponseData>> for RouterData<F, T, PaymentsResponseData> {
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(item: ResponseRouterData<F, CoingatePaymentsResponse, T, PaymentsResponseData>) -> Result<Self,Self::Error> {
        Ok(Self {
