...
impl api::Payment for Paymentwall {}
impl api::PaymentSession for Paymentwall {}
impl api::ConnectorAccessToken for Paymentwall {}
impl api::MandateSetup for Paymentwall {}
impl api::PaymentAuthorize for Paymentwall {}
impl api::PaymentSync for Paymentwall {}
impl api::PaymentCapture for Paymentwall {}
impl api::PaymentVoid for Paymentwall {}
impl api::Refund for Paymentwall {}
impl api::RefundExecute for Paymentwall {}
...
impl ConnectorCommon for Paymentwall {
    ...
    fn build_error_response(
        ...
        let response: paymentwall::PaymentwallErrorResponse = res
            .response
            .parse_struct("PaymentwallErrorResponse")
...
impl ConnectorIntegration<Capture, PaymentsCaptureData, PaymentsResponseData> for Paymentwall {
    ...
    fn handle_response(
        ...
        let response: paymentwall::PaymentwallPaymentsResponse = res
            .response
            .parse_struct("Paymentwall PaymentsCaptureResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl webhooks::IncomingWebhook for Paymentwall {
