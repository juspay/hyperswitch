...
impl TryFrom<&ThunesRouterData<&PaymentsAuthorizeRouterData>> for ThunesPaymentsRequest  {
    ...
    fn try_from(item: &ThunesRouterData<&PaymentsAuthorizeRouterData>) -> Result<Self,Self::Error> {
...
impl<F,T> TryFrom<ResponseRouterData<F, ThunesPaymentsResponse, T, PaymentsResponseData>> for RouterData<F, T, PaymentsResponseData> {
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(item: ResponseRouterData<F, ThunesPaymentsResponse, T, PaymentsResponseData>) -> Result<Self,Self::Error> {
        Ok(Self {
