...
use common_enums::{
    AttemptStatus, CallConnectorAction, CaptureMethod, PaymentAction, PaymentMethodType,
};
use common_utils::{
    crypto,
...
use transformers::{
    LiabilityShift, NuveiACSResponse, NuveiMeta, NuveiPaymentFlowRequest, NuveiPaymentSyncRequest,
    NuveiPaymentsRequest, NuveiPaymentsResponse, NuveiRedirectionResponse, NuveiSessionRequest,
    NuveiSessionResponse, NuveiWebhookDataStatus, NuveiWebhookDetails, NuveiWebhookStatus,
...
use crate::{
    ...
    utils::{
        base64_decode, construct_not_supported_error_report, get_header_key_value,
        is_mandate_supported, to_connector_meta, PaymentMethodDataType, RouterData as _,
    },
};
    ...
    for Nuvei
{
    ...
    fn get_request_body(
        ...
        let meta: NuveiMeta = to_connector_meta(req.request.connector_meta.clone())?;
        let connector_req = NuveiPaymentsRequest::try_from((req, meta.session_token))?;
...
impl ConnectorIntegration<Void, PaymentsCancelData, PaymentsResponseData> for Nuvei {
    ...
    fn get_request_body(
        ...
        let connector_req = NuveiPaymentFlowRequest::try_from(req)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
    }
...
impl ConnectorIntegration<PSync, PaymentsSyncData, PaymentsResponseData> for Nuvei {
    ...
    fn get_request_body(
        ...
        let connector_req = NuveiPaymentSyncRequest::try_from(req)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
    }
    fn build_request(
        &self,
...
impl ConnectorIntegration<Authorize, PaymentsAuthorizeData, PaymentsResponseData> for Nuvei {
    ...
    fn get_request_body(
        ...
        let connector_req = NuveiPaymentsRequest::try_from((req, req.get_session_token()?))?;
    ...
    for Nuvei
{
    ...
    fn get_request_body(
        ...
        let connector_req = NuveiSessionRequest::try_from(req)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: NuveiSessionResponse =
...
impl IncomingWebhook for Nuvei {
    ...
    fn get_webhook_source_verification_signature(
        ...
        let signature = get_header_key_value("advanceResponseChecksum", request.headers)?;
    ...
    fn get_webhook_source_verification_message(
        ...
        let body = serde_urlencoded::from_str::<NuveiWebhookDetails>(&request.query_params)
    ...
    fn get_webhook_object_reference_id(
        ...
        let body = serde_urlencoded::from_str::<NuveiWebhookTransactionId>(&request.query_params)
            .change_context(errors::ConnectorError::WebhookBodyDecodingFailed)?;
    ...
    fn get_webhook_event_type(
        ...
        let body = serde_urlencoded::from_str::<NuveiWebhookDataStatus>(&request.query_params)
            .change_context(errors::ConnectorError::WebhookBodyDecodingFailed)?;
        match body.status {
            NuveiWebhookStatus::Approved => Ok(IncomingWebhookEvent::PaymentIntentSuccess),
            NuveiWebhookStatus::Declined => Ok(IncomingWebhookEvent::PaymentIntentFailure),
            NuveiWebhookStatus::Unknown
            | NuveiWebhookStatus::Pending
            | NuveiWebhookStatus::Update => Ok(IncomingWebhookEvent::EventNotSupported),
        }
    }
    ...
    fn get_webhook_resource_object(
        ...
        let body = serde_urlencoded::from_str::<NuveiWebhookDetails>(&request.query_params)
            .change_context(errors::ConnectorError::WebhookBodyDecodingFailed)?;
        let payment_response = NuveiPaymentsResponse::from(body);
