...
lazy_static! {
    static ref NUVEI_SUPPORTED_PAYMENT_METHODS: SupportedPaymentMethods = {
    ...
    static ref NUVEI_CONNECTOR_INFO: ConnectorInfo = ConnectorInfo {
        display_name: "Nuvei",
        description: "Nuvei is the Canadian fintech company accelerating the business of clients around the world.",
        connector_type: enums::PaymentConnectorCategory::PaymentGateway,
    };

    static ref NUVEI_SUPPORTED_WEBHOOK_FLOWS: Vec<enums::EventClass> = Vec::new();
}
