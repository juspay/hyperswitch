...
impl From<AdyenPaymentStatus> for storage_enums::Status {
    fn from(item: AdyenPaymentStatus) -> Self {
        match item {
            AdyenPaymentStatus::Succeeded => storage_enums::Status::Charged,
            AdyenPaymentStatus::Failed => storage_enums::Status::Failure,
            AdyenPaymentStatus::Processing
            | AdyenPaymentStatus::RequiresCustomerAction
            | AdyenPaymentStatus::RequiresPaymentMethod
            | AdyenPaymentStatus::RequiresConfirmation => storage_enums::Status::Pending,
        }
    }
}
*/
