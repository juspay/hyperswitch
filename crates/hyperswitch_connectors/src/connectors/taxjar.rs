...
impl ConnectorIntegration<Execute, RefundsData, RefundsResponseData> for Taxjar {
    ...
    fn get_request_body(
        ...
        let connector_router_data = taxjar::TaxjarRouterData::from((refund_amount, req));
    ...
    fn handle_response(
        ...
        let response: taxjar::RefundResponse =
            res.response
                .parse_struct("taxjar RefundResponse")
                .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl ConnectorIntegration<RSync, RefundsData, RefundsResponseData> for Taxjar {
    ...
    fn handle_response(
        ...
        let response: taxjar::RefundResponse = res
            .response
            .parse_struct("taxjar RefundSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
