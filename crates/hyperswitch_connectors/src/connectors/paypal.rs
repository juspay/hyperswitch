...
use hyperswitch_domain_models::{
    ...
    types::{
        ...
        PaymentsPostSessionTokensRouterData, PaymentsPreProcessingRouterData, PaymentsSessionRouterData,
...
use hyperswitch_interfaces::{
    ...
    types::{
        ...
        PaymentsPostSessionTokensType, PaymentsPreProcessingType, PaymentsSessionType, PaymentsSyncType,
...
impl ConnectorIntegration<Session, PaymentsSessionData, PaymentsResponseData> for Paypal {
    ...
    fn get_headers(
        ...
        Ok(vec![
            (
                headers::CONTENT_TYPE.to_string(),
                PaymentsSessionType::get_content_type(self).to_string().into(),
            ),
    ...
    fn build_request(
        ...
        let req = Some(
            RequestBuilder::new()
                ...
                .set_body(PaymentsSessionType::get_request_body(self, req, connectors)?)
                .build(),
        );
    ...
    fn get_url(
        ...
        let incremental_authorization_id = paypal_meta.incremental_authorization_id.ok_or(
            errors::ConnectorError::RequestEncodingFailedWithReason(
                "Missing incremental_authorization_id id".to_string(),
            ),
        )?;
        Ok(format!(
