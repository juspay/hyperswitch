...
lazy_static! {
    static ref ZEN_SUPPORTED_PAYMENT_METHODS: SupportedPaymentMethods = {
    ...
    static ref ZEN_CONNECTOR_INFO: ConnectorInfo = ConnectorInfo {
        display_name: "Zen",
    ...
    static ref ZEN_SUPPORTED_WEBHOOK_FLOWS: Vec<enums::EventClass> = Vec::new();
}
