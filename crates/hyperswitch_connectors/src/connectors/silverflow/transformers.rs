...
pub enum SilverflowPaymentStatus {
    Succeeded,
    Failed,
    #[default]
    Processing,
...
impl From<SilverflowPaymentStatus> for common_enums::AttemptStatus {
    fn from(item: SilverflowPaymentStatus) -> Self {
        match item {
            SilverflowPaymentStatus::Succeeded => Self::Charged,
            SilverflowPaymentStatus::Failed => Self::Failure,
            SilverflowPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
...
pub struct SilverflowPaymentsResponse {
    status: SilverflowPaymentStatus,
    id: String,
}
