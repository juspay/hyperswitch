...
use transformers as globalpaymentsheartland;
...
impl ConnectorCommon for GlobalpaymentsHeartland {
    ...
    ) -> CustomResult<Vec<(String, hyperswitch_masking::Maskable<String>)>, errors::ConnectorError>
    {
        ...
        let _auth = globalpaymentsheartland::GlobalpaymentsheartlandAuthType::try_from(auth_type)
...
static GLOBALPAYMENTSHEARTLAND_SUPPORTED_PAYMENT_METHODS: LazyLock<SupportedPaymentMethods> =
    LazyLock::new(|| {
        ...
        let mut globalpaymentsheartland_supported_payment_methods = SupportedPaymentMethods::new();

        for payment_method_type in [
            enums::PaymentMethodType::Credit,
            enums::PaymentMethodType::Debit,
        ] {
            globalpaymentsheartland_supported_payment_methods.add(
        ...
        globalpaymentsheartland_supported_payment_methods
    });

static GLOBALPAYMENTSHEARTLAND_CONNECTOR_INFO: ConnectorInfo = ConnectorInfo {
...
impl ConnectorSpecifications for GlobalpaymentsHeartland {
    ...
    fn get_connector_about(&self) -> Option<&'static ConnectorInfo> {
        Some(&GLOBALPAYMENTSHEARTLAND_CONNECTOR_INFO)
    }

    fn get_supported_payment_methods(&self) -> Option<&'static SupportedPaymentMethods> {
        Some(&*GLOBALPAYMENTSHEARTLAND_SUPPORTED_PAYMENT_METHODS)
    }

    fn get_supported_webhook_flows(&self) -> Option<&'static [enums::EventClass]> {
        Some(&GLOBALPAYMENTSHEARTLAND_SUPPORTED_WEBHOOK_FLOWS)
    }
}
