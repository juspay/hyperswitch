...
impl<T> From<(StringMinorUnit, T)> for GigadatRouterData<T> {
...
impl TryFrom<&GigadatRouterData<&PaymentsAuthorizeRouterData>> for GigadatPaymentsRequest {
...
impl From<GigadatPaymentStatus> for common_enums::AttemptStatus {
    fn from(item: GigadatPaymentStatus) -> Self {
        match item {
            GigadatPaymentStatus::Succeeded => Self::Charged,
            GigadatPaymentStatus::Failed => Self::Failure,
            GigadatPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
...
pub struct GigadatPaymentsResponse {
    status: GigadatPaymentStatus,
    id: String,
}

impl<F, T> TryFrom<ResponseRouterData<F, GigadatPaymentsResponse, T, PaymentsResponseData>>
    for RouterData<F, T, PaymentsResponseData>
{
    type Error = error_stack::Report<errors::ConnectorError>;
    fn try_from(
        item: ResponseRouterData<F, GigadatPaymentsResponse, T, PaymentsResponseData>,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
