...
//! storage status enum, generated by the [`router_derive::domain_status`]
//! attribute macro. The domain type mirrors every storage variant and adds a
...
#[router_derive::domain_status(storage = crate::RefundStatus)]
pub enum RefundStatusDomain {
    Failure,
    ManualReview,
    Pending,
    Success,
...
#[router_derive::domain_status(storage = crate::DisputeStatus)]
pub enum DisputeStatusDomain {
    DisputeOpened,
    DisputeExpired,
    DisputeAccepted,
    DisputeCancelled,
