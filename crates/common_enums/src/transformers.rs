...
impl From<PaymentMethodType> for PaymentMethod {
    fn from(value: PaymentMethodType) -> Self {
        match value {
            ...
            PaymentMethodType::CapitecPay => Self::BankTransfer,
            PaymentMethodType::PayShap => Self::BankTransfer,
            PaymentMethodType::NedbankDirectEft => Self::BankTransfer,
            PaymentMethodType::PeachEft => Self::BankTransfer,
            PaymentMethodType::Payflex => Self::PayLater,
            PaymentMethodType::ZeroPay => Self::PayLater,
            PaymentMethodType::APlus => Self::PayLater,
            PaymentMethodType::Float => Self::PayLater,
            PaymentMethodType::HappyPay => Self::PayLater,
            PaymentMethodType::Mobicred => Self::PayLater,
            PaymentMethodType::Rcs => Self::PayLater,
            PaymentMethodType::Mpesa => Self::Wallet,
            PaymentMethodType::BlinkByEmtel => Self::Wallet,
            PaymentMethodType::McbJuice => Self::Wallet,
            PaymentMethodType::ScanToPay => Self::Wallet,
            PaymentMethodType::Maucas => Self::Wallet,
            PaymentMethodType::OneForYou => Self::Voucher,
            PaymentMethodType::MoneyBadger => Self::Crypto,
        }
    }
}
