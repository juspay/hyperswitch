...
impl PaymentMethodType {
    ...
    pub fn to_display_name(&self) -> String {
        match self {
            ...
            PaymentMethodType::Atome => "Atome".to_string(),
            PaymentMethodType::BancontactCard => "Bancontact Card".to_string(),
            PaymentMethodType::Becs => "BECS Direct Debit".to_string(),
            PaymentMethodType::Benefit => "Benefit".to_string(),
            PaymentMethodType::Bizum => "Bizum".to_string(),
            PaymentMethodType::Blik => "BLIK".to_string(),
            PaymentMethodType::Boleto => "Boleto Bancário".to_string(),
            PaymentMethodType::BcaBankTransfer => "BCA Bank Transfer".to_string(),
            PaymentMethodType::BniVa => "BNI Virtual Account".to_string(),
            PaymentMethodType::BriVa => "BRI Virtual Account".to_string(),
            PaymentMethodType::CardRedirect => "Card Redirect".to_string(),
            PaymentMethodType::CimbVa => "CIMB Virtual Account".to_string(),
            PaymentMethodType::ClassicReward => "Classic Reward".to_string(),
            PaymentMethodType::Credit => "Credit Card".to_string(),
            PaymentMethodType::CryptoCurrency => "Crypto".to_string(),
            PaymentMethodType::Cashapp => "Cash App".to_string(),
            PaymentMethodType::Dana => "DANA".to_string(),
            PaymentMethodType::DanamonVa => "Danamon Virtual Account".to_string(),
            PaymentMethodType::Debit => "Debit Card".to_string(),
            PaymentMethodType::DuitNow => "DuitNow".to_string(),
            PaymentMethodType::Efecty => "Efecty".to_string(),
            PaymentMethodType::Eft => "EFT".to_string(),
            PaymentMethodType::Eps => "EPS".to_string(),
            PaymentMethodType::Fps => "FPS".to_string(),
            PaymentMethodType::Evoucher => "Evoucher".to_string(),
            PaymentMethodType::Giropay => "Giropay".to_string(),
            PaymentMethodType::Givex => "Givex".to_string(),
            PaymentMethodType::GooglePay => "Google Pay".to_string(),
            PaymentMethodType::GoPay => "GoPay".to_string(),
            PaymentMethodType::Gcash => "GCash".to_string(),
            PaymentMethodType::Ideal => "iDEAL".to_string(),
            PaymentMethodType::Interac => "Interac".to_string(),
            PaymentMethodType::Indomaret => "Indomaret".to_string(),
            PaymentMethodType::InstantBankTransfer => "Instant Bank Transfer".to_string(),
            PaymentMethodType::Klarna => "Klarna".to_string(),
            PaymentMethodType::KakaoPay => "KakaoPay".to_string(),
            PaymentMethodType::LocalBankRedirect => "Local Bank Redirect".to_string(),
            PaymentMethodType::MandiriVa => "Mandiri Virtual Account".to_string(),
            PaymentMethodType::Knet => "KNET".to_string(),
            PaymentMethodType::MbWay => "MB WAY".to_string(),
            PaymentMethodType::MobilePay => "MobilePay".to_string(),
            PaymentMethodType::Momo => "MoMo".to_string(),
            ...
            PaymentMethodType::OnlineBankingSlovakia => "Online Banking Slovakia".to_string(),
            PaymentMethodType::Oxxo => "OXXO".to_string(),
            PaymentMethodType::PagoEfectivo => "PagoEfectivo".to_string(),
            PaymentMethodType::PermataBankTransfer => "Permata Bank Transfer".to_string(),
            PaymentMethodType::OpenBankingUk => "Open Banking UK".to_string(),
            PaymentMethodType::PayBright => "PayBright".to_string(),
            PaymentMethodType::Paypal => "PayPal".to_string(),
            PaymentMethodType::Paze => "Paze".to_string(),
            PaymentMethodType::Pix => "Pix".to_string(),
            PaymentMethodType::PaySafeCard => "PaySafeCard".to_string(),
            PaymentMethodType::Przelewy24 => "Przelewy24".to_string(),
            PaymentMethodType::PromptPay => "PromptPay".to_string(),
            PaymentMethodType::Pse => "PSE".to_string(),
            PaymentMethodType::RedCompra => "RedCompra".to_string(),
            PaymentMethodType::RedPagos => "RedPagos".to_string(),
            PaymentMethodType::SamsungPay => "Samsung Pay".to_string(),
            PaymentMethodType::Sepa => "SEPA Direct Debit".to_string(),
            PaymentMethodType::SepaBankTransfer => "SEPA Bank Transfer".to_string(),
            PaymentMethodType::Sofort => "Sofort".to_string(),
            PaymentMethodType::Swish => "Swish".to_string(),
            PaymentMethodType::TouchNGo => "Touch 'n Go".to_string(),
            PaymentMethodType::Trustly => "Trustly".to_string(),
            PaymentMethodType::Twint => "TWINT".to_string(),
            PaymentMethodType::UpiCollect => "UPI Collect".to_string(),
            PaymentMethodType::UpiIntent => "UPI Intent".to_string(),
            PaymentMethodType::Vipps => "Vipps".to_string(),
            PaymentMethodType::VietQr => "VietQR".to_string(),
            PaymentMethodType::Venmo => "Venmo".to_string(),
            PaymentMethodType::Walley => "Walley".to_string(),
            PaymentMethodType::WeChatPay => "WeChat Pay".to_string(),
            PaymentMethodType::SevenEleven => "7-Eleven".to_string(),
            PaymentMethodType::Lawson => "Lawson".to_string(),
            PaymentMethodType::MiniStop => "Mini Stop".to_string(),
            PaymentMethodType::FamilyMart => "FamilyMart".to_string(),
            PaymentMethodType::Seicomart => "Seicomart".to_string(),
            PaymentMethodType::PayEasy => "PayEasy".to_string(),
            PaymentMethodType::LocalBankTransfer => "Local Bank Transfer".to_string(),
            PaymentMethodType::Mifinity => "Mifinity".to_string(),
            PaymentMethodType::OpenBankingPIS => "Open Banking PIS".to_string(),
            PaymentMethodType::DirectCarrierBilling => "Direct Carrier Billing".to_string(),
        }
    }
}
