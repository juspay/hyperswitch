...
impl PaymentMethodType {
    ...
    pub fn to_display_name(&self) -> String {
        match self {
            Self::Ach => "ACH Direct Debit".to_string(),
            Self::Bacs => "BACS Direct Debit".to_string(),
            Self::Affirm => "Affirm".to_string(),
            Self::AfterpayClearpay => "Afterpay and Clearpay".to_string(),
            Self::Alfamart => "Alfamart".to_string(),
            Self::AliPay => "Alipay".to_string(),
            Self::AliPayHk => "AlipayHK".to_string(),
            Self::Alma => "Alma".to_string(),
            Self::AmazonPay => "Amazon Pay".to_string(),
            Self::ApplePay => "Apple Pay".to_string(),
            Self::Atome => "Atome".to_string(),
            Self::BancontactCard => "Bancontact Card".to_string(),
            Self::Becs => "BECS Direct Debit".to_string(),
            Self::Benefit => "Benefit".to_string(),
            Self::Bizum => "Bizum".to_string(),
            Self::Blik => "BLIK".to_string(),
            Self::Boleto => "Boleto Bancário".to_string(),
            Self::BcaBankTransfer => "BCA Bank Transfer".to_string(),
            Self::BniVa => "BNI Virtual Account".to_string(),
            Self::BriVa => "BRI Virtual Account".to_string(),
            Self::CardRedirect => "Card Redirect".to_string(),
            Self::CimbVa => "CIMB Virtual Account".to_string(),
            Self::ClassicReward => "Classic Reward".to_string(),
            Self::Credit => "Credit Card".to_string(),
            Self::CryptoCurrency => "Crypto".to_string(),
            Self::Cashapp => "Cash App".to_string(),
            Self::Dana => "DANA".to_string(),
            Self::DanamonVa => "Danamon Virtual Account".to_string(),
            Self::Debit => "Debit Card".to_string(),
            Self::DuitNow => "DuitNow".to_string(),
            Self::Efecty => "Efecty".to_string(),
            Self::Eft => "EFT".to_string(),
            Self::Eps => "EPS".to_string(),
            Self::Fps => "FPS".to_string(),
            Self::Evoucher => "Evoucher".to_string(),
            Self::Giropay => "Giropay".to_string(),
            Self::Givex => "Givex".to_string(),
            Self::GooglePay => "Google Pay".to_string(),
            Self::GoPay => "GoPay".to_string(),
            Self::Gcash => "GCash".to_string(),
            Self::Ideal => "iDEAL".to_string(),
            Self::Interac => "Interac".to_string(),
            Self::Indomaret => "Indomaret".to_string(),
            Self::InstantBankTransfer => "Instant Bank Transfer".to_string(),
            Self::Klarna => "Klarna".to_string(),
            Self::KakaoPay => "KakaoPay".to_string(),
            Self::LocalBankRedirect => "Local Bank Redirect".to_string(),
            Self::MandiriVa => "Mandiri Virtual Account".to_string(),
            Self::Knet => "KNET".to_string(),
            Self::MbWay => "MB WAY".to_string(),
            Self::MobilePay => "MobilePay".to_string(),
            Self::Momo => "MoMo".to_string(),
            ...
            Self::OnlineBankingSlovakia => "Online Banking Slovakia".to_string(),
            Self::Oxxo => "OXXO".to_string(),
            Self::PagoEfectivo => "PagoEfectivo".to_string(),
            Self::PermataBankTransfer => "Permata Bank Transfer".to_string(),
            Self::OpenBankingUk => "Open Banking UK".to_string(),
            Self::PayBright => "PayBright".to_string(),
            Self::Paypal => "PayPal".to_string(),
            Self::Paze => "Paze".to_string(),
            Self::Pix => "Pix".to_string(),
            Self::PaySafeCard => "PaySafeCard".to_string(),
            Self::Przelewy24 => "Przelewy24".to_string(),
            Self::PromptPay => "PromptPay".to_string(),
            Self::Pse => "PSE".to_string(),
            Self::RedCompra => "RedCompra".to_string(),
            Self::RedPagos => "RedPagos".to_string(),
            Self::SamsungPay => "Samsung Pay".to_string(),
            Self::Sepa => "SEPA Direct Debit".to_string(),
            Self::SepaBankTransfer => "SEPA Bank Transfer".to_string(),
            Self::Sofort => "Sofort".to_string(),
            Self::Swish => "Swish".to_string(),
            Self::TouchNGo => "Touch 'n Go".to_string(),
            Self::Trustly => "Trustly".to_string(),
            Self::Twint => "TWINT".to_string(),
            Self::UpiCollect => "UPI Collect".to_string(),
            Self::UpiIntent => "UPI Intent".to_string(),
            Self::Vipps => "Vipps".to_string(),
            Self::VietQr => "VietQR".to_string(),
            Self::Venmo => "Venmo".to_string(),
            Self::Walley => "Walley".to_string(),
            Self::WeChatPay => "WeChat Pay".to_string(),
            Self::SevenEleven => "7-Eleven".to_string(),
            Self::Lawson => "Lawson".to_string(),
            Self::MiniStop => "Mini Stop".to_string(),
            Self::FamilyMart => "FamilyMart".to_string(),
