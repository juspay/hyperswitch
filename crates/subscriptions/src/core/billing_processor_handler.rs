...
impl BillingHandler {
    ...
    pub async fn create_subscription_on_connector(
        ...
        let subscription_req = subscription_request_types::SubscriptionCreateRequest {
            ...
            // Stripe Billing subscriptions require automatic collection. Reject a missing reusable
            // credential instead of silently falling back to an uncollectable `send_invoice` flow.
