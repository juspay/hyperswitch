...
use crate::{
    core::{cards, errors, network_tokenization},
...
use api_models::{
    enums as api_enums,
    payment_methods::{self as api, CardDetailsPaymentMethod, PaymentMethodsData},
};
#[cfg(feature = "v1")]
...
impl PaymentMethodsController for PmController<'_> {
    ...
    async fn add_card_hs(
        ...
        _customer_id: &id_type::CustomerId,
        _locker_choice: api_enums::LockerChoice,
        _card_reference: Option<&str>,
    ) -> errors::VaultResult<(api::PaymentMethodResponse, Option<DataDuplicationCheck>)> {
        todo!("add_card_hs implementation")
    }
    ...
    async fn add_card_to_locker(
        ...
        todo!("add_card_to_locker implementation")
    }
    ...
    async fn add_bank_to_locker(
        ...
        todo!("add_bank_to_locker implementation")
    }
    ...
    async fn get_card_details_with_locker_fallback(
        &self,
        _pm: &payment_methods::PaymentMethod,
    ) -> errors::PmResult<Option<api::CardDetailFromLocker>> {
        todo!("get_card_details_with_locker_fallback implementation")
    }
    ...
    async fn get_card_details_without_locker_fallback(
        ...
        todo!("get_card_details_without_locker_fallback implementation")
    }
    ...
    async fn add_payment_method_status_update_task(
        &self,
        _payment_method: &payment_methods::PaymentMethod,
        _prev_status: common_enums::PaymentMethodStatus,
        _curr_status: common_enums::PaymentMethodStatus,
        _merchant_id: &id_type::MerchantId,
    ) -> Result<(), sch_errors::ProcessTrackerError> {
        todo!("add_payment_method_status_update_task implementation")
    }
    ...
    async fn get_card_details_from_locker(
        ...
        todo!("get_card_details_from_locker implementation")
    }
}
