...
pub struct FeatureMatrixRequest {
    ...
    #[schema(value_type = Option<Vec<common_enums::connector_enums::Connector>>)]
...
pub struct CardSpecificFeatures {
    ...
    #[schema(value_type = common_enums::FeatureStatus)]
    ...
    #[schema(value_type = Vec<common_enums::CardNetwork>)]
...
pub struct SupportedPaymentMethod {
    ...
    #[schema(value_type = Vec<common_enums::CaptureMethod>)]
    ...
    #[schema(value_type = Option<HashSet<common_enums::CountryAlpha3>>)]
    ...
    #[schema(value_type = Option<HashSet<common_enums::Currency>>)]
...
pub struct ConnectorFeatureMatrixResponse {
    ...
    #[schema(value_type = common_enums::HyperswitchConnectorCategory, example = "payment_gateway")]
    pub category: common_enums::HyperswitchConnectorCategory,
    /// The integration status of the connector
    #[schema(value_type = common_enums::ConnectorIntegrationStatus, example = "live")]
    ...
    #[schema(value_type = Option<Vec<common_enums::EventClass>>)]
