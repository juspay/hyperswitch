...
pub struct PaymentsResponse {
    ...
    /// This field will be depricated soon. Please refer to `customer.id`
    #[schema(
        max_length = 255,
        example = "cus_y3oqhf46pyzuxjbcn2giaqnb44",
        deprecated
    ...
    /// This field will be depricated soon. Please refer to `customer.email` object
    #[schema(max_length = 255, value_type = Option<String>, example = "johntest@test.com", deprecated)]
    pub email: crypto::OptionalEncryptableEmail,

    /// description: The customer's name
    /// This field will be depricated soon. Please refer to `customer.name` object
    #[schema(value_type = Option<String>, max_length = 255, example = "John Test", deprecated)]
    pub name: crypto::OptionalEncryptableName,

    /// The customer's phone number
    /// This field will be depricated soon. Please refer to `customer.phone` object
    #[schema(value_type = Option<String>, max_length = 255, example = "3141592653", deprecated)]
