...
use crate::user::{
    ...
    CloneConnectorWithinMerchantRequest, ConnectAccountRequest, CreateInternalUserRequest,
    ...
    UserMerchantCreate, UserMerchantDetailsResponse, UserOrgMerchantCreateRequest,
...
common_utils::impl_api_event_type!(
    ...
    (
        ...
        CloneConnectorWithinMerchantRequest,
