...
pub struct PayoutCreateRequest {
    ...
    #[schema( max_length = 255, example = json!(["wise", "adyen"]))]
...
pub struct PayoutCreateResponse {
    ...
    #[schema( example = RequiresConfirmation)]
