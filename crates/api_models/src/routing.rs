...
use euclid::{
    ...
    frontend::{
        ast::{ConnectorChoice, VolSplit},
        dir::{DirKeyKind, EuclidDirFilter},
    },
};
use serde::{Deserialize, Serialize};

use super::enums::{self, RoutableConnectors};
    ...
    fn get_dir_value_for_analysis(
        ...
        self.get_connector_list()
            ...
            .map(|connector_choice| {
                ...
                (
                    euclid::frontend::dir::DirValue::Connector(Box::new(connector_choice)),
...
impl ToString for RoutableConnectorChoice {
    fn to_string(&self) -> String {
        let mut base = self.connector.to_string();
