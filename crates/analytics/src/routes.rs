...
//     let flow = Flow::GetPaymentMetrics;
//     api::server_wrap(
//         flow,
//         state,
//         &req,
...
//     let flow = Flow::GetRefundsMetrics;
//     api::server_wrap(
//         flow,
//         state,
//         &req,
...
// ) -> impl Responder {
//     let flow = Flow::GetPaymentFilters;
//     api::server_wrap(
//         flow,
//         state,
//         &req,
...
// ) -> impl Responder {
//     let flow = Flow::GetRefundFilters;
//     api::server_wrap(
//         flow,
//         state,
//         &req,
...
// ) -> impl Responder {
//     let flow = Flow::GetSdkEventFilters;
//     api::server_wrap(
//         flow,
//         state,
//         &req,
