...
{
        /// Asynchronously loads and retrieves metrics data based on the provided dimensions, publishable key, filters, granularity, time range, and database connection pool.
