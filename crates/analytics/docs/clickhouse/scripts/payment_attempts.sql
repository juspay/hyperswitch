CREATE TABLE payment_attempt_queue (
    ...
    `standardised_code` Nullable(String),
    `recovered_from_error_code` Nullable(String),
    `recovered_from_error_reason` Nullable(String),
    `recovered_from_standardised_code` Nullable(String),
    `recovered_from_connector` Nullable(String),
