...
//         $crate::frontend::dir::DirValue::Connector(Box::new(
//             $crate::frontend::ast::ConnectorChoice {
//                 choice_kind: $crate::frontend::ast::ConnectorChoiceKind::OnlyConnector,
//                 connector: $crate::frontend::dir::enums::Connector::$name,
//                 sub_label: None,
//             },
//         ))
...
//
// #[macro_export]
// #[cfg(not(feature = "connector_choice_bcompat"))]
// macro_rules! dirval {
//     (Connector = $name:ident) => {
//         $crate::frontend::dir::DirValue::Connector(Box::new(
//             $crate::frontend::ast::ConnectorChoice {
...
//                         DirValue::Connector(Box::new(ast::ConnectorChoice {
//                             #[cfg(feature = "connector_choice_bcompat")]
//                             choice_kind: ast::ConnectorChoiceKind::OnlyConnector,
//                             connector,
//                             sub_label: None,
//                         }))
//                     })
