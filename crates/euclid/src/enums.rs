...
impl TryFrom<Connector> for RoutableConnectors {
    ...
    fn try_from(connector: Connector) -> Result<Self, Self::Error> {
        match connector {
            ...
            Connector::ElavonPg => Ok(Self::ElavonPg),
            ...
            Connector::GlobalpaymentsHeartland => Ok(Self::GlobalpaymentsHeartland),
            ...
            Connector::JpmorganOrbital => Ok(Self::JpmorganOrbital),
            Connector::Klarna => Ok(Self::Klarna),
            Connector::Loonio => Ok(Self::Loonio),
            Connector::Merchante => Ok(Self::Merchante),
            ...
            Connector::Paydotcom => Ok(Self::Paydotcom),
            Connector::Payload => Ok(Self::Payload),
            Connector::Payme => Ok(Self::Payme),
            Connector::Paynearme => Ok(Self::Paynearme),
            ...
            Connector::Saferpay => Ok(Self::Saferpay),
...
impl From<RoutableConnectors> for Connector {
    fn from(routable_connector: RoutableConnectors) -> Self {
        match routable_connector {
            ...
            RoutableConnectors::D24 => Self::D24,
            ...
            RoutableConnectors::ElavonPg => Self::ElavonPg,
            ...
            RoutableConnectors::GlobalpaymentsHeartland => Self::GlobalpaymentsHeartland,
            ...
            RoutableConnectors::Paydotcom => Self::Paydotcom,
            RoutableConnectors::Payload => Self::Payload,
            RoutableConnectors::Payme => Self::Payme,
            RoutableConnectors::Paynearme => Self::Paynearme,
            ...
            RoutableConnectors::Saferpay => Self::Saferpay,
            ...
            RoutableConnectors::Nsure => Self::Nsure,
