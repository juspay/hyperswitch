...
impl super::RedisConnectionPool {
    ...
    pub async fn stream_read_entries(
        ...
        crate::observed!(self, "XREAD", {
            ...
            let options = StreamReadOptions::default().count(
                usize::try_from(count).change_context(errors::RedisError::StreamReadFailed)?,
            );
