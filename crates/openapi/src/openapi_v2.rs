...
"#,
    ...
    paths(
        ...
        routes::payment_method::create_payment_method_intent_api_v1,
        routes::payment_method::confirm_payment_method_intent_api,
        routes::payment_method::confirm_payment_method_intent_api_v1,
        ...
        routes::payment_method::network_token_status_check_api_v1,
