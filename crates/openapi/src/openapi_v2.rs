...
"#,
    ...
    components(schemas(
        ...
        api_models::payouts::CardPayoutResponse,
        api_models::payouts::additional_info::CardAdditionalData,
        api_models::payouts::Wallet,
        api_models::payouts::additional_info::WalletAdditionalData,
        api_models::payouts::additional_info::PaypalAdditionalData,
        api_models::payouts::additional_info::VenmoAdditionalData,
        api_models::payouts::WalletPayoutResponse,
        ...
        api_models::payouts::BankPayoutResponse,
        api_models::payouts::additional_info::BankAdditionalData,
        api_models::payouts::additional_info::AchBankTransferAdditionalData,
        api_models::payouts::additional_info::BacsBankTransferAdditionalData,
        api_models::payouts::additional_info::SepaBankTransferAdditionalData,
        api_models::payouts::additional_info::PixBankTransferAdditionalData,
