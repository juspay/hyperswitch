...
"#,
    ...
    components(schemas(
        ...
        api_models::three_ds_decision_rule::CartesBancairesParams,
        api_models::three_ds_decision_rule::NetworkParams,
        api_models::three_ds_decision_rule::Cryptogram,
        api_models::three_ds_decision_rule::ExternalThreeDsData,
