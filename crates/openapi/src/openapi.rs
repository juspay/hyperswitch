...
"#,
    ...
    paths(
        ...
        routes::merchant_connector_account::retrieve_connector_webhook,
        //Routes for gsm
    ...
    components(schemas(
        ...
        api_models::admin::ConnectorWebhookRegisterRequest,
        api_models::admin::RegisterConnectorWebhookResponse,
        api_models::admin::ConnectorWebhookResponse,
        api_models::admin::ConnectorWebhookListResponse,
