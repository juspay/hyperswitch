...
#[utoipa::path(
    post,
    path = "/routing",
    request_body = api_models::routing::RoutingConfigRequest,
    responses(
        (status = 200, description = "Routing config created", body = api_models::routing::RoutingDictionaryRecord),
...
#[utoipa::path(
    ...
    request_body = api_models::routing::RoutingConfigRequest,
    responses(
        (status = 200, description = "Routing Algorithm created", body = api_models::routing::RoutingDictionaryRecord),
        (status = 400, description = "Request body is malformed"),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing"),
        (status = 422, description = "Unprocessable request"),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Routing config activated", body = api_models::routing::RoutingDictionaryRecord),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing"),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully fetched routing config", body = api_models::routing::MerchantRoutingAlgorithm),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing"),
        (status = 403, description = "Forbidden")
    ),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully fetched routing algorithm", body = api_models::routing::MerchantRoutingAlgorithm),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing"),
        (status = 403, description = "Forbidden")
    ),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully fetched routing configs", body = api_models::routing::RoutingKind),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing")
    ),
   tag = "Routing",
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully updated default config", body = Vec<api_models::routing::RoutableConnectorChoice>),
        (status = 500, description = "Internal server error"),
        (status = 400, description = "Malformed request"),
        (status = 422, description = "Unprocessable request")
    ),
...
#[utoipa::path(
    ...
    path = "/routing/default",
    responses(
        (status = 200, description = "Successfully retrieved default config", body = Vec<api_models::routing::RoutableConnectorChoice>),
        (status = 500, description = "Internal server error")
    ),
   tag = "Routing",
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully retrieved default config", body = api_models::routing::ProfileDefaultRoutingConfig),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing")
    ),
   tag = "Routing",
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully updated default config for profile", body = api_models::routing::ProfileDefaultRoutingConfig),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing"),
        (status = 400, description = "Malformed request"),
        (status = 422, description = "Unprocessable request"),
...
#[utoipa::path(
    ...
    params(
        ...
        ("enable" = api_models::routing::DynamicRoutingFeatures, Query, description = "Feature to enable for success based routing"),
    ),
    responses(
        (status = 200, description = "Routing Algorithm created", body = api_models::routing::RoutingDictionaryRecord),
        (status = 400, description = "Request body is malformed"),
...
#[utoipa::path(
    ...
    request_body = api_models::routing::SuccessBasedRoutingConfig,
    params(
        ("account_id" = String, Path, description = "Merchant id"),
...
#[utoipa::path(
    ...
    request_body = api_models::routing::SuccessBasedRoutingConfig,
    responses(
        (status = 200, description = "Routing Algorithm updated", body = api_models::routing::RoutingDictionaryRecord),
...
#[utoipa::path(
    ...
    params(
        ("account_id" = String, Path, description = "Merchant id"),
        ("profile_id" = String, Path, description = "Profile id under which Dynamic routing needs to be toggled"),
        ("enable" = api_models::routing::DynamicRoutingFeatures, Query, description = "Feature to enable for elimination based routing"),
    ),
    responses(
        (status = 200, description = "Routing Algorithm created", body = api_models::routing::RoutingDictionaryRecord),
        (status = 400, description = "Request body is malformed"),
...
#[utoipa::path(
    ...
    request_body = api_models::routing::EliminationRoutingConfig,
    params(
        ("account_id" = String, Path, description = "Merchant id"),
        ("profile_id" = String, Path, description = "Profile id under which Dynamic routing needs to be created"),
        ("enable" = api_models::routing::DynamicRoutingFeatures, Query, description = "Feature to enable for elimination based routing"),
...
#[utoipa::path(
    ...
    params(
        ("account_id" = String, Path, description = "Merchant id"),
        ("profile_id" = String, Path, description = "Profile id under which Dynamic routing needs to be toggled"),
        ("enable" = api_models::routing::DynamicRoutingFeatures, Query, description = "Feature to enable for contract based routing"),
    ),
    request_body = api_models::routing::ContractBasedRoutingConfig,
    responses(
        (status = 200, description = "Routing Algorithm created", body = api_models::routing::RoutingDictionaryRecord),
        (status = 400, description = "Request body is malformed"),
        (status = 500, description = "Internal server error"),
...
#[utoipa::path(
    ...
    request_body = api_models::open_router::OpenRouterDecideGatewayRequest,
    responses(
        (status = 200, description = "Routing rules evaluated successfully", body = api_models::open_router::DecideGatewayResponse),
        (status = 400, description = "Request body is malformed"),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing"),
        (status = 422, description = "Unprocessable request"),
...
#[utoipa::path(
    ...
    request_body = api_models::open_router::UpdateScorePayload,
    responses(
        (status = 200, description = "Gateway score updated successfully", body = api_models::open_router::UpdateScoreResponse),
        (status = 400, description = "Request body is malformed"),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing"),
        (status = 422, description = "Unprocessable request"),
...
#[utoipa::path(
    ...
    request_body = api_models::routing::RoutingEvaluateRequest,
    responses(
        (status = 200, description = "Routing rules evaluated successfully", body = api_models::routing::RoutingEvaluateResponse),
        (status = 400, description = "Request body is malformed"),
        (status = 500, description = "Internal server error"),
        (status = 404, description = "Resource missing"),
        (status = 422, description = "Unprocessable request"),
