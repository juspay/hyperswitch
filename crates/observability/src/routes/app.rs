...
use crate::{
    ...
    logger,
    routes::{alerts_info, blacklist, cloudwatch, health_check, notify, thresholds},
    state::AppState,
};
        ...
        web::scope("/alerts")
            ...
            .service(
                web::resource("/thresholds")
                    .route(web::get().to(thresholds::list))
                    .route(web::post().to(thresholds::upsert))
                    .route(web::delete().to(thresholds::delete)),
            )
            .service(
