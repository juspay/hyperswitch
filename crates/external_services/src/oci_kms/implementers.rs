//! Trait implementations for OCI KMS client
...
use crate::oci_kms::core::OciKmsClient;

#[async_trait::async_trait]
impl EncryptionManagementInterface for OciKmsClient {
...
#[async_trait::async_trait]
impl SecretManagementInterface for OciKmsClient {
    async fn get_secret(
        &self,
        input: Secret<String>,
