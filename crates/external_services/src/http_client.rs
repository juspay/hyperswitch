...
/// XML Serializer for serializing payloads to XML bytes with configurable declarations
pub struct XmlSerializer;

impl XmlSerializer {
    /// Serialize a payload to XML bytes with optional configuration
            ...
            Method::Post => {
                ...
                match request.body {
                    ...
                    Some(RequestContent::Xml(payload, config)) => {
                        let body = XmlSerializer::serialize_to_xml_bytes(&payload, config)?;
