...
class TestPaymentCreatePaymentLinkConfig(unittest.TestCase):
    """PaymentCreatePaymentLinkConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentCreatePaymentLinkConfig:
        """Test PaymentCreatePaymentLinkConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentCreatePaymentLinkConfig`
        """
        model = PaymentCreatePaymentLinkConfig()
        if include_optional:
            return PaymentCreatePaymentLinkConfig(
                theme = '#4E6ADD',
    ...
    def testPaymentCreatePaymentLinkConfig(self):
        """Test PaymentCreatePaymentLinkConfig"""
