...
class TestDisputeResponse1(unittest.TestCase):
    """DisputeResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisputeResponse1:
        """Test DisputeResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisputeResponse1`
        """
        model = DisputeResponse1()
        if include_optional:
            return DisputeResponse1(
                type = 'dispute_details',
                object = hyperswitch.models.dispute_response.DisputeResponse(
                    dispute_id = '', 
                    payment_id = '', 
                    attempt_id = '', 
                    amount = '', 
