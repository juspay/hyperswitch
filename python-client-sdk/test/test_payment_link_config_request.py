...
class TestPaymentLinkConfigRequest(unittest.TestCase):
    """PaymentLinkConfigRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentLinkConfigRequest:
        """Test PaymentLinkConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentLinkConfigRequest`
        """
        model = PaymentLinkConfigRequest()
        if include_optional:
            return PaymentLinkConfigRequest(
                theme = '#4E6ADD',
    ...
    def testPaymentLinkConfigRequest(self):
        """Test PaymentLinkConfigRequest"""
