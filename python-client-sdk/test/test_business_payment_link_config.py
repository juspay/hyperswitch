...
class TestBusinessPaymentLinkConfig(unittest.TestCase):
    """BusinessPaymentLinkConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessPaymentLinkConfig:
        """Test BusinessPaymentLinkConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessPaymentLinkConfig`
        """
        model = BusinessPaymentLinkConfig()
        if include_optional:
            return BusinessPaymentLinkConfig(
                theme = '#4E6ADD',
                ...
                business_specific_configs = {
                    'key' : hyperswitch.models.payment_link_config_request.PaymentLinkConfigRequest(
                        theme = '#4E6ADD', 
                        logo = 'https://i.pinimg.com/736x/4d/83/5c/4d835ca8aafbbb15f84d07d926fda473.jpg', 
                        seller_name = 'hyperswitch', 
                        sdk_layout = 'accordion', 
    ...
    def testBusinessPaymentLinkConfig(self):
        """Test BusinessPaymentLinkConfig"""
