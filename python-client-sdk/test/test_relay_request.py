...
class TestRelayRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RelayRequest:
        """Test RelayRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelayRequest`
        """
        model = RelayRequest()
        if include_optional:
            return RelayRequest(
