...
class TestEventListItemResponse(unittest.TestCase):
    """EventListItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventListItemResponse:
        """Test EventListItemResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventListItemResponse`
        """
        model = EventListItemResponse()
        if include_optional:
    ...
    def testEventListItemResponse(self):
        """Test EventListItemResponse"""
