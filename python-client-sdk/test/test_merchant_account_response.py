...
class TestMerchantAccountResponse(unittest.TestCase):
    """MerchantAccountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantAccountResponse:
        """Test MerchantAccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantAccountResponse`
        """
        model = MerchantAccountResponse()
        if include_optional:
    ...
    def testMerchantAccountResponse(self):
        """Test MerchantAccountResponse"""
