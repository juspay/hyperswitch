...
class TestSessionTokenInfo(unittest.TestCase):
    """SessionTokenInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SessionTokenInfo:
        """Test SessionTokenInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SessionTokenInfo`
        """
        model = SessionTokenInfo()
        if include_optional:
