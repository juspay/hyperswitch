...
class TestMerchantAccountUpdate(unittest.TestCase):
    """MerchantAccountUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantAccountUpdate:
        """Test MerchantAccountUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantAccountUpdate`
        """
        model = MerchantAccountUpdate()
        if include_optional:
            return MerchantAccountUpdate(
                ...
                primary_business_details = [
                    hyperswitch.models.primary_business_details.PrimaryBusinessDetails(
                        country = 'AF', 
                        business = 'food', )
                    ],
    ...
    def testMerchantAccountUpdate(self):
        """Test MerchantAccountUpdate"""
