...
class TestPaymentsResponse1(unittest.TestCase):
    """PaymentsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentsResponse1:
        """Test PaymentsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentsResponse1`
        """
        model = PaymentsResponse1()
        if include_optional:
            return PaymentsResponse1(
                type = 'payment_details',
                object = hyperswitch.models.payments_response.PaymentsResponse(
    ...
    def testPaymentsResponse1(self):
        """Test PaymentsResponse1"""
