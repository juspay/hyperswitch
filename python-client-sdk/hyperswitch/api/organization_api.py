...
class OrganizationApi:
    ...
    def create_an_organization(
        ...
        _param = self._create_an_organization_serialize(
    ...
    @validate_call
    def create_an_organization_with_http_info(
        self,
        organization_create_request: OrganizationCreateRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_an_organization_without_preload_content(
        self,
        organization_create_request: OrganizationCreateRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_an_organization_serialize(
        self,
    ...
    def retrieve_an_organization(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier for the Organization")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._retrieve_an_organization_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def retrieve_an_organization_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier for the Organization")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def retrieve_an_organization_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier for the Organization")],
        _request_timeout: Union[
            None,
    ...
    def _retrieve_an_organization_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def update_an_organization(
        ...
        _param = self._update_an_organization_serialize(
            id=id,
    ...
    @validate_call
    def update_an_organization_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier for the Organization")],
        organization_update_request: OrganizationUpdateRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def update_an_organization_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier for the Organization")],
        organization_update_request: OrganizationUpdateRequest,
        _request_timeout: Union[
    ...
    def _update_an_organization_serialize(
        self,
        id,
