...
class BankRedirectDataOneOf2(BaseModel):
    """
    BankRedirectDataOneOf2
    """ # noqa: E501
    blik: BankRedirectDataOneOf2Blik
    __properties: ClassVar[List[str]] = ["blik"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blik": BankRedirectDataOneOf2Blik.from_dict(obj["blik"]) if obj.get("blik") is not None else None
        })
        return _obj
