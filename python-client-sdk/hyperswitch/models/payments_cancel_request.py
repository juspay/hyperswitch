...
class PaymentsCancelRequest(BaseModel):
    """
    PaymentsCancelRequest
    """ # noqa: E501
    cancellation_reason: Optional[StrictStr] = Field(default=None, description="The reason for the payment cancel")
    merchant_connector_details: Optional[MerchantConnectorDetailsWrap] = None
    __properties: ClassVar[List[str]] = ["cancellation_reason", "merchant_connector_details"]
