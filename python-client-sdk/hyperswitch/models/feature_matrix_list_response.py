...
class FeatureMatrixListResponse(BaseModel):
    """
    FeatureMatrixListResponse
    """ # noqa: E501
    connector_count: Annotated[int, Field(strict=True, ge=0)] = Field(description="The number of connectors included in the response")
    connectors: List[ConnectorFeatureMatrixResponse]
    __properties: ClassVar[List[str]] = ["connector_count", "connectors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connector_count": obj.get("connector_count"),
            "connectors": [ConnectorFeatureMatrixResponse.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None
        })
        return _obj
