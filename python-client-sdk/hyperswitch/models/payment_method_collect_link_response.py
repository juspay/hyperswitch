...
class PaymentMethodCollectLinkResponse(BaseModel):
    """
    ...
    pm_collect_link_id: StrictStr = Field(description="The unique identifier for the collect link.")
    customer_id: StrictStr = Field(description="The unique identifier of the customer.")
    expiry: datetime = Field(description="Time when this link will be expired in ISO8601 format")
    link: StrictStr = Field(description="URL to the form's link generated for collecting payment method details.")
    ...
    __properties: ClassVar[List[str]] = ["logo", "merchant_name", "theme", "pm_collect_link_id", "customer_id", "expiry", "link", "return_url", "enabled_payment_methods"]
