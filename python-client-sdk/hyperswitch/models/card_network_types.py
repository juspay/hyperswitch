...
class CardNetworkTypes(BaseModel):
    """
    CardNetworkTypes
    """ # noqa: E501
    card_network: Optional[CardNetwork] = None
    surcharge_details: Optional[SurchargeDetailsResponse] = None
    eligible_connectors: List[StrictStr] = Field(description="The list of eligible connectors for a given card network")
    __properties: ClassVar[List[str]] = ["card_network", "surcharge_details", "eligible_connectors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eligible_connectors": obj.get("eligible_connectors")
        })
        return _obj
