...
class MerchantRecipientDataOneOf2(BaseModel):
    """
    MerchantRecipientDataOneOf2
    """ # noqa: E501
    account_data: MerchantAccountData
    __properties: ClassVar[List[str]] = ["account_data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account_data": MerchantAccountData.from_dict(obj["account_data"]) if obj.get("account_data") is not None else None
        })
        return _obj
