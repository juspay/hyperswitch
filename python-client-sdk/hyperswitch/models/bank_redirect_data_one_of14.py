...
class BankRedirectDataOneOf14(BaseModel):
    """
    BankRedirectDataOneOf14
    """ # noqa: E501
    trustly: BankRedirectDataOneOf14Trustly
    __properties: ClassVar[List[str]] = ["trustly"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "trustly": BankRedirectDataOneOf14Trustly.from_dict(obj["trustly"]) if obj.get("trustly") is not None else None
        })
        return _obj
