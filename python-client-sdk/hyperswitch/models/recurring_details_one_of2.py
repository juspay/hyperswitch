...
class RecurringDetailsOneOf2(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['processor_payment_token']):
            raise ValueError("must be one of enum values ('processor_payment_token')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "data": ProcessorPaymentToken.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
