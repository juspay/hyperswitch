...
class RelayDataOneOf(BaseModel):
    """
    RelayDataOneOf
    """ # noqa: E501
    refund: RelayRefundRequestData
    __properties: ClassVar[List[str]] = ["refund"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "refund": RelayRefundRequestData.from_dict(obj["refund"]) if obj.get("refund") is not None else None
        })
        return _obj
