...
class PaymentsUpdateMetadataRequest(BaseModel):
    """
    PaymentsUpdateMetadataRequest
    """ # noqa: E501
    metadata: Dict[str, Any] = Field(description="Metadata is useful for storing additional, unstructured information on an object.")
