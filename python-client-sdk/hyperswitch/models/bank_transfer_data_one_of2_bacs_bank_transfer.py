...
class BankTransferDataOneOf2BacsBankTransfer(BaseModel):
    """
    BankTransferDataOneOf2BacsBankTransfer
    """ # noqa: E501
    billing_details: Optional[SepaAndBacsBillingDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "billing_details": SepaAndBacsBillingDetails.from_dict(obj["billing_details"]) if obj.get("billing_details") is not None else None
        })
        return _obj
