...
class GiropayBankRedirectAdditionalData(BaseModel):
    """
    GiropayBankRedirectAdditionalData
    """ # noqa: E501
    bic: Optional[StrictStr] = Field(default=None, description="Masked bank account bic code")
    iban: Optional[StrictStr] = Field(default=None, description="Partially masked international bank account number (iban) for SEPA")
    country: Optional[CountryAlpha2] = None
    __properties: ClassVar[List[str]] = ["bic", "iban", "country"]
