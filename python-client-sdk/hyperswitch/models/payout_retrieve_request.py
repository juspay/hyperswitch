...
class PayoutRetrieveRequest(BaseModel):
    """
    ...
    force_sync: Optional[StrictBool] = Field(default=False, description="`force_sync` with the connector to get payout details (defaults to false)")
    merchant_id: Optional[StrictStr] = Field(default=None, description="The identifier for the Merchant Account.")
    __properties: ClassVar[List[str]] = ["payout_id", "force_sync", "merchant_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if force_sync (nullable) is None
        # and model_fields_set contains the field
        if self.force_sync is None and "force_sync" in self.model_fields_set:
            _dict['force_sync'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "force_sync": obj.get("force_sync") if obj.get("force_sync") is not None else False,
