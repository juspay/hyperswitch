...
class GivexGiftCardAdditionalData(BaseModel):
    """
    GivexGiftCardAdditionalData
    """ # noqa: E501
    last4: StrictStr = Field(description="Last 4 digits of the gift card number")
    __properties: ClassVar[List[str]] = ["last4"]
