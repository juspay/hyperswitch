...
class PayoutListFilters(BaseModel):
    ...
    PayoutListFilters
    """ # noqa: E501
    connector: List[PayoutConnectors] = Field(description="The list of available connector filters")
    currency: List[Currency] = Field(description="The list of available currency filters")
    status: List[PayoutStatus] = Field(description="The list of available payout status filters")
    payout_method: List[PayoutType] = Field(description="The list of available payout method filters")
    __properties: ClassVar[List[str]] = ["connector", "currency", "status", "payout_method"]
