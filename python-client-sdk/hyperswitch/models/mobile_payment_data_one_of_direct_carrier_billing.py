...
class MobilePaymentDataOneOfDirectCarrierBilling(BaseModel):
    """
    MobilePaymentDataOneOfDirectCarrierBilling
    """ # noqa: E501
    msisdn: StrictStr = Field(description="The phone number of the user")
    client_uid: Optional[StrictStr] = Field(default=None, description="Unique user id")
    __properties: ClassVar[List[str]] = ["msisdn", "client_uid"]
