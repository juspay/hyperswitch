...
class CustomerDefaultPaymentMethodResponse(BaseModel):
    """
    CustomerDefaultPaymentMethodResponse
    """ # noqa: E501
    default_payment_method_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the Payment method")
    ...
    __properties: ClassVar[List[str]] = ["default_payment_method_id", "customer_id", "payment_method", "payment_method_type"]
