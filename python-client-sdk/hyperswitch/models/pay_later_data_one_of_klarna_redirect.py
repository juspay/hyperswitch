...
class PayLaterDataOneOfKlarnaRedirect(BaseModel):
    """
    For KlarnaRedirect as PayLater Option
    """ # noqa: E501
    billing_email: Optional[StrictStr] = Field(default=None, description="The billing email")
    billing_country: Optional[CountryAlpha2] = None
    __properties: ClassVar[List[str]] = ["billing_email", "billing_country"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if billing_country (nullable) is None
        # and model_fields_set contains the field
        if self.billing_country is None and "billing_country" in self.model_fields_set:
            _dict['billing_country'] = None
