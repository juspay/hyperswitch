...
class AdditionalPayoutMethodDataOneOf(BaseModel):
    """
    AdditionalPayoutMethodDataOneOf
    """ # noqa: E501
    card: CardAdditionalData = Field(alias="Card")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Card": CardAdditionalData.from_dict(obj["Card"]) if obj.get("Card") is not None else None
        })
        return _obj
