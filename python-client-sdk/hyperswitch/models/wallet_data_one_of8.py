...
class WalletDataOneOf8(BaseModel):
    """
    WalletDataOneOf8
    """ # noqa: E501
    apple_pay: ApplePayWalletData
    __properties: ClassVar[List[str]] = ["apple_pay"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apple_pay": ApplePayWalletData.from_dict(obj["apple_pay"]) if obj.get("apple_pay") is not None else None
        })
        return _obj
