...
class PaymentsResponse1(BaseModel):
    """
    PaymentsResponse1
    """ # noqa: E501
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['payment_details']):
            raise ValueError("must be one of enum values ('payment_details')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "object": PaymentsResponse.from_dict(obj["object"]) if obj.get("object") is not None else None
        })
        return _obj
