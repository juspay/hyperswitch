...
class PaymentMethodUpdate(BaseModel):
    ...
    PaymentMethodUpdate
    """ # noqa: E501
    card: Optional[CardDetailUpdate] = None
    client_secret: Optional[Annotated[str, Field(min_length=30, strict=True, max_length=30)]] = Field(default=None, description="This is a 15 minute expiry token which shall be used from the client to authenticate and perform sessions from the SDK")
    __properties: ClassVar[List[str]] = ["card", "client_secret"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "card": CardDetailUpdate.from_dict(obj["card"]) if obj.get("card") is not None else None,
