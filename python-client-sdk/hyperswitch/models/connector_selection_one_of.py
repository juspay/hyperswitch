...
class ConnectorSelectionOneOf(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['priority']):
            raise ValueError("must be one of enum values ('priority')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "data": [RoutableConnectorChoice.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
