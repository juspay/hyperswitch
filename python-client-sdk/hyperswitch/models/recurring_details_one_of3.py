...
class RecurringDetailsOneOf3(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['network_transaction_id_and_card_details']):
            raise ValueError("must be one of enum values ('network_transaction_id_and_card_details')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "data": NetworkTransactionIdAndCardDetails.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
