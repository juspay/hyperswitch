...
class RoutingRetrieveResponse(BaseModel):
    """
    Response of the retrieved routing configs for a merchant account
    """ # noqa: E501
    algorithm: Optional[MerchantRoutingAlgorithm] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "algorithm": MerchantRoutingAlgorithm.from_dict(obj["algorithm"]) if obj.get("algorithm") is not None else None
        })
        return _obj
