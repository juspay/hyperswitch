...
class ProfileResponse(BaseModel):
    ...
    ProfileResponse
    """ # noqa: E501
    merchant_id: Annotated[str, Field(strict=True, max_length=64)] = Field(description="The identifier for Merchant Account")
    profile_id: Annotated[str, Field(strict=True, max_length=64)] = Field(description="The identifier for profile. This must be used for creating merchant accounts, payments and payouts")
    profile_name: Annotated[str, Field(strict=True, max_length=64)] = Field(description="Name of the profile")
    ...
    intent_fulfillment_time: Optional[StrictInt] = Field(default=None, description="Will be used to determine the time till which your payment will be active once the payment session starts")
    frm_routing_algorithm: Optional[Dict[str, Any]] = Field(default=None, description="The routing algorithm to be used to process the incoming request from merchant to outgoing payment processor or payment method. The default is 'Custom'")
    ...
    session_expiry: Optional[StrictInt] = Field(default=None, description="Client Secret Default expiry for all payments created under this profile")
    ...
    use_billing_as_payment_method_billing: Optional[StrictBool] = None
    extended_card_info_config: Optional[ExtendedCardInfoConfig] = None
    ...
    outgoing_webhook_custom_http_headers: Optional[Dict[str, Any]] = Field(default=None, description="These key-value pairs are sent as additional custom headers in the outgoing webhook request.")
    ...
    is_tax_connector_enabled: StrictBool = Field(description="Indicates if tax_calculator connector is enabled or not. If set to `true` tax_connector_id will be checked.")
    is_network_tokenization_enabled: StrictBool = Field(description="Indicates if network tokenization is enabled or not.")
    is_auto_retries_enabled: StrictBool = Field(description="Indicates if is_auto_retries_enabled is enabled or not.")
    max_auto_retries_enabled: Optional[StrictInt] = Field(default=None, description="Maximum number of auto retries allowed for a payment")
    ...
    is_click_to_pay_enabled: StrictBool = Field(description="Indicates if click to pay is enabled or not.")
    ...
    is_clear_pan_retries_enabled: Optional[StrictBool] = Field(default=False, description="Indicates if clear pan retries is enabled or not.")
    force_3ds_challenge: Optional[StrictBool] = Field(default=False, description="Indicates if 3ds challenge is forced")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of extended_card_info_config
        if self.extended_card_info_config:
            _dict['extended_card_info_config'] = self.extended_card_info_config.to_dict()
        ...
        # set to None if extended_card_info_config (nullable) is None
        # and model_fields_set contains the field
        if self.extended_card_info_config is None and "extended_card_info_config" in self.model_fields_set:
            _dict['extended_card_info_config'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "extended_card_info_config": ExtendedCardInfoConfig.from_dict(obj["extended_card_info_config"]) if obj.get("extended_card_info_config") is not None else None,
            ...
            "is_network_tokenization_enabled": obj.get("is_network_tokenization_enabled") if obj.get("is_network_tokenization_enabled") is not None else False,
            "is_auto_retries_enabled": obj.get("is_auto_retries_enabled") if obj.get("is_auto_retries_enabled") is not None else False,
            ...
            "is_click_to_pay_enabled": obj.get("is_click_to_pay_enabled") if obj.get("is_click_to_pay_enabled") is not None else False,
