...
class BoletoVoucherData(BaseModel):
    """
    BoletoVoucherData
    """ # noqa: E501
    social_security_number: Optional[StrictStr] = Field(default=None, description="The shopper's social security number")
    __properties: ClassVar[List[str]] = ["social_security_number"]
