...
class PaymentsDynamicTaxCalculationResponse(BaseModel):
    """
    PaymentsDynamicTaxCalculationResponse
    """ # noqa: E501
    payment_id: StrictStr = Field(description="The identifier for the payment")
    net_amount: StrictInt = Field(description="This Unit struct represents MinorUnit in which core amount works")
    ...
    shipping_cost: Optional[StrictInt] = Field(default=None, description="This Unit struct represents MinorUnit in which core amount works")
    display_amount: DisplayAmountOnSdk
    __properties: ClassVar[List[str]] = ["payment_id", "net_amount", "order_tax_amount", "shipping_cost", "display_amount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.display_amount:
            _dict['display_amount'] = self.display_amount.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "display_amount": DisplayAmountOnSdk.from_dict(obj["display_amount"]) if obj.get("display_amount") is not None else None
        })
        return _obj
