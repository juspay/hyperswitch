...
class BankTransferInstructionsOneOf4(BaseModel):
    """
    BankTransferInstructionsOneOf4
    """ # noqa: E501
    multibanco: MultibancoTransferInstructions
    __properties: ClassVar[List[str]] = ["multibanco"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "multibanco": MultibancoTransferInstructions.from_dict(obj["multibanco"]) if obj.get("multibanco") is not None else None
        })
        return _obj
