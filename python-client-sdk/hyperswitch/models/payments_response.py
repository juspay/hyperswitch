...
class PaymentsResponse(BaseModel):
    ...
    capture_on: Optional[datetime] = Field(default=None, description="A timestamp (ISO 8601 code) that determines when the payment should be captured. Providing this field will automatically set `capture` to true")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if capture_on (nullable) is None
        # and model_fields_set contains the field
        if self.capture_on is None and "capture_on" in self.model_fields_set:
            _dict['capture_on'] = None
