...
class RefundUpdateRequest(BaseModel):
    ...
    RefundUpdateRequest
    """ # noqa: E501
    reason: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="An arbitrary string attached to the object. Often useful for displaying to users and your customer support executive")
    ...
    __properties: ClassVar[List[str]] = ["reason", "metadata"]
