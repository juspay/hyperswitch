...
class BankDebitDataOneOf2BecsBankDebit(BaseModel):
    """
    BankDebitDataOneOf2BecsBankDebit
    """ # noqa: E501
    billing_details: Optional[BankDebitBilling] = None
    account_number: StrictStr = Field(description="Account number for Becs payment method")
    bsb_number: StrictStr = Field(description="Bank-State-Branch (bsb) number")
    bank_account_holder_name: Optional[StrictStr] = Field(default=None, description="Owner name for bank debit")
    __properties: ClassVar[List[str]] = ["billing_details", "account_number", "bsb_number", "bank_account_holder_name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if bank_account_holder_name (nullable) is None
        # and model_fields_set contains the field
        if self.bank_account_holder_name is None and "bank_account_holder_name" in self.model_fields_set:
            _dict['bank_account_holder_name'] = None
