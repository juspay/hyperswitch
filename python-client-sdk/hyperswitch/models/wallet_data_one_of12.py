...
class WalletDataOneOf12(BaseModel):
    """
    WalletDataOneOf12
    """ # noqa: E501
    google_pay: GooglePayWalletData
    __properties: ClassVar[List[str]] = ["google_pay"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.google_pay:
            _dict['google_pay'] = self.google_pay.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "google_pay": GooglePayWalletData.from_dict(obj["google_pay"]) if obj.get("google_pay") is not None else None
        })
        return _obj
