...
class BankRedirectDataOneOf4(BaseModel):
    """
    BankRedirectDataOneOf4
    """ # noqa: E501
    giropay: BankRedirectDataOneOf4Giropay
    __properties: ClassVar[List[str]] = ["giropay"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "giropay": BankRedirectDataOneOf4Giropay.from_dict(obj["giropay"]) if obj.get("giropay") is not None else None
        })
        return _obj
