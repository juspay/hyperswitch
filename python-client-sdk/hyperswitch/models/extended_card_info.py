...
class ExtendedCardInfo(BaseModel):
    """
    ExtendedCardInfo
    """ # noqa: E501
    card_number: StrictStr = Field(description="The card number")
    card_exp_month: StrictStr = Field(description="The card's expiry month")
    card_exp_year: StrictStr = Field(description="The card's expiry year")
    card_holder_name: StrictStr = Field(description="The card holder's name")
    card_cvc: StrictStr = Field(description="The CVC number for the card")
    card_issuer: Optional[StrictStr] = Field(default=None, description="The name of the issuer of card")
    ...
    __properties: ClassVar[List[str]] = ["card_number", "card_exp_month", "card_exp_year", "card_holder_name", "card_cvc", "card_issuer", "card_network", "card_type", "card_issuing_country", "bank_code"]
