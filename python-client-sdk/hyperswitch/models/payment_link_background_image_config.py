...
class PaymentLinkBackgroundImageConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["url", "position", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": ElementSize.from_dict(obj["size"]) if obj.get("size") is not None else None
        })
        return _obj
