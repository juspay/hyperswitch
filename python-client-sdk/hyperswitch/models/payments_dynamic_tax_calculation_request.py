...
class PaymentsDynamicTaxCalculationRequest(BaseModel):
    """
    PaymentsDynamicTaxCalculationRequest
    """ # noqa: E501
    shipping: Address
    client_secret: StrictStr = Field(description="Client Secret")
    payment_method_type: PaymentMethodType
    session_id: Optional[StrictStr] = Field(default=None, description="Session Id")
    __properties: ClassVar[List[str]] = ["shipping", "client_secret", "payment_method_type", "session_id"]
