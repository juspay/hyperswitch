...
class CustomerAcceptance(BaseModel):
    ...
    accepted_at: Optional[datetime] = Field(default=None, description="Specifying when the customer acceptance was provided")
    online: Optional[OnlineMandate] = None
    __properties: ClassVar[List[str]] = ["acceptance_type", "accepted_at", "online"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "acceptance_type": obj.get("acceptance_type"),
            "accepted_at": obj.get("accepted_at"),
            "online": OnlineMandate.from_dict(obj["online"]) if obj.get("online") is not None else None
        })
        return _obj
