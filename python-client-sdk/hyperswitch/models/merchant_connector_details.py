...
class MerchantConnectorDetails(BaseModel):
    """
    MerchantConnectorDetails
    """ # noqa: E501
    auth_type: str = Field(description="Authentication type for the connector")
    ...
    __properties: ClassVar[List[str]] = ["auth_type", "api_key", "metadata"]
