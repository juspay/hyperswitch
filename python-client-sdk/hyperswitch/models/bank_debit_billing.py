...
class BankDebitBilling(BaseModel):
    """
    BankDebitBilling
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The billing name for bank debits")
    email: Optional[StrictStr] = Field(default=None, description="The billing email for bank debits")
    address: Optional[AddressDetails] = None
    __properties: ClassVar[List[str]] = ["name", "email", "address"]
