...
class ConnectorVolumeSplit(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connector": RoutableConnectorChoice.from_dict(obj["connector"]) if obj.get("connector") is not None else None,
            "split": obj.get("split")
        })
        return _obj
