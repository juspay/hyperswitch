...
class BankDebitDataOneOf3BacsBankDebit(BaseModel):
    """
    BankDebitDataOneOf3BacsBankDebit
    """ # noqa: E501
    billing_details: Optional[BankDebitBilling] = None
    account_number: StrictStr = Field(description="Account number for Bacs payment method")
    sort_code: StrictStr = Field(description="Sort code for Bacs payment method")
    bank_account_holder_name: StrictStr = Field(description="holder name for bank debit")
    __properties: ClassVar[List[str]] = ["billing_details", "account_number", "sort_code", "bank_account_holder_name"]
