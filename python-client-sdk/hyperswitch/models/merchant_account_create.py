...
class MerchantAccountCreate(BaseModel):
    ...
    primary_business_details: Optional[List[PrimaryBusinessDetails]] = Field(default=None, description="List of primary business details")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.primary_business_details:
            _dict['primary_business_details'] = [primary_business_detail.to_dict() for primary_business_detail in self.primary_business_details]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "primary_business_details": [PrimaryBusinessDetails.from_dict(primary_business_detail) for primary_business_detail in obj.get("primary_business_details", [])] if obj.get("primary_business_details") is not None else None,
