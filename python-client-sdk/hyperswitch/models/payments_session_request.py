...
class PaymentsSessionRequest(BaseModel):
    """
    ...
    wallets: List[PaymentMethodType] = Field(description="The list of the supported wallets")
    merchant_connector_details: Optional[MerchantConnectorDetailsWrap] = None
    __properties: ClassVar[List[str]] = ["payment_id", "client_secret", "wallets", "merchant_connector_details"]
