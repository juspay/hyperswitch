...
class BankTransferDataOneOf4PermataBankTransfer(BaseModel):
    """
    BankTransferDataOneOf4PermataBankTransfer
    """ # noqa: E501
    billing_details: Optional[DokuBillingDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "billing_details": DokuBillingDetails.from_dict(obj["billing_details"]) if obj.get("billing_details") is not None else None
        })
        return _obj
