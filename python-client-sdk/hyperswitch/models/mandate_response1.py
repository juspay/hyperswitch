...
class MandateResponse1(BaseModel):
    """
    MandateResponse1
    """ # noqa: E501
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mandate_details']):
            raise ValueError("must be one of enum values ('mandate_details')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "object": MandateResponse.from_dict(obj["object"]) if obj.get("object") is not None else None
        })
        return _obj
