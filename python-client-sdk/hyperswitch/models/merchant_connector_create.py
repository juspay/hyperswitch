...
class MerchantConnectorCreate(BaseModel):
    """
    ...
    profile_id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Identifier for the profile, if not provided default will be chosen from merchant account")
    ...
    merchant_connector_id: Optional[StrictStr] = Field(default=None, description="Unique ID of the connector")
    ...
    __properties: ClassVar[List[str]] = ["connector_type", "connector_name", "connector_label", "profile_id", "connector_account_details", "payment_methods_enabled", "connector_webhook_details", "metadata", "test_mode", "disabled", "frm_configs", "business_country", "business_label", "business_sub_label", "merchant_connector_id", "pm_auth_config", "status", "additional_merchant_data", "connector_wallets_details"]
