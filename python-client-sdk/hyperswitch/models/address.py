...
class Address(BaseModel):
    ...
    phone: Optional[PhoneDetails] = None
    email: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["address", "phone", "email"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phone": PhoneDetails.from_dict(obj["phone"]) if obj.get("phone") is not None else None,
            "email": obj.get("email")
        })
        return _obj
