...
class BusinessPayoutLinkConfig(BaseModel):
    """
    ...
    payout_test_mode: Optional[StrictBool] = Field(default=False, description="Allows for removing any validations / pre-requisites which are necessary in a production environment")
    __properties: ClassVar[List[str]] = ["logo", "merchant_name", "theme", "domain_name", "allowed_domains", "form_layout", "payout_test_mode"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if payout_test_mode (nullable) is None
        # and model_fields_set contains the field
        if self.payout_test_mode is None and "payout_test_mode" in self.model_fields_set:
            _dict['payout_test_mode'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payout_test_mode": obj.get("payout_test_mode") if obj.get("payout_test_mode") is not None else False
        })
        return _obj
