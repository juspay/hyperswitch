...
class ProgramConnectorSelection(BaseModel):
    """
    The program, having a default connector selection and a bunch of rules. Also can hold arbitrary metadata.
    """ # noqa: E501
    default_selection: ConnectorSelection = Field(alias="defaultSelection")
    rules: RuleConnectorSelection
    metadata: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["defaultSelection", "rules", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaultSelection": ConnectorSelection.from_dict(obj["defaultSelection"]) if obj.get("defaultSelection") is not None else None,
            "rules": RuleConnectorSelection.from_dict(obj["rules"]) if obj.get("rules") is not None else None,
