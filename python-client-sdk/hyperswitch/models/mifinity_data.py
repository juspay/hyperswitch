...
class MifinityData(BaseModel):
    """
    MifinityData
    """ # noqa: E501
    date_of_birth: date
    language_preference: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["date_of_birth", "language_preference"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.language_preference is None and "language_preference" in self.model_fields_set:
