...
class ProfileDefaultRoutingConfig(BaseModel):
    """
    ProfileDefaultRoutingConfig
    """ # noqa: E501
    profile_id: StrictStr
    connectors: List[RoutableConnectorChoice]
    __properties: ClassVar[List[str]] = ["profile_id", "connectors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connectors": [RoutableConnectorChoice.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None
        })
        return _obj
