...
class BankRedirectDataOneOf13Sofort(BaseModel):
    """
    BankRedirectDataOneOf13Sofort
    """ # noqa: E501
    billing_details: Optional[BankRedirectBilling] = None
    country: CountryAlpha2
    preferred_language: Optional[StrictStr] = Field(default=None, description="The preferred language")
    __properties: ClassVar[List[str]] = ["billing_details", "country", "preferred_language"]
