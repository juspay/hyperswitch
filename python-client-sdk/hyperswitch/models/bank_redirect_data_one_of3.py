...
class BankRedirectDataOneOf3(BaseModel):
    """
    BankRedirectDataOneOf3
    """ # noqa: E501
    eps: BankRedirectDataOneOf3Eps
    __properties: ClassVar[List[str]] = ["eps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eps": BankRedirectDataOneOf3Eps.from_dict(obj["eps"]) if obj.get("eps") is not None else None
        })
        return _obj
