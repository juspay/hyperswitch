...
class LabelInformation(BaseModel):
    """
    LabelInformation
    """ # noqa: E501
    label: StrictStr
    target_count: Annotated[int, Field(strict=True, ge=0)]
    target_time: Annotated[int, Field(strict=True, ge=0)]
    mca_id: StrictStr
    __properties: ClassVar[List[str]] = ["label", "target_count", "target_time", "mca_id"]
