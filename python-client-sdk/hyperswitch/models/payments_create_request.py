...
class PaymentsCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    amount: Annotated[int, Field(strict=True, ge=0)] = Field(description="The payment amount. Amount for the payment in the lowest denomination of the currency, (i.e) in cents for USD denomination, in yen for JPY denomination etc. E.g., Pass 100 to charge $1.00 and 1 for 1¥ since ¥ is a zero-decimal currency. Read more about [the Decimal and Non-Decimal Currencies](https://github.com/juspay/hyperswitch/wiki/Decimal-and-Non%E2%80%90Decimal-Currencies)")
    ...
    business_label: Optional[StrictStr] = Field(default=None, description="Business label of the merchant for this payment. To be deprecated soon. Pass the profile_id instead")
    ...
    profile_id: Optional[StrictStr] = Field(default=None, description="The business profile to be used for this payment, if not passed the default business profile associated with the merchant account will be used. It is mandatory in case multiple business profiles have been set up.")
