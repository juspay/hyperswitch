...
class BankRedirectDataOneOf12Przelewy24(BaseModel):
    """
    BankRedirectDataOneOf12Przelewy24
    """ # noqa: E501
    bank_name: Optional[BankNames] = None
    billing_details: Optional[BankRedirectBilling] = None
    __properties: ClassVar[List[str]] = ["bank_name", "billing_details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billing_details": BankRedirectBilling.from_dict(obj["billing_details"]) if obj.get("billing_details") is not None else None
        })
        return _obj
