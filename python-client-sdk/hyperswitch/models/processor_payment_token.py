...
class ProcessorPaymentToken(BaseModel):
    """
    Processor payment token for MIT payments where payment_method_data is not available
    """ # noqa: E501
    processor_payment_token: StrictStr
    merchant_connector_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["processor_payment_token", "merchant_connector_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "processor_payment_token": obj.get("processor_payment_token"),
