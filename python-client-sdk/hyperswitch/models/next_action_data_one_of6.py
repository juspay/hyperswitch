...
class NextActionDataOneOf6(BaseModel):
    """
    Contains duration for displaying a wait screen, wait screen with timer is displayed by sdk
    """ # noqa: E501
    display_from_timestamp: StrictInt
    display_to_timestamp: Optional[StrictInt] = None
    type: StrictStr
    __properties: ClassVar[List[str]] = ["display_from_timestamp", "display_to_timestamp", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['wait_screen_information']):
            raise ValueError("must be one of enum values ('wait_screen_information')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "display_from_timestamp": obj.get("display_from_timestamp"),
