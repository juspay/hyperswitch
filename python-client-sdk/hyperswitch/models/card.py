...
class Card(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["card_number", "card_exp_month", "card_exp_year", "card_holder_name", "card_cvc", "card_issuer", "card_network", "card_type", "card_issuing_country", "bank_code", "nick_name"]
