...
class OutgoingWebhookRequestContent(BaseModel):
    """
    The request information (headers and body) sent in the webhook.
    """ # noqa: E501
    body: StrictStr = Field(description="The request body sent in the webhook.")
    headers: List[List[OutgoingWebhookRequestContentHeadersInnerInner]] = Field(description="The request headers sent in the webhook.")
