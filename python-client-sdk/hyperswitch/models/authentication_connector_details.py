...
class AuthenticationConnectorDetails(BaseModel):
    """
    AuthenticationConnectorDetails
    """ # noqa: E501
    authentication_connectors: List[AuthenticationConnectors] = Field(description="List of authentication connectors")
    three_ds_requestor_url: StrictStr = Field(description="URL of the (customer service) website that will be shown to the shopper in case of technical errors during the 3D Secure 2 process.")
    ...
    __properties: ClassVar[List[str]] = ["authentication_connectors", "three_ds_requestor_url", "three_ds_requestor_app_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authentication_connectors": obj.get("authentication_connectors"),
