...
class PaymentsErrorResponse(BaseModel):
    """
    PaymentsErrorResponse
    """ # noqa: E501
    error: Optional[PaymentsErrorResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": PaymentsErrorResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
