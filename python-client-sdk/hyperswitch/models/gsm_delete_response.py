...
class GsmDeleteResponse(BaseModel):
    """
    GsmDeleteResponse
    """ # noqa: E501
    gsm_rule_delete: StrictBool
    ...
    __properties: ClassVar[List[str]] = ["gsm_rule_delete", "connector", "flow", "sub_flow", "code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gsm_rule_delete": obj.get("gsm_rule_delete"),
