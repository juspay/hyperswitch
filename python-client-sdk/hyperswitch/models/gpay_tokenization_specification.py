...
class GpayTokenizationSpecification(BaseModel):
    """
    GpayTokenizationSpecification
    """ # noqa: E501
    type: StrictStr = Field(description="The token specification type(ex: PAYMENT_GATEWAY)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "parameters": GpayTokenParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
