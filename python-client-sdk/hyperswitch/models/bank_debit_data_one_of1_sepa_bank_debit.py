...
class BankDebitDataOneOf1SepaBankDebit(BaseModel):
    """
    BankDebitDataOneOf1SepaBankDebit
    """ # noqa: E501
    billing_details: Optional[BankDebitBilling] = None
    iban: StrictStr = Field(description="International bank account number (iban) for SEPA")
    bank_account_holder_name: StrictStr = Field(description="Owner name for bank debit")
    __properties: ClassVar[List[str]] = ["billing_details", "iban", "bank_account_holder_name"]
