...
class SessionTokenOneOf8(BaseModel):
    """
    SessionTokenOneOf8
    """ # noqa: E501
    wallet_name: StrictStr
    __properties: ClassVar[List[str]] = ["wallet_name"]

    @field_validator('wallet_name')
    def wallet_name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['no_session_token_received']):
            raise ValueError("must be one of enum values ('no_session_token_received')")
        return value
