...
class BankRedirectDataOneOf13(BaseModel):
    """
    BankRedirectDataOneOf13
    """ # noqa: E501
    sofort: BankRedirectDataOneOf13Sofort
    __properties: ClassVar[List[str]] = ["sofort"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sofort": BankRedirectDataOneOf13Sofort.from_dict(obj["sofort"]) if obj.get("sofort") is not None else None
        })
        return _obj
