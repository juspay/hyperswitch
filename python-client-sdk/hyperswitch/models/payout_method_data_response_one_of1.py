...
class PayoutMethodDataResponseOneOf1(BaseModel):
    """
    PayoutMethodDataResponseOneOf1
    """ # noqa: E501
    bank: BankAdditionalData
    __properties: ClassVar[List[str]] = ["bank"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bank": BankAdditionalData.from_dict(obj["bank"]) if obj.get("bank") is not None else None
        })
        return _obj
