...
class AcceptedCurrenciesOneOf1(BaseModel):
    """
    AcceptedCurrenciesOneOf1
    """ # noqa: E501
    type: StrictStr
    list: List[Currency]
    __properties: ClassVar[List[str]] = ["type", "list"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['disable_only']):
            raise ValueError("must be one of enum values ('disable_only')")
        return value
