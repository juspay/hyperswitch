...
class MerchantConnectorResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["connector_type", "connector_name", "connector_label", "merchant_connector_id", "profile_id", "connector_account_details", "payment_methods_enabled", "connector_webhook_details", "metadata", "test_mode", "disabled", "frm_configs", "business_country", "business_label", "business_sub_label", "applepay_verified_domains", "pm_auth_config", "status", "additional_merchant_data", "connector_wallets_details"]
