...
class MerchantRoutingAlgorithm(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "profile_id", "name", "description", "algorithm", "created_at", "modified_at", "algorithm_for"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "algorithm": RoutingAlgorithm.from_dict(obj["algorithm"]) if obj.get("algorithm") is not None else None,
