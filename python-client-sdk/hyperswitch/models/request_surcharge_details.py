...
class RequestSurchargeDetails(BaseModel):
    """
    Details of surcharge applied on this payment, if applicable
    """ # noqa: E501
    surcharge_amount: StrictInt
    tax_amount: Optional[StrictInt] = Field(default=None, description="This Unit struct represents MinorUnit in which core amount works")
    __properties: ClassVar[List[str]] = ["surcharge_amount", "tax_amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "surcharge_amount": obj.get("surcharge_amount"),
