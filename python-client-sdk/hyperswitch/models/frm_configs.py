...
class FrmConfigs(BaseModel):
    ...
    payment_methods: List[FrmPaymentMethod] = Field(description="payment methods that can be used in the payment")
    __properties: ClassVar[List[str]] = ["gateway", "payment_methods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payment_methods": [FrmPaymentMethod.from_dict(_item) for _item in obj["payment_methods"]] if obj.get("payment_methods") is not None else None
        })
        return _obj
