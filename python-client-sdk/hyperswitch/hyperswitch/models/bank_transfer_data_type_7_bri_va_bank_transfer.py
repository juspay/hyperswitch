...
T = TypeVar("T", bound="BankTransferDataType7BriVaBankTransfer")


@_attrs_define
class BankTransferDataType7BriVaBankTransfer:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_transfer_data_type_7_bri_va_bank_transfer = cls(
            billing_details=billing_details,
        )

        bank_transfer_data_type_7_bri_va_bank_transfer.additional_properties = d
        return bank_transfer_data_type_7_bri_va_bank_transfer
