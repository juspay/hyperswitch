...
T = TypeVar("T", bound="GsmCreateRequest")


@_attrs_define
class GsmCreateRequest:
    """
    Attributes:
        connector (Connector):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        connector = Connector(d.pop("connector"))
        ...
        decision = GsmDecision(d.pop("decision"))
        ...
        gsm_create_request.additional_properties = d
        return gsm_create_request
