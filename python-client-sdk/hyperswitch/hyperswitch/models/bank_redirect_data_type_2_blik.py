...
T = TypeVar("T", bound="BankRedirectDataType2Blik")


@_attrs_define
class BankRedirectDataType2Blik:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_redirect_data_type_2_blik = cls(
            blik_code=blik_code,
        )

        bank_redirect_data_type_2_blik.additional_properties = d
        return bank_redirect_data_type_2_blik
