...
if TYPE_CHECKING:
    ...
    from ..models.merchant_connector_response_metadata_type_0 import MerchantConnectorResponseMetadataType0
    from ..models.merchant_connector_response_pm_auth_config_type_0 import MerchantConnectorResponsePmAuthConfigType0
...
T = TypeVar("T", bound="MerchantConnectorResponse")


@_attrs_define
class MerchantConnectorResponse:
    ...
    Attributes:
        ...
        metadata (Union['MerchantConnectorResponseMetadataType0', None, Unset]): Metadata is useful for storing
        ...
        applepay_verified_domains (Union[None, Unset, list[str]]): identifier for the verified domains of a particular
            connector account
        pm_auth_config (Union['MerchantConnectorResponsePmAuthConfigType0', None, Unset]):
    ...
    metadata: Union["MerchantConnectorResponseMetadataType0", None, Unset] = UNSET
    ...
    pm_auth_config: Union["MerchantConnectorResponsePmAuthConfigType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.merchant_connector_details import MerchantConnectorDetails
        from ..models.merchant_connector_response_metadata_type_0 import MerchantConnectorResponseMetadataType0
        from ..models.merchant_connector_response_pm_auth_config_type_0 import (
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, MerchantConnectorResponseMetadataType0):
        ...
        elif isinstance(self.pm_auth_config, MerchantConnectorResponsePmAuthConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> Union["MerchantConnectorResponseMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = MerchantConnectorResponseMetadataType0.from_dict(data)

                return metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["MerchantConnectorResponseMetadataType0", None, Unset], data)
        ...
        def _parse_pm_auth_config(data: object) -> Union["MerchantConnectorResponsePmAuthConfigType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                pm_auth_config_type_0 = MerchantConnectorResponsePmAuthConfigType0.from_dict(data)

                return pm_auth_config_type_0
            except:  # noqa: E722
                pass
            return cast(Union["MerchantConnectorResponsePmAuthConfigType0", None, Unset], data)
        ...
        merchant_connector_response = cls(
            connector_type=connector_type,
            connector_name=connector_name,
            merchant_connector_id=merchant_connector_id,
            profile_id=profile_id,
        ...
        return merchant_connector_response
