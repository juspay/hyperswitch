...
T = TypeVar("T", bound="PixBankTransferAdditionalData")


@_attrs_define
class PixBankTransferAdditionalData:
    """
    Attributes:
        pix_key (Union[None, Unset, str]): Partially masked unique key for pix transfer Example: a1f4102e ******
            6fa48899c1d1.
        cpf (Union[None, Unset, str]): Partially masked CPF - CPF is a Brazilian tax identification number Example: ****
            124689.
        cnpj (Union[None, Unset, str]): Partially masked CNPJ - CNPJ is a Brazilian company tax identification number
            Example: **** 417312.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pix_bank_transfer_additional_data = cls(
            pix_key=pix_key,
            cpf=cpf,
            cnpj=cnpj,
        )

        pix_bank_transfer_additional_data.additional_properties = d
        return pix_bank_transfer_additional_data
