...
T = TypeVar("T", bound="AdditionalPayoutMethodDataType2")


@_attrs_define
class AdditionalPayoutMethodDataType2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        additional_payout_method_data_type_2 = cls(
            wallet=wallet,
        )

        additional_payout_method_data_type_2.additional_properties = d
        return additional_payout_method_data_type_2
