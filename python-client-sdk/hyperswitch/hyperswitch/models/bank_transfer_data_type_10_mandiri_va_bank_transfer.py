...
T = TypeVar("T", bound="BankTransferDataType10MandiriVaBankTransfer")


@_attrs_define
class BankTransferDataType10MandiriVaBankTransfer:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_transfer_data_type_10_mandiri_va_bank_transfer = cls(
            billing_details=billing_details,
        )

        bank_transfer_data_type_10_mandiri_va_bank_transfer.additional_properties = d
        return bank_transfer_data_type_10_mandiri_va_bank_transfer
