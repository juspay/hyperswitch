...
if TYPE_CHECKING:
    ...
    from ..models.payout_update_request_metadata_type_0 import PayoutUpdateRequestMetadataType0
...
T = TypeVar("T", bound="PayoutUpdateRequest")


@_attrs_define
class PayoutUpdateRequest:
    """
    Attributes:
        ...
        confirm (Union[None, Unset, bool]): This field is used when merchant wants to confirm the payout, thus useful
            for the payout _Confirm_ request. Ideally merchants should _Create_ a payout, _Update_ it (if required), then
            _Confirm_ it. Default: False. Example: True.
        ...
        metadata (Union['PayoutUpdateRequestMetadataType0', None, Unset]): You can specify up to 50 keys, with key names
    ...
    metadata: Union["PayoutUpdateRequestMetadataType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, PayoutUpdateRequestMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> Union["PayoutUpdateRequestMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = PayoutUpdateRequestMetadataType0.from_dict(data)

                return metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PayoutUpdateRequestMetadataType0", None, Unset], data)
        ...
        payout_update_request.additional_properties = d
        return payout_update_request
