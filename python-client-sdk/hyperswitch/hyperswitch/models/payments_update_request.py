...
if TYPE_CHECKING:
    ...
    from ..models.payments_update_request_frm_metadata_type_0 import PaymentsUpdateRequestFrmMetadataType0
    from ..models.payments_update_request_metadata_type_0 import PaymentsUpdateRequestMetadataType0
...
T = TypeVar("T", bound="PaymentsUpdateRequest")
...
class PaymentsUpdateRequest:
    ...
    Attributes:
        ...
        metadata (Union['PaymentsUpdateRequestMetadataType0', None, Unset]): You can specify up to 50 keys, with key
        ...
        frm_metadata (Union['PaymentsUpdateRequestFrmMetadataType0', None, Unset]): Additional data related to some
    ...
    metadata: Union["PaymentsUpdateRequestMetadataType0", None, Unset] = UNSET
    ...
    frm_metadata: Union["PaymentsUpdateRequestFrmMetadataType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, PaymentsUpdateRequestMetadataType0):
        ...
        if isinstance(self.frm_metadata, Unset):
            frm_metadata = UNSET
        elif isinstance(self.frm_metadata, PaymentsUpdateRequestFrmMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> Union["PaymentsUpdateRequestMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = PaymentsUpdateRequestMetadataType0.from_dict(data)

                return metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PaymentsUpdateRequestMetadataType0", None, Unset], data)
        ...
        def _parse_frm_metadata(data: object) -> Union["PaymentsUpdateRequestFrmMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                frm_metadata_type_0 = PaymentsUpdateRequestFrmMetadataType0.from_dict(data)

                return frm_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PaymentsUpdateRequestFrmMetadataType0", None, Unset], data)
        ...
        payments_update_request.additional_properties = d
        return payments_update_request
