...
T = TypeVar("T", bound="AlfamartVoucherData")


@_attrs_define
class AlfamartVoucherData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alfamart_voucher_data = cls(
            first_name=first_name,
            last_name=last_name,
            email=email,
        )

        alfamart_voucher_data.additional_properties = d
        return alfamart_voucher_data
