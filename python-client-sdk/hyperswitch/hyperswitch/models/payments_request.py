...
if TYPE_CHECKING:
    ...
    from ..models.feature_metadata import FeatureMetadata
    ...
    from ..models.payments_request_frm_metadata_type_0 import PaymentsRequestFrmMetadataType0
    from ..models.payments_request_metadata_type_0 import PaymentsRequestMetadataType0
...
T = TypeVar("T", bound="PaymentsRequest")
...
class PaymentsRequest:
    ...
    Attributes:
        ...
        merchant_id (Union[None, Unset, str]): This is an identifier for the merchant account. This is inferred from the
            API key
        ...
        capture_on (Union[None, Unset, datetime.datetime]): A timestamp (ISO 8601 code) that determines when the payment
            should be captured.
            Providing this field will automatically set `capture` to true Example: 2022-09-10T10:11:12Z.
        ...
        email (Union[None, Unset, str]): The customer's email address.
            This field will be deprecated soon, use the customer object instead Example: johntest@test.com.
        name (Union[None, Unset, str]): The customer's name.
            This field will be deprecated soon, use the customer object instead. Example: John Test.
        phone (Union[None, Unset, str]): The customer's phone number
            This field will be deprecated soon, use the customer object instead Example: 9123456789.
        phone_country_code (Union[None, Unset, str]): The country code for the customer phone number
            This field will be deprecated soon, use the customer object instead Example: +1.
        ...
        card_cvc (Union[None, Unset, str]): This is used along with the payment_token field while collecting during
            saved card payments. This field will be deprecated soon, use the payment_method_data.card_token object instead
        ...
        business_sub_label (Union[None, Unset, str]): Business sub label for the payment
        retry_action (Union[None, RetryAction, Unset]):
        metadata (Union['PaymentsRequestMetadataType0', None, Unset]): You can specify up to 50 keys, with key names up
        ...
        feature_metadata (Union['FeatureMetadata', None, Unset]):
        ...
        frm_metadata (Union['PaymentsRequestFrmMetadataType0', None, Unset]): Additional data related to some frm(Fraud
            Risk Management) connectors
    ...
    capture_on: Union[None, Unset, datetime.datetime] = UNSET
    ...
    metadata: Union["PaymentsRequestMetadataType0", None, Unset] = UNSET
    connector_metadata: Union["ConnectorMetadata", None, Unset] = UNSET
    feature_metadata: Union["FeatureMetadata", None, Unset] = UNSET
    ...
    frm_metadata: Union["PaymentsRequestFrmMetadataType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        capture_on: Union[None, Unset, str]
        if isinstance(self.capture_on, Unset):
            capture_on = UNSET
        elif isinstance(self.capture_on, datetime.datetime):
            capture_on = self.capture_on.isoformat()
        else:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, PaymentsRequestMetadataType0):
        ...
        feature_metadata: Union[None, Unset, dict[str, Any]]
        if isinstance(self.feature_metadata, Unset):
            feature_metadata = UNSET
        elif isinstance(self.feature_metadata, FeatureMetadata):
        ...
        if isinstance(self.frm_metadata, Unset):
            frm_metadata = UNSET
        elif isinstance(self.frm_metadata, PaymentsRequestFrmMetadataType0):
        ...
        if capture_on is not UNSET:
            field_dict["capture_on"] = capture_on
        ...
        if feature_metadata is not UNSET:
            field_dict["feature_metadata"] = feature_metadata
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_capture_on(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                capture_on_type_0 = isoparse(data)

                return capture_on_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, datetime.datetime], data)

        capture_on = _parse_capture_on(d.pop("capture_on", UNSET))
        ...
        def _parse_metadata(data: object) -> Union["PaymentsRequestMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = PaymentsRequestMetadataType0.from_dict(data)

                return metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PaymentsRequestMetadataType0", None, Unset], data)
        ...
        def _parse_feature_metadata(data: object) -> Union["FeatureMetadata", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                feature_metadata_type_1 = FeatureMetadata.from_dict(data)

                return feature_metadata_type_1
            except:  # noqa: E722
                pass
            return cast(Union["FeatureMetadata", None, Unset], data)

        feature_metadata = _parse_feature_metadata(d.pop("feature_metadata", UNSET))
        ...
        def _parse_frm_metadata(data: object) -> Union["PaymentsRequestFrmMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                frm_metadata_type_0 = PaymentsRequestFrmMetadataType0.from_dict(data)

                return frm_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PaymentsRequestFrmMetadataType0", None, Unset], data)
