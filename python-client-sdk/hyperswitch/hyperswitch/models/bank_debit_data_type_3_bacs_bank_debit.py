...
T = TypeVar("T", bound="BankDebitDataType3BacsBankDebit")


@_attrs_define
class BankDebitDataType3BacsBankDebit:
    """
    Attributes:
        account_number (str): Account number for Bacs payment method Example: 00012345.
        sort_code (str): Sort code for Bacs payment method Example: 108800.
        bank_account_holder_name (str): holder name for bank debit Example: A. Schneider.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_debit_data_type_3_bacs_bank_debit = cls(
            account_number=account_number,
            sort_code=sort_code,
            bank_account_holder_name=bank_account_holder_name,
        ...
        bank_debit_data_type_3_bacs_bank_debit.additional_properties = d
        return bank_debit_data_type_3_bacs_bank_debit
