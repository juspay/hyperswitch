...
T = TypeVar("T", bound="CustomerDetailsResponse")
...
class CustomerDetailsResponse:
    ...
    Attributes:
        id (Union[None, Unset, str]): The identifier for the customer. Example: cus_y3oqhf46pyzuxjbcn2giaqnb44.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        customer_details_response.additional_properties = d
        return customer_details_response
