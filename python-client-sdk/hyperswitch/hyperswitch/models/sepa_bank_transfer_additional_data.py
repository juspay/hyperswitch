...
T = TypeVar("T", bound="SepaBankTransferAdditionalData")


@_attrs_define
class SepaBankTransferAdditionalData:
    ...
    Attributes:
        ...
        bic (Union[None, Unset, str]): [8 / 11 digits] Bank Identifier Code (bic) / Swift Code - used in many countries
            for identifying a bank and it's branches Example: HSBCGB2LXXX.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sepa_bank_transfer_additional_data = cls(
            iban=iban,
            bank_name=bank_name,
        ...
        sepa_bank_transfer_additional_data.additional_properties = d
        return sepa_bank_transfer_additional_data
