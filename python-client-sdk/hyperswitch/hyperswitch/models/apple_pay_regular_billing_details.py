...
T = TypeVar("T", bound="ApplePayRegularBillingDetails")


@_attrs_define
class ApplePayRegularBillingDetails:
    """
    Attributes:
        label (str): The label that Apple Pay displays to the user in the payment sheet with the recurring details
        recurring_payment_start_date (Union[None, Unset, datetime.datetime]): The date of the first payment Example:
            2023-09-10T23:59:59Z.
        recurring_payment_end_date (Union[None, Unset, datetime.datetime]): The date of the final payment Example:
            2023-09-10T23:59:59Z.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        apple_pay_regular_billing_details = cls(
            label=label,
        ...
        apple_pay_regular_billing_details.additional_properties = d
        return apple_pay_regular_billing_details
