...
T = TypeVar("T", bound="PayoutMethodDataResponseType1")


@_attrs_define
class PayoutMethodDataResponseType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payout_method_data_response_type_1 = cls(
            bank=bank,
        )

        payout_method_data_response_type_1.additional_properties = d
        return payout_method_data_response_type_1
