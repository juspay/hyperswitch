...
from ..models.retry_action import RetryAction
...
if TYPE_CHECKING:
    ...
    from ..models.payments_confirm_request_frm_metadata_type_0 import PaymentsConfirmRequestFrmMetadataType0
    from ..models.payments_confirm_request_metadata_type_0 import PaymentsConfirmRequestMetadataType0
...
T = TypeVar("T", bound="PaymentsConfirmRequest")


@_attrs_define
class PaymentsConfirmRequest:
    """
    Attributes:
        amount (Union[None, Unset, int]): The payment amount. Amount for the payment in the lowest denomination of the
            currency, (i.e) in cents for USD denomination, in yen for JPY denomination etc. E.g., Pass 100 to charge $1.00
            and 1 for 1¥ since ¥ is a zero-decimal currency. Read more about [the Decimal and Non-Decimal
            Currencies](https://github.com/juspay/hyperswitch/wiki/Decimal-and-Non%E2%80%90Decimal-Currencies) Example:
            6540.
        ...
        client_secret (Union[None, Unset, str]): It's a token used for client side verification. Example:
        ...
        retry_action (Union[None, RetryAction, Unset]):
        metadata (Union['PaymentsConfirmRequestMetadataType0', None, Unset]): You can specify up to 50 keys, with key
        ...
        frm_metadata (Union['PaymentsConfirmRequestFrmMetadataType0', None, Unset]): Additional data related to some
    ...
    retry_action: Union[None, RetryAction, Unset] = UNSET
    metadata: Union["PaymentsConfirmRequestMetadataType0", None, Unset] = UNSET
    ...
    frm_metadata: Union["PaymentsConfirmRequestFrmMetadataType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        retry_action: Union[None, Unset, str]
        if isinstance(self.retry_action, Unset):
            retry_action = UNSET
        elif isinstance(self.retry_action, RetryAction):
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, PaymentsConfirmRequestMetadataType0):
        ...
        if isinstance(self.frm_metadata, Unset):
            frm_metadata = UNSET
        elif isinstance(self.frm_metadata, PaymentsConfirmRequestFrmMetadataType0):
        ...
        if retry_action is not UNSET:
            field_dict["retry_action"] = retry_action
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_retry_action(data: object) -> Union[None, RetryAction, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                retry_action_type_1 = RetryAction(data)

                return retry_action_type_1
            except:  # noqa: E722
                pass
            return cast(Union[None, RetryAction, Unset], data)

        retry_action = _parse_retry_action(d.pop("retry_action", UNSET))

        def _parse_metadata(data: object) -> Union["PaymentsConfirmRequestMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = PaymentsConfirmRequestMetadataType0.from_dict(data)

                return metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PaymentsConfirmRequestMetadataType0", None, Unset], data)
        ...
        def _parse_frm_metadata(data: object) -> Union["PaymentsConfirmRequestFrmMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                frm_metadata_type_0 = PaymentsConfirmRequestFrmMetadataType0.from_dict(data)

                return frm_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PaymentsConfirmRequestFrmMetadataType0", None, Unset], data)
        ...
        payments_confirm_request.additional_properties = d
        return payments_confirm_request
