...
T = TypeVar("T", bound="BacsBankTransferAdditionalData")


@_attrs_define
class BacsBankTransferAdditionalData:
    """Masked payout method details for bacs bank transfer payout method

    Attributes:
        bank_sort_code (str): Partially masked sort code for Bacs payment method Example: 108800.
        bank_account_number (str): Bank account's owner name Example: 0001****3456.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bacs_bank_transfer_additional_data = cls(
            bank_sort_code=bank_sort_code,
            bank_account_number=bank_account_number,
            bank_name=bank_name,
        ...
        bacs_bank_transfer_additional_data.additional_properties = d
        return bacs_bank_transfer_additional_data
