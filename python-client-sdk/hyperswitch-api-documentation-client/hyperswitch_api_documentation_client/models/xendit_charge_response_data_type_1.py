...
T = TypeVar("T", bound="XenditChargeResponseDataType1")


@_attrs_define
class XenditChargeResponseDataType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        xendit_charge_response_data_type_1 = cls(
            single_split=single_split,
        )

        xendit_charge_response_data_type_1.additional_properties = d
        return xendit_charge_response_data_type_1
