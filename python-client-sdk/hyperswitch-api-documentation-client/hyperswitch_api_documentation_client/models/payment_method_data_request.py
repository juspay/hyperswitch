...
T = TypeVar("T", bound="PaymentMethodDataRequest")


@_attrs_define
class PaymentMethodDataRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_method_data_request = cls(
            billing=billing,
        )

        payment_method_data_request.additional_properties = d
        return payment_method_data_request
