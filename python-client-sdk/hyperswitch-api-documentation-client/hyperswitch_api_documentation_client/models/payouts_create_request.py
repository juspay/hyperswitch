...
if TYPE_CHECKING:
    ...
    from ..models.payouts_create_request_metadata_type_0 import PayoutsCreateRequestMetadataType0
...
T = TypeVar("T", bound="PayoutsCreateRequest")


@_attrs_define
class PayoutsCreateRequest:
    """
    Attributes:
        amount (int): The payout amount. Amount for the payout in lowest denomination of the currency. (i.e) in cents
            for USD denomination, in paisa for INR denomination etc.,
        ...
        metadata (Union['PayoutsCreateRequestMetadataType0', None, Unset]): You can specify up to 50 keys, with key
    ...
    metadata: Union["PayoutsCreateRequestMetadataType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, PayoutsCreateRequestMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> Union["PayoutsCreateRequestMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = PayoutsCreateRequestMetadataType0.from_dict(data)

                return metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PayoutsCreateRequestMetadataType0", None, Unset], data)
        ...
        payouts_create_request.additional_properties = d
        return payouts_create_request
