...
T = TypeVar("T", bound="ConnectorChargeResponseDataType1")


@_attrs_define
class ConnectorChargeResponseDataType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        connector_charge_response_data_type_1 = cls(
            adyen_split_payment=adyen_split_payment,
        )

        connector_charge_response_data_type_1.additional_properties = d
        return connector_charge_response_data_type_1
