...
T = TypeVar("T", bound="PaymentLinkConfigRequest")


@_attrs_define
class PaymentLinkConfigRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_link_config_request = cls(
            theme=theme,
            logo=logo,
        ...
        payment_link_config_request.additional_properties = d
        return payment_link_config_request
