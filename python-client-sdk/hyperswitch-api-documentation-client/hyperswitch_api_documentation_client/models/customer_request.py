...
if TYPE_CHECKING:
    ...
    from ..models.customer_request_metadata_type_0 import CustomerRequestMetadataType0
...
class CustomerRequest:
    ...
    Attributes:
        customer_id (Union[None, Unset, str]): The identifier for the customer object. If not provided the customer ID
            will be autogenerated. Example: cus_y3oqhf46pyzuxjbcn2giaqnb44.
        ...
        metadata (Union['CustomerRequestMetadataType0', None, Unset]): You can specify up to 50 keys, with key names up
    ...
    metadata: Union["CustomerRequestMetadataType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, CustomerRequestMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> Union["CustomerRequestMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = CustomerRequestMetadataType0.from_dict(data)

                return metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CustomerRequestMetadataType0", None, Unset], data)
