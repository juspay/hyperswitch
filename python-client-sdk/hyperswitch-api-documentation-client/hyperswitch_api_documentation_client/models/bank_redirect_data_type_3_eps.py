...
T = TypeVar("T", bound="BankRedirectDataType3Eps")


@_attrs_define
class BankRedirectDataType3Eps:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_redirect_data_type_3_eps = cls(
            bank_name=bank_name,
            country=country,
            billing_details=billing_details,
        )

        bank_redirect_data_type_3_eps.additional_properties = d
        return bank_redirect_data_type_3_eps
