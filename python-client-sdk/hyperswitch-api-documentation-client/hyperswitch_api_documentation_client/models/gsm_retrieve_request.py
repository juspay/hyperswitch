...
T = TypeVar("T", bound="GsmRetrieveRequest")


@_attrs_define
class GsmRetrieveRequest:
    """
    Attributes:
        connector (Connector):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gsm_retrieve_request.additional_properties = d
        return gsm_retrieve_request
