...
if TYPE_CHECKING:
    from ..models.apple_pay_regular_billing_request import ApplePayRegularBillingRequest


T = TypeVar("T", bound="ApplePayRecurringPaymentRequest")
...
class ApplePayRecurringPaymentRequest:
    ...
    Attributes:
        ...
        management_u_r_l (str): A URL to a web page where the user can update or delete the payment method for the
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        management_u_r_l = self.management_u_r_l
        ...
        field_dict.update(
            {
                ...
                "management_u_r_l": management_u_r_l,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        regular_billing = ApplePayRegularBillingRequest.from_dict(d.pop("regular_billing"))

        management_u_r_l = d.pop("management_u_r_l")
        ...
        apple_pay_recurring_payment_request = cls(
            payment_description=payment_description,
            regular_billing=regular_billing,
            management_u_r_l=management_u_r_l,
        ...
        apple_pay_recurring_payment_request.additional_properties = d
        return apple_pay_recurring_payment_request
