...
T = TypeVar("T", bound="AchBankTransfer")


@_attrs_define
class AchBankTransfer:
    """
    Attributes:
        bank_account_number (str): Bank account number is an unique identifier assigned by a bank to a customer.
            Example: 000123456.
        bank_routing_number (str): [9 digits] Routing number - used in USA for identifying a specific bank. Example:
            110000000.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ach_bank_transfer.additional_properties = d
