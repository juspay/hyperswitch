...
T = TypeVar("T", bound="NetworkTransactionIdAndCardDetails")


@_attrs_define
class NetworkTransactionIdAndCardDetails:
    """
    Attributes:
        ...
        network_transaction_id (str): The network transaction ID provided by the card network during a CIT (Customer
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_transaction_id = d.pop("network_transaction_id")
        ...
        network_transaction_id_and_card_details = cls(
            card_number=card_number,
            card_exp_month=card_exp_month,
            card_exp_year=card_exp_year,
            card_holder_name=card_holder_name,
        ...
        network_transaction_id_and_card_details.additional_properties = d
        return network_transaction_id_and_card_details
