...
/// MerchantConnectorCreate : Create a new Merchant Connector for the merchant account. The connector could be a payment processor / facilitator / acquirer or specialized services like Fraud / Accounting etc.\"
...
pub struct MerchantConnectorCreate {
    ...
    pub connector_name: crate::models::Connector,
    #[serde(rename = "connector_label")]
    pub connector_label: String,
    /// Unique ID of the connector
    #[serde(rename = "merchant_connector_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub merchant_connector_id: Option<Option<String>>,
...
impl MerchantConnectorCreate {
    ...
    pub fn new(connector_type: crate::models::ConnectorType, connector_name: crate::models::Connector, connector_label: String) -> MerchantConnectorCreate {
