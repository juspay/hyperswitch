...
pub struct PaymentRetrieveBody {
    ...
    #[serde(rename = "force_sync", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub force_sync: Option<Option<bool>>,
...
impl PaymentRetrieveBody {
    pub fn new() -> PaymentRetrieveBody {
        PaymentRetrieveBody {
            merchant_id: None,
            force_sync: None,
            client_secret: None,
