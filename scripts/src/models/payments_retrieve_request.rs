...
pub struct PaymentsRetrieveRequest {
    ...
    pub resource_id: Box<crate::models::PaymentIdType>,
...
impl PaymentsRetrieveRequest {
    pub fn new(resource_id: crate::models::PaymentIdType, force_sync: bool) -> PaymentsRetrieveRequest {
