...
pub struct RedirectResponse {
    ...
    #[serde(rename = "json_payload", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub json_payload: Option<Option<serde_json::Value>>,
}
