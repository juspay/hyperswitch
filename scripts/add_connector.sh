...
function find_prev_connector() {
    ...
    connectors=(aci adyen airwallex applepay authorizedotnet bambora bluesnap braintree checkout cybersource dlocal fiserv globalpay klarna mollie multisafepay netseasy nuvei payu rapyd shift4 stripe trustpay worldline worldpay "$1")
