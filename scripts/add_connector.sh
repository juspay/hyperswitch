...
case "$connector_type" of
    payout) sed -i'' -e "s/pub enum RoutablePayoutConnectors {/pub enum RoutablePayoutConnectors {\n\t${pgc},/" crates/api_models/src/enums.rs   ;;
    *)      sed -i'' -e "s/pub enum RoutablePaymentConnectors {/pub enum RoutablePaymentConnectors {\n\t${pgc},/" crates/api_models/src/enums.rs ;;
esac
