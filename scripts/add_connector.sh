...
sed -i '' -e "/\/\/ Add Seperate authentication support for connectors/ s/.*/${indentation}&\\
    ${indentation}| Self::${payment_gateway_camelcase}/" crates/api_models/src/enums.rs
