...
CURL_COMMAND=("curl" "--get" "${WEBHOOK_URL}" "--data-urlencode" "${VERSION}" "--data-urlencode" "${INSTALLATION_STATUS}")
...
# Print confirmation
echo "Request sent to ${WEBHOOK_URL} with ${VERSION} and ${INSTALLATION_STATUS}"
