 ...
 *
 * Test data and expected responses for Stripe connector
 * Ported from Cypress Stripe.js
 */
...
// Card required fields (defined locally to avoid circular dependency)
const cardRequiredField = {
