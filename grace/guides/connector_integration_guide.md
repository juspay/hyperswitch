...
### Preparation 
[IMPORTANT]
[This step can be ignored if already created eg. if connector_integation/{connector}/planner-steps.md & tech-specs.md is already created, this step can be skipped]
...
1.  **Contextual Awareness (Mandatory)**:
    ...
    *   Second, ensure the content of `guide/connector_integration_guide.md` is loaded and understood.
...
- Established a clear, multi-step workflow for creating connector-specific planning and technical specification prompts:
