...
pm.test("[POST]::/payments:id/capture - Content check if value for 'amount_received' matches '6000'", function() {
...
if (jsonData?.amount_capturable){
    pm.test("[post]:://payments/:id/capture - Content check if value for 'amount_capturable' matches 'amount - 540'", function() {
