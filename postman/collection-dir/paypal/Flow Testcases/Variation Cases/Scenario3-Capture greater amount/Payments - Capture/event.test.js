...
// Response body should have value "amount_to_capture is greater than amount" for "message"
if (jsonData?.error?.message) {
pm.test("[POST]::/payments - Content check if value for 'error.message' matches 'connector_error'", function() {
  pm.expect(jsonData.error.message).to.eql("amount_to_capture is greater than amount");
})};
