...
// Response body should have value "square" for "connector"
if (jsonData?.connector) {
  pm.test(
    "[POST]::/payments/:id/confirm - Content check if value for 'connector' matches 'square'",
    function () {
      pm.expect(jsonData.connector).to.eql("square");
    },
  );
}
