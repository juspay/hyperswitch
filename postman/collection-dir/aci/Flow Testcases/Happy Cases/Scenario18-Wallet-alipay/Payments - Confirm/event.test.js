...
// Response body should have value "ali_pay" for "payment_method_type"
if (jsonData?.payment_method_type) {
pm.test("[POST]::/payments/:id/confirm - Content check if value for 'payment_method_type' matches 'ali_pay'", function() {
  pm.expect(jsonData.payment_method_type).to.eql("ali_pay");
})};
