...
// Response body should have value "przelewy24" for "payment_method_type"
if (jsonData?.payment_method_type) {
pm.test("[POST]::/payments/:id/confirm - Content check if value for 'payment_method_type' matches 'przelewy24'", function() {
  pm.expect(jsonData.payment_method_type).to.eql("przelewy24");
})};
