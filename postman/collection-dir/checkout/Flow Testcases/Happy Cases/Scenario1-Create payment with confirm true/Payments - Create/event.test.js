...
//     pm.expect(jsonData.amount).to.eql(pm.request.amount);
// });
...
if (jsonData?.amount_received){
    pm.test("[post]:://payments/:id/capture - Content check if value for 'amount_received' matches 'amount - 6540'", function() {
