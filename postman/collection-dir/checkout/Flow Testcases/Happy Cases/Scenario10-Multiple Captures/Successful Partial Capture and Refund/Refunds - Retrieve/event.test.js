...
// Response body should have value "6000" for "amount"
if (jsonData?.status) {
pm.test("[POST]::/refunds - Content check if value for 'amount' matches '6000'", function() {
  pm.expect(jsonData.amount).to.eql(6000);
})};
