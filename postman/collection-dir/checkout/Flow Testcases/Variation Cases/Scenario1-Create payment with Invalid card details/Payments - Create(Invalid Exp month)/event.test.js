...
// Response body should have value "Invalid Expiry Month" for "message"
if (jsonData?.error?.message) {
pm.test("[POST]::/payments - Content check if value for 'error.message' matches 'Invalid Expiry Month'", function() {
  pm.expect(jsonData.error.message).to.eql("Invalid Expiry Month");
})};