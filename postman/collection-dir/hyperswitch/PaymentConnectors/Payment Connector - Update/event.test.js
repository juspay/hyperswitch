// Validate status 2xx 
pm.test("[POST]::/account/:account_id/connectors/:connector_id - Status code is 2xx", function () {
   pm.response.to.be.success;
});

// Validate if response header has matching content-type
pm.test("[POST]::/account/:account_id/connectors/:connector_id - Content-Type is application/json", function () {
