...
if (jsonData?.amount){
    pm.test("[post]:://payments/:id/capture - Content check if value for 'amount' matches '1000'", function() {
...
pm.test("[POST]::/payments:id/capture - Content check if value for 'amount_received' matches '600'", function() {
