...
// Response body should have value "mollie" for "connector"
if (jsonData?.connector) {
pm.test("[POST]::/payments/:id/confirm - Content check if value for 'connector' matches 'mollie'", function() {
  pm.expect(jsonData.connector).to.eql("mollie");
})};