...
if (jsonData?.amount){
    pm.test("[post]:://payments/:id/capture - Content check if value for 'amount' matches '{{amount}}'", function() {
...
pm.test("[POST]::/payments:id/capture - Content check if value for 'amount_received' matches '{{amount}}'", function() {
