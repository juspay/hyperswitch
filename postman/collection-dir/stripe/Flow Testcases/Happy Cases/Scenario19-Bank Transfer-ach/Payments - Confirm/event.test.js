...
pm.test("[POST]::/payments/:id/confirm - Content check if value for 'payment_method_type' matches 'display_bank_transfer_information'", function() {
  pm.expect(jsonData.next_action.type).to.eql("display_bank_transfer_information");
})};
