...
pm.test("[POST]::/payments - Content check if 'next_action.type' exists", function() {
...
pm.test("[POST]::/payments/:id/confirm - Content check if value for 'payment_method_type' matches 'we_chat_pay'", function() {
...
pm.test("[POST]::/payments/:id/confirm - Content check if value for 'payment_method_type' matches 'qr_code_information'", function() {
