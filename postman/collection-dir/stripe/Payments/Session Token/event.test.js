...
pm.test("[POST]::/payments/session_tokens - Content-Type is application/json", function () {
...
pm.test("[POST]::/payments/session_tokens - Verify wallet_name is 'google_pay'", function() {
