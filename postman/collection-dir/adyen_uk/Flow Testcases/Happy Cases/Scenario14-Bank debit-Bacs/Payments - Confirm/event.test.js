...
// Response body should have value "bacs" for "payment_method_type"
if (jsonData?.payment_method_type) {
  pm.test(
    "[POST]::/payments/:id/confirm - Content check if value for 'payment_method_type' matches 'bacs'",
    function () {
      pm.expect(jsonData.payment_method_type).to.eql("bacs");
    },
  );
}
