...
pm.test("[POST]::/payments - Content check if value for 'error.message' matches 'Invalid card_cvc length'", function() {
  pm.expect(jsonData.error.message).to.eql("Invalid card_cvc length");
})};