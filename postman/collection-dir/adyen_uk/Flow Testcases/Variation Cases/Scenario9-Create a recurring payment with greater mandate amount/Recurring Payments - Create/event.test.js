...
pm.test("[POST]::/payments - Content check if value for 'error.message' matches 'Mandate Validation Failed'", function() {
  pm.expect(jsonData.error.message).to.eql("Mandate Validation Failed");
})};
