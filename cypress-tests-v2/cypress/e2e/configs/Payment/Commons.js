      ...
      Response: {
        ...
        body: {
          error: {
            ...
            message: "Json deserialize error: invalid card number length at line 1 column 638",
            code: "IR_06"
          },
        },
      },
    ...
    InvalidCaptureMethod: {
      ...
      Response: {
        ...
        body: {
          error: {
            error_type: "invalid_request",
            message: "Json deserialize error: unknown variant `auto`, expected one of `automatic`, `manual`, `manual_multiple`, `scheduled` at line 1 column 389",
            code: "IR_06"
          },
        },
      },
    ...
    InvalidPaymentMethod: {
      ...
      Response: {
        ...
        body: {
          error: {
            error_type: "invalid_request",
            message: "Json deserialize error: unknown variant `this_supposed_to_be_a_card`, expected one of `card`, `card_redirect`, `pay_later`, `wallet`, `bank_redirect`, `bank_transfer`, `crypto`, `bank_debit`, `reward`, `real_time_payment`, `upi`, `voucher`, `gift_card`, `open_banking`, `mobile_payment` at line 1 column 481",
            code: "IR_06"
          },
        },
      },
