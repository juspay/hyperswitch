...
BEGIN
    IF EXISTS (
        ...
        ALTER COLUMN connector_transaction_data TYPE VARCHAR(512);
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        ALTER TABLE refund 
        ALTER COLUMN connector_refund_data TYPE VARCHAR(512);
    END IF;
END $$;
...
BEGIN
    IF EXISTS (
        ...
        ALTER COLUMN connector_capture_data TYPE VARCHAR(512);
    END IF;
END $$;