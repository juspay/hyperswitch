...
<CardGroup horizontal cols={2} row={3}> 
  <Card horizontal title="Try a Payment" href="http://localhost:3000/essentials/Introduction_to_Payments_Endpoint" icon="money-bill">
    Explore the versitile payments endpoint, through multiple test scenarios
  </Card>
  <Card horizontal title="Refund" href="http://localhost:3001/api-reference/refunds/refunds--create" icon="receipt">
    Process refunds for completed payments using our API
  </Card>
  <Card horizontal title="Save a payment method" icon="vault">
    Save customer payment methods securely for future transactions
  </Card>
  <Card horizontal title="Self Hosted?" icon="circle-down">
