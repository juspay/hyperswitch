...
│   ├── common_types                   : Common type definitions used across crates
│   ├── common_utils                   : Utilities shared across `router` and other crates
│   ├── config_importer                : Configuration import utilities
│   ├── connector_configs              : Connector configuration management
...
│   ├── euclid                         : Routing engine core
│   ├── euclid_macros                  : Macros for the Euclid routing engine
│   ├── euclid_wasm                    : WebAssembly bindings for Euclid
│   ├── events                         : Event handling and processing
│   ├── external_services              : Interactions with external systems like emails, AWS KMS, etc.
│   ├── hsdev                          : Development tools and utilities
│   ├── hyperswitch_connectors         : Payment connector implementations
│   ├── hyperswitch_constraint_graph   : Constraint graph for routing decisions
│   ├── hyperswitch_domain_models      : Domain models used by the business/domain layer
│   ├── hyperswitch_interfaces         : Interface definitions for core components
│   ├── injector                       : Dependency injection utilities
│   ├── kgraph_utils                   : Knowledge graph utilities
│   ├── masking                        : Personal Identifiable Information protection
│   ├── openapi                        : OpenAPI specification generation
│   ├── payment_methods                : Payment method handling and validation
...
│   ├── smithy                         : Smithy framework integration
│   ├── smithy-core                    : Core Smithy framework components
│   ├── smithy-generator               : Smithy code generation utilities
